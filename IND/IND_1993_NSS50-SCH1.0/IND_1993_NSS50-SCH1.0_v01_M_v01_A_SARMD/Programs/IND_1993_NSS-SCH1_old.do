...
** UNIT OF ANALYSIS	
** INPUT DATABASES	
*   C:\_I2D2\India\1993\Original\Data\DataOrig.dta
...
** DIRECTORY
	local input "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\IND\IND_1993_NSS_SCH1\IND_1993_NSS_SCH1_v01_M"
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\IND\IND_1993_NSS_SCH1\IND_1993_NSS_SCH1_v01_M_v01_A_SARMD"

** LOG FILE
	log using "`input'\Doc\IND_1993_NSS_SCH1.log",replace
...
** DATABASE ASSEMBLENT
	...
	use "`input'\Data\Raw\Household\block4.dta" 
	...
	use "`input'\Data\Raw\Constructed\poverty50_ind.dta", clear

	generate idh=string(hhid, "%15.0f")
	sort idh indid

	merge m:1 idh using "`input'\Data\Raw\Constructed\pcc50.dta"
drop _merge
	merge 1:1 hhid indid  using `t1'
...
** HOUSEHOLD SIZE
	...
	bys idh: egen hhsize1=count(relation2)
	drop one two
	label var hhsize1 "Household size (I2D2)"


	ren hhsize1 hhsize_i2d2
...
** EDUCATIONAL LEVEL 1
	gen edulevel1=gened
	recode edulevel1 (1=1) (2 3 4=7) (5=2) (6=3) (7 8 =4) (9=5) (10 11 12 13=6)	(0=.)
...
** EDUCATION LEVEL 2
	...
	replace edulevel2=2 if edulevel1==2|edulevel1==3
	replace edulevel2=3 if edulevel1==4|edulevel1==5
	replace edulevel2=4 if edulevel1==6
...
** DELETE MISSING VARIABLES
	...
	save "`output'\Data\Harmonized\IND_1993_NSS_SCH1.dta", replace
	save "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Final Files\Individual Files\IND_1993_NSS_SCH1.dta", replace
	/*
...
** FIXES FOR NORMAL I2D2
	...
	save "`input'\Processed\IND_1993_I2D2_NSS_SCH1.dta", replace
	save "D:\__CURRENT\IND_1993_I2D2_NSS_SCH1.dta", replace
	*/
