/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   IND_2011_NSS68-SCH1.0-T1_v01_M_v01_A_GMD_DEM.do	</_Program name_>
...
<_Version Control_>
Date:	03-03-2019
File:	IND_2011_NSS68-SCH1.0-T1_v01_M_v01_A_GMD_DEM.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
local filename     "IND_2011_NSS68-SCH1.0-T1_v01_M_v01_A_GMD_DEM";
*</_Program setup_>;
...
#delimit cr
datalibweb, country(`code') year(`year') type(`type') survey(`survey') vermast(`vm') veralt(04) mod(IND) clear 
#delimit ;
*</_Datalibweb request_>;
