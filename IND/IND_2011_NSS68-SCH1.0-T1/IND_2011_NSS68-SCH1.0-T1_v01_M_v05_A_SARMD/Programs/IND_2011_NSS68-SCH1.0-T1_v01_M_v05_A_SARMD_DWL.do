/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   IND_2011_NSS68-SCH1.0-T1_v01_M_v01_A_GMD_DWL.do	</_Program name_>
...
<_Version Control_>
Date:	03-03-2019
File:	IND_2011_NSS68-SCH1.0-T1_v01_M_v01_A_GMD_DWL.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
tempfile raw2
datalibweb, country(IND) year(2011) type(SARRAW) surveyid(IND_2011_NSS68-SCH1.0-T1_v01_M) filename(NSS68_Sch1-T1_bk_11.dta)
keep if inlist(B11_v02, 562, 586, 581)
...
local filename     "IND_2011_NSS68-SCH1.0-T1_v01_M_v01_A_GMD_DWL";
*</_Program setup_>;
...
gen video= (B11_v03562 == 1) if !missing(B11_v03562);
*</_video_>;
...
gen stove= (B11_v03586 == 1) if !missing(B11_v03586);
*</_stove_>;
...
gen ac= (B11_v03581 == 1) if !missing(B11_v03581);
*</_ac_>;
...
gen agriland= ((B3_v14 > 0 & B3_v14 != .) | (B3_v15 > 0 & B3_v15 != .));
*</_agriland_>; 
...
egen area_agriland= rowtotal(B3_v14 B3_v15), missing;
*</_area_agriland_>;
