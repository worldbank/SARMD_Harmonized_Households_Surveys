/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   IND_2011_NSS68-SCH1.0-T1_v01_M_v01_A_GMD_UTL.do	</_Program name_>
...
<_Survey Title_>   NSS68-SCH1.0-T1	</_Survey Title_>
<_Survey Year_>    2011	</_Survey Year_>
--------------------------------------------------------------------------------
<_Version Control_>
Date:	03-03-2019
File:	IND_2011_NSS68-SCH1.0-T1_v01_M_v01_A_GMD_UTL.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*<_Raw data_>;
tempfile raw1
datalibweb, country(IND) year(2011) type(SARRAW) surveyid(IND_2011_NSS68-SCH1.0-T1_v01_M) filename(NSS68_Sch1-T1_bk_10.dta)
keep if inlist(B10_v02,540,437,487,488,496,508,510)
keep B10_v02 ID B10_v03
reshape wide B10_v03, i(ID) j(B10_v02)
save `raw1'

tempfile raw2
datalibweb, country(IND) year(2011) type(SARRAW) surveyid(IND_2011_NSS68-SCH1.0-T1_v01_M) filename(NSS68_Sch1-T1_bk_3.dta)
merge 1:1 ID using `raw1'
drop _merge
save `raw2'

tempfile raw3
datalibweb, country(IND) year(2011) type(SARRAW) surveyid(IND_2011_NSS68-SCH1.0-T1_v01_M) filename(NSS68_Sch1-T1_bk_5_6.dta)
keep if inlist(B5_v02,332,338,334,335,338,343,344,331,337,330,333,340,342,345)
keep B5_v02 ID B5_v06
reshape wide B5_v06, i(ID) j(B5_v02)

merge 1:1 ID using `raw2'
drop _merge
...
local code         "IND";
local year         "2011";
local survey       "NSS68-SCH1.0-T1";
local vm           "01";
local va           "04";
local type         "SARMD";
local yearfolder   "IND_2011_NSS68-SCH1.0-T1";
local gmdfolder    "IND_2011_NSS68-SCH1.0-T1_v01_M_v01_A_GMD";
local filename     "IND_2011_NSS68-SCH1.0-T1_v01_M_v01_A_GMD_UTL";
*</_Program setup_>;
...
gen cellphone_exp= B10_v03488*12;
...
gen coal_exp= B5_v06337*12;
notes coal_exp: Multiplied by 12 to annualize;
*</_coal_exp_>;

*<_cooksource_>;
*<_cooksource_note_> Main cooking fuel *</_cooksource_note_>;
*<_cooksource_note_> cooksource brought in from  *</_cooksource_note_>;
gen cooksource= B3_v16;
recode cooksource (2=1) (3=5) (4 5 1 9=9) (6=3) (7=2) (8=4);
*</_cooksource_>;
...
egen diesel_exp = rowtotal(B5_v06344 B10_v03510), missing;
replace diesel_exp = diesel_exp*12;
notes diesel_exp: incl diesel for conveyance. Multiplied by 12 to annualize;
*</_diesel_exp _>;
...
gen dwelmat_exp=.;
notes dwelmat_exp: Survey collects this combined with cost of construction which is meant to be excluded. Thus blank. ;
*</_dwelmat_exp_>;
...
gen lightsource= B3_v17;
recode lightsource (1=2) (2 9=9) (3=4) (4=3) (5=1) (6=10);
*</_lightsource_>;
...
egen gasoline_exp = rowtotal(B5_v06343 B10_v03508), missing;
replace gasoline_exp = gasoline_exp*12;
notes gasoline_exp: Incl gasoline for conveyance. Multiplied by 12 to annualize;
*</_gasoline_exp _>;
...
gen internet_exp= B10_v03496*12;
notes internet_exp: Multiplied by 12 to annualize;
*</_internet_exp_>;
...
egen kerosene_exp= rowtotal(B5_v06334 B5_v06335), missing;
...
gen landphone_exp= B10_v03487*12;
...
gen othfuel_exp= B5_v06345*12;
notes othfuel_exp: Multiplied by 12 to annualize;
*</_othfuel_exp_>;
...
egen othsol_exp= rowtotal(B5_v06330 B5_v06333 B5_v06340 B5_v06342), missing;
...
egen transfuel_exp= rowtotal(B10_v03508 B10_v03510), missing;
...
gen tv_exp= B10_v03437*12;
notes tv_exp: Multiplied by 12 to annualize;
*</_tv_exp_>;
