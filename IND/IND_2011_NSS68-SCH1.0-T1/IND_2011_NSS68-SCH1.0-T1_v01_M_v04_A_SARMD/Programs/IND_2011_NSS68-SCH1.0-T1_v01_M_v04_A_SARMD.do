...
** DIRECTORY
	...
	local input "${rootdatalib}\SAR_DATABANK\IND\IND_2011_NSS68-SCH1.0-T1\IND_2011_NSS68-SCH1.0-T1_v01_M"
	local output "${rootdatalib}\SAR_DATABANK\IND\IND_2011_NSS68-SCH1.0-T1\IND_2011_NSS68-SCH1.0-T1_v01_M_v04_A_SARMD"
	glo pricedata "${rootdatalib}\CPI\cpi_ppp_sarmd_weighted.dta"
	glo shares "${rootdatalib}\APPS\DATA CHECK\Food and non-food shares\IND"
...
*	replace pline_urp_sector=1114.0	if sector==2
	...
	* MERGE DATASETS
	...
	save "`input'\Data\Stata\IND_2011_NSS68-SCH1.0-T1_v01_M.dta", replace
	mmm
/*****************************************************************************************************
*                                                                                                    *
...
*<_subnatid0_>
    clonevar subnatid0=state
	recode subnatid0 (1 2 3 4 6 8 = 1) (5 7 9 10 23 = 2) (12/18 = 3) (11 19 20 21 22 35 = 4) ( 24 25 26 27 30 = 5) (28 29 31 32 33 34 = 6)
	label define lblsubnatid0 1 "Northern" 2 "North-Central" 3 "North-Eastern" 4 "Eastern" 5 "Western" 6 "Southern" 
	label var subnatid0 "Region at 2 digit (ADMN2)"
...
*<_subnatid2_>
	gen byte subnatid2=.
	label var subnatid2 "Region at 3 digit (ADMN3)"
...
** KEEP VARIABLES - ALL
	...
	keep countrycode year survey idh idp wgt pop_wgt wgt_wdi strata psu vermast veralt urban int_month int_year fieldwork  ///
	     subnatid0 subnatid1 subnatid2 subnatid3 gaul_adm1_code ownhouse landholding tenure water electricity toilet internet ///
...
** ORDER VARIABLES
	...
	order countrycode year survey idh idp wgt pop_wgt wgt_wdi strata psu vermast veralt urban int_month int_year fieldwork ///
	       subnatid0 subnatid1 subnatid2 subnatid3 gaul_adm1_code ownhouse landholding tenure water water_original water_source improved_water pipedwater_acc ///
...
** DELETE MISSING VARIABLES
	...
	saveold "${rootdatalib}\SAR_DATABANK\__REGIONAL\Individual Files\IND_2011_NSS68-SCH1.0-T1_v01_M_v04_A_SARMD_IND.dta", replace version(12)
