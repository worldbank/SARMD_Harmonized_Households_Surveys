/*----------------------------------------------------------------------------------
  SARMD Harmonization
------------------------------------------------------------------------------------
<_Program name_>   		IND_2011_NSS-SCH2_v03_M_v01_SARMD_UTL.do	   </_Program name_>
...
<_Version Control_>
Date:					02-2026
File:					IND_2011_NSS-SCH2_v03_M_v01_SARMD_UTL.do
First version
</_Version Control_>
----------------------------------------------------------------------------------*/
...
gen watertype_quest = .
notes watertype_quest: the NSS-SCH2 does not contain the information needed to define this variable
*</_watertype_quest_>
...
gen water_original = "."
notes water_original: the NSS-SCH2 does not contain the information needed to define this variable
*</_water_original_>
...
* Q4.23: What is the source of drinking water from which most of the drinking water is obtained by the household during last 365 days?
gen water_source = .
notes water_source: the NSS-SCH2 does not contain the information needed to define this variable
*</_water_source_>
...
gen imp_wat_rec = .
notes imp_wat_rec: the NSS-SCH2 does not contain the information needed to define this variable
*</_imp_wat_rec_>
...
gen piped = .
notes piped: the NSS-SCH2 does not contain the information needed to define this variable
*</_piped_>
...
gen piped_to_prem = .
notes piped_to_prem: the NSS-SCH2 does not contain the information needed to define this variable
*</_piped_to_prem_>
...
gen w_30m = .
notes w_30m: the NSS-SCH2 does not contain the information needed to define this variable
*</_w_30m_>
...
gen w_avail = .
notes w_avail: the NSS-SCH2 does not contain the information needed to define this variable
*</_w_avail_>
...
notes sanitation_original: the NSS-SCH2 does not contain the information needed to define this variable
*</_sanitation_original_>
...
notes sanitation_source: the NSS-SCH2 does not contain the information needed to define this variable
*</_sanitation_source_>
...
gen toilet_acc = .	
notes toilet_acc: the NSS-SCH2 does not contain the information needed to define this variable
*</_toilet_acc_>
...
gen sewer = .	
notes sewer: the NSS-SCH2 does not contain the information needed to define this variable
*</_sewer_>
...
gen open_def = .	
notes open_def: the NSS-SCH2 does not contain the information needed to define this variable
*</_open_def_>
...
gen imp_san_rec = .	
notes imp_san_rec: the NSS-SCH2 does not contain the information needed to define this variable
*</_imp_san_rec_>
...
gen waste = .
notes waste: the NSS-SCH2 does not contain the information needed to define this variable
*</_waste_>
...
gen central_acc = .
notes central_acc: the NSS-SCH2 does not contain the information needed to define this variable
*</_central_acc_>
...
gen heatsource = .
notes heatsource: the NSS-SCH2 does not contain the information needed to define this variable
*</_heatsource_>
...
gen 	gas = 0			
replace gas = 2		if  cookmode==3
replace gas = 3		if  cookmode==4 
...
gen 	cooksource = 1		if  cookmode==2						// firewood and chips 				//
replace cooksource = 2		if  cookmode==7						// kerosene 						//
replace cooksource = 3		if  cookmode==1 | cookmode==6		// coke-coal / charcoal				//
replace cooksource = 4 		if  cookmode==8						// Electricity						//
replace cooksource = 5		if  cookmode==3 | cookmode==4 		// LPG / gobar gas					//
replace cooksource = 9		if  cookmode==5 | cookmode==9		// dung cake / Other				//  
replace cooksource = 10		if  cookmode==10					// no cooking arrangement			//
notes 	cooksource: cooksource==4 ("charcoal") includes coke-coal and charcoal 
notes   cooksource: cooksource==9 ("other") includes dung cake, gobar gas and other
*</_cooksource_>
...
gen 	lightsource = 1		if  lightmode==5					// electricity 					// 
replace lightsource = 2		if  lightmode==1					// kerosene						//
replace lightsource = 3		if  lightmode==4					// candles 						//
replace lightsource = 4		if  lightmode==3					// gas							//
replace lightsource = 9		if  lightmode==2 | lightmode==9		// other oil / other			//
replace lightsource = 10	if  lightmode==6					// no lighting arrangement		//
...
gen     elec_acc = 4			
replace elec_acc = 3		if  lightmode==5
*</_elec_acc_>
...
gen 	electricity = 0		if  lightmode!=.
replace electricity = 1		if  lightmode==5
*</_electricity_>
...
gen elechr_acc = .
notes elechr_acc: the NSS-SCH2 does not contain the information needed to define this variable
*</_elechr_acc_>
...
gen pwater_exp = .
notes pwater_exp: NSS-SCH2 does not include information on this type of expenditure
*</_pwater_exp_>
...
gen hwater_exp = .
notes hwater_exp: NSS-SCH2 does not include information on this type of expenditure
*</_hwater_exp_>
...
notes water_exp: NSS-SCH2 only includes information on "water charges", without detailed information on the type of water
*</_water_exp_>
...
gen garbage_exp = .
notes garbage_exp: NSS-SCH2 does not include information on this type of expenditure
*</_garbage_exp_>
...
gen sewage_exp = .
notes sewage_exp: NSS-SCH2 does not include information on this type of expenditure
*</_sewage_exp_>
...
notes waste_exp: NSS-SCH2 does not include information on this type of expenditure
*</_waste_exp _>
...
gen dwelothsvc_exp = .
notes dwelothsvc_exp: NSS-SCH2 does not include information on this type of expenditure
*</_dwelothsvc_exp_>
...
gen ngas_exp = .
notes ngas_exp: NSS-SCH2 does not include information on this type of expenditure
*</_ngas_exp _>
...
/*<_gasoline_exp _note_> Rawdata variable: exp343 (petrol) - exp508 (petrol for vehicle) *</_gasoline_exp _note_>*/
*<_gasoline_exp _note_> gasoline_exp  brought in from raw data *</_gasoline_exp _note_>
egen 	gasoline_exp = rsum(exp343 exp508), missing 
replace gasoline_exp = gasoline_exp*12
*</_gasoline_exp _>

*<_diesel_exp _>
*<_diesel_exp _note_> Total annual consumption of diesel *</_diesel_exp _note_>
/*<_diesel_exp _note_> Rawdata variable: exp344 (diesel) - exp510 (diesel for vehicle) *</_diesel_exp _note_>*/
*<_diesel_exp _note_> diesel_exp brought in from raw data *</_diesel_exp _note_>
egen 	diesel_exp = rsum(exp344 exp510), missing 
...
gen othliq_exp = .
notes othliq_exp: NSS-SCH2 does not include information on this type of expenditure
*</_othliq_exp _>
...
/*<_coal_exp_note_> Rawdata variable: exp330 (coke) - exp337 (coal) - exp340 (charcoal) *</_coal_exp_note_>*/
*<_coal_exp_note_> coal_exp brought in from raw data *</_coal_exp_note_>
egen 	coal_exp = rsum(exp330 exp337 exp340), missing 
...
gen peat_exp = .
notes peat_exp: NSS-SCH2 does not include information on this type of expenditure
*</_peat_exp _>
...
/*<_othfuel_exp_note_> exp341 (candles) - exp342 (gobar gas) - exp345 (other)  *</_othfuel_exp_note_>*/
*<_othfuel_exp_note_> othfuel_exp brought in from raw data *</_othfuel_exp_note_>
egen 	othfuel_exp = rsum(exp341 exp342 exp345), missing 
...
gen central_exp = .
notes central_exp: NSS-SCH2 does not include information on this type of expenditure
*</_central_exp_>
...
gen dwelmat_exp = .
notes dwelmat_exp: NSS-SCH2 does not include information on this type of expenditure
*</_dwelmat_exp_>
...
gen dwelsvc_exp = .
notes dwelsvc_exp: NSS-SCH2 does not include information on this type of expenditure
*</_dwelsvc_exp_>
...
gen transfuel_exp = .
notes transfuel_exp: NSS-SCH2 does not include information on this type of expenditure
*</_transfuel_exp_>
...
gen telefax_exp = .
notes telefax_exp: NSS-SCH2 does not include information on this type of expenditure
*</_telefax_exp_>
...
gen tv_exp = .
notes tv_exp: NSS-SCH2 does not include information on this type of expenditure
*</_tv_exp_>
