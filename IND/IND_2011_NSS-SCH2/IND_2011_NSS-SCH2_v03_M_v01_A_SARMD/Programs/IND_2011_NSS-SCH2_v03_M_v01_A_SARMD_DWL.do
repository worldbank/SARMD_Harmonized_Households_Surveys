/*----------------------------------------------------------------------------------
  SARMD Harmonization
------------------------------------------------------------------------------------
<_Program name_>   		IND_2011_NSS-SCH2_v03_M_v01_SARMD_DWL.do	   </_Program name_>
...
<_Version Control_>
Date:					02-2026
File:					IND_2011_NSS-SCH2_v03_M_v01_SARMD_DWL.do
First version
</_Version Control_>
----------------------------------------------------------------------------------*/
...
gen 	landphone = 1	if  item_624==1 
replace landphone = 0	if  item_624!=1	
*</_landphone_>
...
gen   	cellphone = 1	if  item_623==1 
replace cellphone = 0	if  item_623!=1
*</_cellphone_>
...
gen cellphone_i = .
notes cellphone_i: the NSS-SCH2 does not contain the information needed to define this variable
*</_cellphone_i_>
...
gen 	phone = 1		if  landphone==1 | cellphone==1
...
gen		computer = 1	if  item_622==1 
replace computer = 0	if  item_622!=1	
*</_computer_>
...
gen etablet = .
notes etablet: the NSS-SCH2 only collects information on expendidure for the purchase of PC/laptop in the last 365 days
*</_etablet_>
...
gen 	radio = 1		if  item_560==1
replace radio = 0		if  item_560!=1
*</_radio_>
...
gen 	tv = 1			if  item_561==1 
replace tv = 0			if  item_561!=1
*</_tv_>
...
gen tv_cable = .
notes tv_cable: the NSS-SCH2 only collects information on expendidure on tv cable services in the last 365 days
*</_tv_cable_>
...
gen 	video = 1		if  item_562==1 
replace video = 0		if  item_562!=1
*</_video_>
...
gen 	fridge = 1		if  item_588==1
replace fridge = 0		if  item_588!=1
*</_fridge_>
...
gen 	sewmach = 1		if  item_584==1 
replace sewmach = 0		if  item_584!=1
*</_sewmach_>
...
gen 	washmach = 1	if  item_585==1 
replace washmach = 0	if  item_585!=1
*</_washmach_>
...
gen 	stove = 1		if  item_586==1
replace stove = 0		if  item_586!=1
*</_stove_>
...
gen ricecook = .
notes ricecook: the NSS-SCH2 does not contain the information needed to define this variable
*</_ricecook_>
...
gen 	fan = 1			if  item_580==1
replace fan = 0			if  item_580!=1 
*</_fan_>
...
gen 	ac = 1			if  item_581==1 
replace ac = 0			if  item_581!=1
*</_ac_>
...
gen ewpump = .
notes ewpump: the NSS-SCH2 does not contain the information needed to define this variable
*</_ewpump_>
...
gen 	car = 1		if  item_602==1
replace car = 0		if  item_602!=1
*</_ewpump_>
...
gen 	bcycle = 1	if  item_600==1
replace bcycle = 0	if  item_600!=1
*</_bcycle_>
...
gen 	mcycle = 1	if  item_601==1
replace mcycle = 0	if  item_601!=1
*</_mcycle_>
...
gen oxcart = .
notes oxcart: the NSS-SCH2 only collects information on expendidure for the purchase of motorcycles in the last 365 days
*</_oxcart_>
...
gen boat = .
notes boat: the NSS-SCH2 does not contain the information needed to define this variable
*</_boat_>
...
gen canoe = .
notes canoe: the NSS-SCH2 does not contain the information needed to define this variable
*</_canoe_>
...
gen roofcs = "."
notes roofcs: the NSS-SCH2 does not contain the information needed to define this variable
*</_roofcs_>
...
gen roof = .
notes roof: the NSS-SCH2 does not contain the information needed to define this variable
*</_roof_>
...
gen wallcs = "."
notes wallcs: the NSS-SCH2 does not contain the information needed to define this variable
*</_wallcs_>
...
gen wall = .
notes wall: the NSS-SCH2 does not contain the information needed to define this variable
*</_wall_>
...
gen floorcs = "."
notes floorcs: the NSS-SCH2 does not contain the information needed to define this variable
*</_floorcs_>
...
gen floor = .
notes floor: the NSS-SCH2 does not contain the information needed to define this variable
*</_floor_>
...
*<_dweltyp_note_> missing variable, no information in the NSS-SCH2 to define dweltyp *</_dweltyp_note_>
gen dweltyp = .
notes dweltyp: the NSS-SCH2 does not contain the information needed to define this variable
*</_dweltyp_>
...
*<_typlivqrt_note_> missing variable, no information in the NSS-SCH2 to define typlivqrt *</_typlivqrt_note_>
gen typlivqrt = .
notes typlivqrt: the NSS-SCH2 does not contain the information needed to define this variable
*</_typlivqrt_>

*<_kitchen_>
*<_kitchen_note_> Separate kitchen in the dwelling *</_kitchen_note_>
/*<_kitchen_note_> 1 "Yes" 0 "No" *</_kitchen_note_>*/
*<_kitchen_note_> missing variable, no information in the NSS-SCH2 to define kitchen *</_kitchen_note_>
gen kitchen = .
notes kitchen: the NSS-SCH2 does not contain the information needed to define this variable
*</_kitchen_>

*<_bath_>
*<_bath_note_> Bathing facility in the dwelling *</_bath_note_>
/*<_bath_note_> 1 "Yes" 0 "No" *</_bath_note_>*/
*<_bath_note_> missing variable, no information in the NSS-SCH2 to define bath *</_bath_note_>
gen bath = .
notes bath: the NSS-SCH2 does not contain the information needed to define this variable
*</_bath_>

*<_rooms_>
*<_rooms_note_> Number of habitable rooms *</_rooms_note_>
/*<_rooms_note_>  *</_rooms_note_>*/
*<_rooms_note_> missing variable, no information in the NSS-SCH2 to define rooms *</_rooms_note_>
gen rooms = .
notes rooms: the NSS-SCH2 does not contain the information needed to define this variable
*</_rooms_>

*<_areaspace_>
*<_areaspace_note_> Area *</_areaspace_note_>
/*<_areaspace_note_>     *</_areaspace_note_>*/
*<_areaspace_note_> missing variable, no information in the NSS-SCH2 to define areaspace *</_areaspace_note_>
gen areaspace = .
notes areaspace: the NSS-SCH2 does not contain the information needed to define this variable
*</_areaspace_>

*<_ybuilt_>
*<_ybuilt_note_> Year the dwelling built *</_ybuilt_note_>
/*<_ybuilt_note_>  *</_ybuilt_note_>*/
*<_ybuilt_note_> missing variable, no information in the NSS-SCH2 to define ybuilt *</_ybuilt_note_>
gen ybuilt = .
notes ybuilt: the NSS-SCH2 does not contain the information needed to define this variable
*</_ybuilt_>
...
gen     ownhouse = 1 	if  dwellingcode==1 		/* owned		 */
replace ownhouse = 2 	if  dwellingcode==2			/* hired		 */
...
*<_acqui_house_note_> missing variable, no information in the NSS-SCH2 to define acqui_house *</_acqui_house_note_>
gen acqui_house = .
notes acqui_house: the NSS-SCH2 does not contain the information needed to define this variable
*</_acqui_house_>

*<_dwelownlti_>
*<_dwelownlti_note_> Legal title for Ownership *</_dwelownlti_note_>
/*<_dwelownlti_note_> 1 "Yes" 0 "No" *</_dwelownlti_note_>*/
*<_dwelownlti_note_> missing variable, no information in the NSS-SCH2 to define dwelownlti *</_dwelownlti_note_>
gen dwelownlti = .
notes dwelownlti: the NSS-SCH2 does not contain the information needed to define this variable
*</_dwelownlti_>
...
*<_fem_dwelownlti_note_> missing variable, no information in the NSS-SCH2 to define fem_dwelownlti *</_fem_dwelownlti_note_>
gen fem_dwelownlti = .
notes fem_dwelownlti: the NSS-SCH2 does not contain the information needed to define this variable
*</_fem_dwelownlti_>
...
*<_dwelownti_note_> missing variable, no information in the NSS-SCH2 to define dwelownti *</_dwelownti_note_>
gen dwelownti = .
notes dwelownti: the NSS-SCH2 does not contain the information needed to define this variable
*</_dwelownti_>

*<_selldwel_>
*<_selldwel_note_> Right to sell dwelling *</_selldwel_note_>
/*<_selldwel_note_> 1 "Yes" 0 "No" *</_selldwel_note_>*/
*<_selldwel_note_> missing variable, no information in the NSS-SCH2 to define selldwel *</_selldwel_note_>
gen selldwel = .
notes selldwel: the NSS-SCH2 does not contain the information needed to define this variable
*</_selldwel_>

*<_transdwel_>
*<_transdwel_note_> Right to transfer dwelling *</_transdwel_note_>
/*<_transdwel_note_> 1 "Yes" 0 "No" *</_transdwel_note_>*/
*<_transdwel_note_> missing variable, no information in the NSS-SCH2 to define transdwel *</_transdwel_note_>
gen transdwel = .
notes transdwel: the NSS-SCH2 does not contain the information needed to define this variable
*</_transdwel_>
...
gen 	ownland = 0
replace ownland = 1			if  landown==1 & landowntyp>=1 & landowntyp<=2
*</_ownland_>
...
*<_acqui_land_note_> missing variable, no information in the NSS-SCH2 to define acqui_land *</_acqui_land_note_>
gen acqui_land = .
notes acqui_land: the NSS-SCH2 does not contain the information needed to define this variable
*</_acqui_land_>

*<_doculand_>
*<_doculand_note_> Legal document for residential land *</_doculand_note_>
/*<_doculand_note_> 1 "Yes" 0 "No" *</_doculand_note_>*/
*<_doculand_note_> missing variable, no information in the NSS-SCH2 to define doculand *</_doculand_note_>
gen doculand = .
notes doculand: the NSS-SCH2 does not contain the information needed to define this variable
*</_doculand_>
...
*<_fem_doculand_note_> missing variable, no information in the NSS-SCH2 to define fem_doculand *</_fem_doculand_note_>
gen fem_doculand = .
notes fem_doculand: the NSS-SCH2 does not contain the information needed to define this variable
*</_fem_doculand_>
...
*<_landownti_note_> missing variable, no information in the NSS-SCH2 to define landownti *</_landownti_note_>
gen landownti = .
notes landownti: the NSS-SCH2 does not contain the information needed to define this variable
*</_landownti_>

*<_sellland_>
*<_sellland_note_> Right to sell land *</_sellland_note_>
/*<_sellland_note_> 1 "Yes" 0 "No" *</_sellland_note_>*/
*<_sellland_note_> missing variable, no information in the NSS-SCH2 to define sellland *</_sellland_note_>
gen sellland = .
notes sellland: the NSS-SCH2 does not contain the information needed to define this variable
*</_sellland_>

*<_transland_>
*<_transland_note_> Right to transfer land *</_transland_note_>
/*<_transland_note_> 1 "Yes" 0 "No" *</_transland_note_>*/
*<_transland_note_> missing variable, no information in the NSS-SCH2 to define transland *</_transland_note_>
gen transland = .
notes transland: the NSS-SCH2 does not contain the information needed to define this variable
*</_transland_>

*<_agriland_>
*<_agriland_note_> Agriculture Land *</_agriland_note_>
/*<_agriland_note_> 1 "Yes" 0 "No" *</_agriland_note_>*/
*<_agriland_note_> missing variable, no information in the NSS-SCH2 to define agriland *</_agriland_note_>
gen agriland = .
notes agriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_agriland_>

*<_area_agriland_>
*<_area_agriland_note_> Area of Agriculture land *</_area_agriland_note_>
/*<_area_agriland_note_> *</_area_agriland_note_>*/
*<_area_agriland_note_> missing variable, no information in the NSS-SCH2 to define area_agriland *</_area_agriland_note_>
gen area_agriland = .
notes area_agriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_area_agriland_>
...
gen 	ownagriland = 0
replace ownagriland = 1		if  landowntyp>=2 & landowntyp<=3
...
destring landown_ha, replace
gen area_ownagriland = landown_ha/2.471
*</_area_ownagriland_>

*<_purch_agriland_>
*<_purch_agriland_note_> Purchased agri land *</_purch_agriland_note_>
/*<_purch_agriland_note_> 1 "Yes" 0 "No" *</_purch_agriland_note_>*/
*<_purch_agriland_note_> missing variable, no information in the NSS-SCH2 to define purch_agriland *</_purch_agriland_note_>
gen purch_agriland = .
notes purch_agriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_purch_agriland_>
...
*<_areapurch_agriland_note_> missing variable, no information in the NSS-SCH2 to define areapurch_agriland *</_areapurch_agriland_note_>
gen areapurch_agriland = .
notes areapurch_agriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_areapurch_agriland_>
...
*<_inher_agriland_note_> missing variable, no information in the NSS-SCH2 to define inher_agriland *</_inher_agriland_note_>
gen inher_agriland = .
notes inher_agriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_inher_agriland_>
...
*<_areainher_agriland_note_> missing variable, no information in the NSS-SCH2 to define areainher_agriland *</_areainher_agriland_note_>
gen areainher_agriland = .
notes areainher_agriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_areainher_agriland_>

*<_rentout_agriland_>
*<_rentout_agriland_note_> Rent Out Land *</_rentout_agriland_note_>
/*<_rentout_agriland_note_> 1 "Yes" 0 "No" *</_rentout_agriland_note_>*/
*<_rentout_agriland_note_> missing variable, no information in the NSS-SCH2 to define rentout_agriland *</_rentout_agriland_note_>
gen rentout_agriland = .
notes rentout_agriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_rentout_agriland_>
...
*<_arearentout_agriland_note_> missing variable, no information in the NSS-SCH2 to define arearentout_agriland *</_arearentout_agriland_note_>
gen arearentout_agriland = .
notes arearentout_agriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_arearentout_agriland_>

*<_rentin_agriland_>
*<_rentin_agriland_note_> Rent in Land *</_rentin_agriland_note_>
/*<_rentin_agriland_note_> 1 "Yes" 0 "No" *</_rentin_agriland_note_>*/
*<_rentin_agriland_note_> missing variable, no information in the NSS-SCH2 to define rentin_agriland *</_rentin_agriland_note_>
gen rentin_agriland = .
notes rentin_agriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_rentin_agriland_>
...
*<_arearentin_agriland_note_> missing variable, no information in the NSS-SCH2 to define arearentin_agriland *</_arearentin_agriland_note_>
gen arearentin_agriland = .
notes arearentin_agriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_arearentin_agriland_>

*<_docuagriland_>
*<_docuagriland_note_> Documented Agri Land *</_docuagriland_note_>
/*<_docuagriland_note_> 1 "Yes" 0 "No" *</_docuagriland_note_>*/
*<_docuagriland_note_> missing variable, no information in the NSS-SCH2 to define docuagriland *</_docuagriland_note_>
gen docuagriland = .
notes docuagriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_docuagriland_>
...
*<_area_docuagriland_note_> missing variable, no information in the NSS-SCH2 to define area_docuagriland *</_area_docuagriland_note_>
gen area_docuagriland = .
notes area_docuagriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_area_docuagriland_>
...
*<_fem_agrilandownti_note_> missing variable, no information in the NSS-SCH2 to define fem_agrilandownti *</_fem_agrilandownti_note_>
gen fem_agrilandownti = .
notes fem_agrilandownti: the NSS-SCH2 does not contain the information needed to define this variable
*</_fem_agrilandownti_>
...
*<_agrilandownti_note_> missing variable, no information in the NSS-SCH2 to define agrilandownti *</_agrilandownti_note_>
gen agrilandownti = .
notes agrilandownti: the NSS-SCH2 does not contain the information needed to define this variable
*</_agrilandownti_>

*<_sellagriland_>
*<_sellagriland_note_> Right to sell agri land *</_sellagriland_note_>
/*<_sellagriland_note_> 1 "Yes" 0 "No" *</_sellagriland_note_>*/
*<_sellagriland_note_> missing variable, no information in the NSS-SCH2 to define sellagriland *</_sellagriland_note_>
gen sellagriland = .
notes sellagriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_sellagriland_>
...
*<_transagriland_note_> missing variable, no information in the NSS-SCH2 to define transagriland *</_transagriland_note_>
gen transagriland = .
notes transagriland: the NSS-SCH2 does not contain the information needed to define this variable
*</_transagriland_>
