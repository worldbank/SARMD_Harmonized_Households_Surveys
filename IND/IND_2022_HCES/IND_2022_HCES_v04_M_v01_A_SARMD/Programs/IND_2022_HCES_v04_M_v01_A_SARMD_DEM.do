/*----------------------------------------------------------------------------------
  SARMD Harmonization
------------------------------------------------------------------------------------
<_Program name_>   		IND_2022_HCES_v04_M_v01_SARMD_DEM.do	   	   </_Program name_>
...
<_Version Control_>
Date:					02-2026
File:					IND_2022_HCES_v04_M_v01_SARMD_DEM.do
First version
</_Version Control_>
----------------------------------------------------------------------------------*/
...
gen   language = "."
notes language: HCES 2022 does not collect information on language 
*</_language_>
...
gen   age = b3q5
notes age: age range in HCES 2022: 0-120
*</_age_>
...
gen   childmth = .
notes childmth: HCES 2022 does not collect information on age of individual in complete months 
*</_childyr_>
...
label define b3q3 1 "1 - Head of the household" 2 "2 - Spouse of the Head" 3 "3 - Married Child" 4 "4 - Spouse of Married Child" 5 "5 - Unmarried Child" 6 "6 - Grandchild" 7 "7 - Father/Mother/Father-in-law/Mother-in-law" 8 "8- Brother/Sister/Brother-in-law/Sister-in-law" 9 "9 - Servants/Employees/Other non-relatives"
...
gen     literacy = 0	if  b3q7==1
replace literacy = 1	if  b3q7>=2 & b3q7<=13
*</_literacy_>
...
gen   everattend = .
notes everattend: HCES 2022 does not collect information on school attendance 
*</_everattend_>
...
replace educat7 = 5		if  b3q7==6 & b3q8>=12 & b3q8<=18 	
replace educat7 = 5		if  b3q7>=8 & b3q7<=10 & b3q8>=8 & b3q8<=12
replace educat7 = 6		if  b3q7==7 | (b3q7>=8 & b3q7<=10 & b3q8>=13 & b3q8<=18) 
...
gen 	educy = b3q8 
replace educy = 0 	if   b3q7<=2 & b3q8==.
*</_educy_>
...
gen   school = .
notes school: HCES 2022 does not collect information on school attendance
*</_atschool_>
...
gen   eye_dsablty = .
notes eye_dsablty: HCES 2022 does not collect information on disabilities
*</_eye_dsablty_>
...
gen   hear_dsablty = .
notes hear_dsablty: HCES 2022 does not collect information on disabilities
*</_hear_dsablty_>
...
gen   walk_dsablty = .
notes walk_dsablty: HCES 2022 does not collect information on disabilities
...
gen   conc_dsord = .
notes conc_dsord: HCES 2022 does not collect information on disabilities
*</_conc_dsord_>
...
gen   slfcre_dsablty = .
notes slfcre_dsablty: HCES 2022 does not collect information on disabilities
*</_slfcre_dsablty_>
...
gen   comm_dsablty = .
notes comm_dsablty: HCES 2022 does not collect information on disabilities
*</_comm_dsablty_>
