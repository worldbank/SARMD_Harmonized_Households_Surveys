/*----------------------------------------------------------------------------------
  SARMD Harmonization
------------------------------------------------------------------------------------
<_Program name_>   		IND_2022_HCES_v04_M_v01_SARMD_IND.do   	   </_Program name_>
...
<_Version Control_>
Date:					02-2026
File:					IND_2022_HCES_v04_M_v01_SARMD_IND.do
First version
</_Version Control_>
----------------------------------------------------------------------------------*/
...
merge m:1 hhid using "${input}\\IND_PRIMUS_2022-23.dta", keepusing(pwt welfarenom_final welfaredef_final cpi_2022 cpi_2017 cpi_2021 hhsize)
*</_Datalibweb request_>
...
gen 	religion = "."
replace religion = "1 - Hinduism"		if  b4q4pt11==1
replace religion = "2 - Islam"			if  b4q4pt11==2
replace religion = "3 - Christianity"	if  b4q4pt11==3
replace religion = "4 - Sikhism"		if  b4q4pt11==4
replace religion = "5 - Jainism"		if  b4q4pt11==5
replace religion = "6 - Buddhism"		if  b4q4pt11==6
replace religion = "7 - Zoroastrianism"	if  b4q4pt11==7
replace religion = "9 - Other"			if  b4q4pt11==9 
*</_religion_>
...
gen 	shared_toilet = 0
replace shared_toilet = 1			if  b4q4pt25!=1
*</_sar_improved_toilet_>
