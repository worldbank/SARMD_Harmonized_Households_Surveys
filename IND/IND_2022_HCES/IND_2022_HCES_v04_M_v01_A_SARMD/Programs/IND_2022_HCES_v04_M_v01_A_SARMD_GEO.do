/*----------------------------------------------------------------------------------
  SARMD Harmonization
------------------------------------------------------------------------------------
<_Program name_>   		IND_2022_HCES_v04_M_v01_SARMD_GEO.do	       </_Program name_>
...
<_Version Control_>
Date:				02-2026
File:				IND_2022_HCES_v04_M_v01_SARMD_GEO.do
First version
</_Version Control_>
----------------------------------------------------------------------------------*/
...
egen strata = concat(state sector stratum sub_stratum b1q1pt11), punct(-)
*</_strata_>
