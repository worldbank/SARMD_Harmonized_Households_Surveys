/*------------------------------------------------------------------------------
  SARMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   		IND_2022_HCES_v04_M.do			   	   </_Program name_>
...
keep if b8pt1q2>="331" & b8pt1q2<="346" 
keep hhid b8pt1q2 b8pt1q6
rename b8pt1q6 exp
reshape wide exp, i(hhid) j(b8pt1q2) string
...
keep if   b9pt1q2=="487" | b9pt1q2=="488" | b9pt1q2=="496" | b9pt1q2=="512" | b9pt1q2=="513" | b9pt1q2=="540"
keep hhid b9pt1q2 b9pt1q3
rename b9pt1q3 exp
reshape wide exp, i(hhid) j(b9pt1q2) string
...
* LVL 08_EXPENDITURES										  ---> reshaped 
* LVL 09:  7,942,402 observations (item level)  			  ---> reshape
* LVL 09_EXPENDITURES										  ---> reshaped 
...
drop if _merge!=3
drop _merge
merge m:1 hhid using "${input}\\IND_PRIMUS_2022-23.dta", keepusing(welfarenom_base welfaredef_base pwt welfarenom_final welfaredef_final cpi* hhwt hhsize)
drop _merge
