/*----------------------------------------------------------------------------------
  SARMD Harmonization
------------------------------------------------------------------------------------
<_Program name_>   		IND_2023_HCES_v01_M_v01_SARMD_UTL.do		   </_Program name_>
...
<_Version Control_>
Date:					02-2026
File:					IND_2023_HCES_v01_M_v01_SARMD_UTL.do
First version
</_Version Control_>
----------------------------------------------------------------------------------*/
...
destring Energy_Source_Cooking, replace
gen 	gas = 0			
replace gas = 1		if  Energy_Source_C==2
replace gas = 2		if  Energy_Source_C==3
replace gas = 3		if  Energy_Source_C==7 | Energy_Source_C==8
...
gen 	cooksource = 1		if  Energy_Source_C==1																	// firewood and chips 									//
replace cooksource = 2		if  Energy_Source_C==5																	// kerosene 											//
replace cooksource = 3		if  Energy_Source_C==6 | Energy_Source_C==10											// coke-coal / charcoal									//
replace cooksource = 4 		if  Energy_Source_C==11																	// Electricity											//
replace cooksource = 5		if  Energy_Source_C==2 | Energy_Source_C==3 | Energy_Source_C==7 | Energy_Source_C==8	// LPG / other natural gas / gobar gas / other biogas	//
replace cooksource = 9		if  Energy_Source_C==4 | Energy_Source_C==9												// dung cake / Other									//  
replace cooksource = 10		if  Energy_Source_C==12																	// no cooking arrangement								//
...
destring Energy_Source_Lighting, replace
gen 	lightsource = 1		if  Energy_Source_L==1							// electricity (including generated by wind and solar power generators	// 
replace lightsource = 2		if  Energy_Source_L==2							// kerosene																//
replace lightsource = 3		if  Energy_Source_L==5							// candles 																//
replace lightsource = 4		if  Energy_Source_L==4							// gas																	//
replace lightsource = 9		if  Energy_Source_L==3 | Energy_Source_L==9		// other oil / other													//
replace lightsource = 10	if  Energy_Source_L==6							// no lighting arrangement												//
...
gen     elec_acc = 4			
replace elec_acc = 3		if  Energy_Source_L==1	
*</_elec_acc_>
...
gen 	electricity = 0		if  Energy_Source_L!=.
replace electricity = 1		if  Energy_Source_L==1
*</_electricity_>
