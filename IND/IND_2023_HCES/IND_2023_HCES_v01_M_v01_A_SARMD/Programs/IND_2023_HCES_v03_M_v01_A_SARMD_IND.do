/*----------------------------------------------------------------------------------
  SARMD Harmonization
------------------------------------------------------------------------------------
<_Program name_>   		IND_2023_HCES_v01_M_v01_SARMD_IND.do   	   </_Program name_>
...
<_Version Control_>
Date:					02-2026
File:					IND_2023_HCES_v01_M_v01_SARMD_IND.do
First version
</_Version Control_>
----------------------------------------------------------------------------------*/
...
gen 	soc = "."
replace soc = "1 - Scheduled Tribe"			if  Social_Group==1
replace soc = "2 - Scheduled Caste"			if  Social_Group==2
replace soc = "3 - Other Backward Caste"	if  Social_Group==3
replace soc = "9 - Other"					if  Social_Group==9
...
destring Religion_of_HH_Head, replace
gen 	religion = "."
replace religion = "1 - Hinduism"		if  Religion_of_HH_Head==1
replace religion = "2 - Islam"			if  Religion_of_HH_Head==2
replace religion = "3 - Christianity"	if  Religion_of_HH_Head==3
replace religion = "4 - Sikhism"		if  Religion_of_HH_Head==4
replace religion = "5 - Jainism"		if  Religion_of_HH_Head==5
replace religion = "6 - Buddhism"		if  Religion_of_HH_Head==6
replace religion = "7 - Zoroastrianism"	if  Religion_of_HH_Head==7
replace religion = "9 - Other"			if  Religion_of_HH_Head==9 
*</_religion_>
...
gen   lamp = .
notes lamp: the HCES only collects information on expendidure for the purchase of electric fans in the last 365 days
*</_fan_>
...
gen double welfare = mpce_sp_def_ind*12.0
*</_welfare_>
...
gen welfaredef = mpce_sp_def_ind*12
*</_welfaredef_>
...
destring FDQ, gen(fdq)
count 						if  fdq==. & relationharm==1 						
...
replace fdq_new = 1 		if  fdq_new==. & relationharm==1 			
replace fdq_new = . 		if  fdq_miss_head==1 & select==1 			
...
replace fdq_new = . 		if  fdq_miss_head==1 & (n_fdq_new>n_fdq_or) & relationharm==2 	
