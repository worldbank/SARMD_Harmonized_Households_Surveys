...
destring Possess*, replace
gen   	cellphone = 0	
replace cellphone = 1	if  Possess_Mobile==1
*</_cellphone_>
...
gen	    computer = 0	
replace computer = 1	if  Possess_Laptop==1
*</_computer_>
...
*<_internet_note_> no information on ownership of an internet connection *</_internet_note_>
destring Used_Internet_Last_30_Days, replace
egen aux_internet = min(Used_Internet_Last_30_Days), by(hhid)
gen 	internet = 3	if  aux_internet==1
replace internet = 4	if  internet==.
*</_internet_>
...
gen     radio = 0		
replace radio = 1		if  Possess_Radio==1
*</_radio_>
...
gen     tv = 0			
replace tv = 1 			if  Possess_Television==1
*</_tv_>
...
destring TV_Facility, replace
gen     tv_cable = 0	
replace tv_cable = 1	if  TV_Facility==2 | TV_Facility==3		// cable tv + satellite tv
*</_tv_cable_>
...
gen     fridge = 0 		
replace fridge = 1		if  Possess_Refri==1
*</_fridge_>
...
gen     washmach = 0	
replace washmach = 1	if  Possess_Washing==1
*</_washmach_>
...
gen 	ac = 0		
replace ac = 1		if  Possess_AirCooler==1
*</_ac_>
...
gen   	car = 0			
replace car = 1		if  Possess_Car==1 | Possess_Truck==1
*</_car_>
...
gen 	mcycle = 0 		
replace mcycle = 1	if  Possess_Scooter==1
*</_mcycle_>
...
gen 	bcycle = 0		
replace bcycle = 1	if  Possess_Bicycle==1
*</_bcycle_>
...
gen   	oxcart = 0 		
replace oxcart = 1	if  Possess_Animal==1
*</_oxcart_>
...
*<_roofcs_note_> no information on the main material used for roof *</_roofcs_note_>
gen roofcs = "."
notes roofcs: missing variable, no information on main material used for roof
*</_roofcs_>
...
*<_roof_note_> no information on the main material used for roof  *</_roof_note_>
gen roof = .
notes roof: missing variable, no information on main material used for roof
*</_roof_>

*<_wallcs_>
*<_wallcs_note_> Main material used for wall *</_wallcs_note_>
/*<_wallcs_note_> *</_wallcs_note_>*/
*<_wallcs_note_> no information on the main material used for wall *</_wallcs_note_>
gen wallcs = "."
notes wallcs: missing variable, no information on main material used for wall
*</_wallcs_>
...
*<_wall_note_> no information on the main material used for wall *</_wall_note_>
gen wall = .
notes wall: missing variable, no information on main material used for wall
*</_wall_>

*<_floorcs_>
*<_floorcs_note_> Main material used for floor *</_floorcs_note_>
/*<_floorcs_note_> *</_floorcs_note_>*/
*<_floorcs_note_> no information on the main material used for floor *</_floorcs_note_>
gen floorcs = "."
notes floorcs: missing variable, no information on main material used for floor
*</_floorcs_>
...
*<_floor_note_> no information on the main material used for floor *</_floor_note_>
gen floor = .
notes floor: missing variable, no information on main material used for floor
*</_floor_>
...
destring Type_of_Dwelling, replace
gen     ownhouse = 1 		if  Type_of_Dwelling==1 		/* owned		 */
replace ownhouse = 2 		if  Type_of_Dwelling==2			/* hired		 */
...
destring Land_Ownership Type_of_Land, replace
gen 	ownland = 0
replace ownland = 1			if  Land_Ownership==1 & Type_of_Land>=1 & Type_of_Land<=2
*</_ownland_>
...
gen 	ownagriland = 0
replace ownagriland = 1		if  Type_of_Land>=2 & Type_of_Land<=3
...
destring Total_Area_Land, replace
gen area_ownagriland = Total_Area_Land/2.471
*</_area_ownagriland_>
