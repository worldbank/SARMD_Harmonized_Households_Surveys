/*----------------------------------------------------------------------------------
  SARMD Harmonization
------------------------------------------------------------------------------------
<_Program name_>   		IND_2023_HCES_v01_M_v01_SARMD_DEM.do		   </_Program name_>
...
<_Version Control_>
Date:					02-2026
File:					IND_2023_HCES_v01_M_v01_SARMD_DEM.do
First version
</_Version Control_>
----------------------------------------------------------------------------------*/
...
*<_language_note_> missing variable, HCES does not collect information on language *</_language_note_>
gen   language = "."
notes language: HCES 2023 does not collect information on language 
*</_language_>

*<_age_>
*<_age_note_> Age of individual (continuous) *</_age_note_>
/*<_age_note_> Age is an important variable for most socio-economic analysis and must be established as accurately as possible. Especially for children aged less than 5 years, this is used to interpret Anthropometrics data. *</_age_note_>*/
*<_age_note_> age brought in from rawdata *</_age_note_>
destring Age, replace 
gen   age = Age
notes age: age range in HCES 2023: 0-120
*</_age_>
...
*<_childmth_note_> missing variable, HCES does not collect information on childmth *</_childmth_note_>
gen   childmth = .
notes childmth: HCES 2023 does not collect information on age of individual in complete months 
*</_childyr_>
...
replace male = 9			if  Gender==3
notes   male: Those cases answering "Transgender" are coded as male = 9
*</_male_>
...
gen 	relationharm = 1	if  Relation_to_Head==1
replace relationharm = 2	if  Relation_to_Head==2
replace relationharm = 3	if  Relation_to_Head==3 | Relation_to_Head==5
replace relationharm = 4	if  Relation_to_Head==7
replace relationharm = 5	if  Relation_to_Head==4 | Relation_to_Head==6 | Relation_to_Head==8 
replace relationharm = 6	if  Relation_to_Head==9
*</_relationharm_>

*<_relationcs_>
*<_relationcs_note_> Relationship to head of household country/region specific *</_relationcs_note_>
/*<_relationcs_note_> country specific categories *</_relationcs_note_>*/
...
label define Relation_to_Head 1 "1 - Head of the household" 2 "2 - Spouse of the Head" 3 "3 - Married Child" 4 "4 - Spouse of Married Child" 5 "5 - Unmarried Child" 6 "6 - Grandchild" 7 "7 - Father/Mother/Father-in-law/Mother-in-law" 8 "8- Brother/Sister/Brother-in-law/Sister-in-law" 9 "9 - Servants/Employees/Other non-relatives"
label values Relation_to_Head Relation_to_Head
decode Relation_to_Head, gen(relationcs)
*</_relationcs_>
...
destring Education_Level Years_of_Education, replace
gen     literacy = 0	if  Education_Level==1
replace literacy = 1	if  Education_Level>=2 & Education_Level<=13
*</_literacy_>
...
*<_everattend_note_> missing variable, HCES does not collect information on school attendance *</_everattend_note_>
gen   everattend = .
notes everattend: HCES 2023 does not collect information on school attendance 
*</_everattend_>
...
gen	 	educat7 = .
replace educat7 = 1		if  Education_Level==1 | Education_Level==2					
replace educat7 = 2		if  Education_Level==3								
replace educat7 = 2		if  Education_Level==4 & Years_of_Education>=4 & Years_of_Education<=6
replace educat7 = 3		if  Education_Level==4 & Years_of_Education>=7 & Years_of_Education<=11
replace educat7 = 4		if  Education_Level==5
replace educat7 = 4 	if  Education_Level==6 & Years_of_Education>=10 & Years_of_Education<=11
replace educat7 = 5		if  Education_Level==6 & Years_of_Education>=12 & Years_of_Education<=18 	
replace educat7 = 5		if  Education_Level>=8 & Education_Level<=10 & Years_of_Education>=8 & Years_of_Education<=12
replace educat7 = 6		if  Education_Level==7 | (Education_Level>=8 & Education_Level<=10 & Years_of_Education>=13 & Years_of_Education<=21) 
replace educat7 = 6		if  Education_Level==11
replace educat7 = 7		if  Education_Level==12 | Education_Level==13
*</_educat7_>
...
/*<_educy_note_> Variable is constructed for all persons administered this module in each questionnaire. For this reason the lower age cutoff at which information is collected will vary from country to country. This is a continuous variable of the number of years of formal schooling completed *</_educy_note_>*/
*<_educy_note_>  *</_educy_note_>
gen 	educy = Years_of_Education 
replace educy = 0 	if   Education_Level<=2 & Years_of_Education==.
*</_educy_>
...
gen   school = .
notes school: HCES 2023 does not collect information on school attendance
*</_atschool_>
...
gen   eye_dsablty = .
notes eye_dsablty: HCES 2023 does not collect information on disabilities
*</_eye_dsablty_>
...
gen   hear_dsablty = .
notes hear_dsablty: HCES 2023 does not collect information on disabilities
*</_hear_dsablty_>
...
gen   walk_dsablty = .
notes walk_dsablty: HCES 2023 does not collect information on disabilities
...
gen   conc_dsord = .
notes conc_dsord: HCES 2023 does not collect information on disabilities
*</_conc_dsord_>
...
gen   slfcre_dsablty = .
notes slfcre_dsablty: HCES 2023 does not collect information on disabilities
*</_slfcre_dsablty_>
...
gen   comm_dsablty = .
notes comm_dsablty: HCES 2023 does not collect information on disabilities
*</_comm_dsablty_>
