...
** DATABASE ASSEMBLENT
	...
	use "`input'\Data\Stata\interview_actions.dta", clear
	...
	use "`input'\Data\Stata\hhroster.dta"
	rename (ParentId1 Id) (Id pid)
	merge m:1 Id using "`input'\Data\Stata\version 2 bhutan living standard survey 2017 final.dta"
	drop if _m==2
	drop _m
	rename Id houseid
	merge m:1 houseid using "`input'\Data\Stata\poverty_estimate_CPI.dta"
	drop if _m==2
	drop _m
	merge m:1 houseid using "`input'\Data\Stata\psu.dta"
	drop if _m==2
	drop _m
...
*<_arearentout_agriland_>
                ...
                gen byte arearentout_agriland=AS10b+AS11b
...
*<_rentout_agriland_>
                ...
                gen byte rentout_agriland=0
				replace rentout_agriland=1 if arearentout_agriland>0 & arearentout_agriland!=.
...
*<_arearentin_agriland_>
                ...
                gen byte arearentin_agriland=AS10d+AS11d
...
*<_rentin_agriland_>
                ...
                gen byte rentin_agriland=0
				replace rentin_agriland=1 if arearentin_agriland>0 & arearentin_agriland!=.
...
*<_dweltyp_>
                ...
                gen byte dweltyp=HS1
				recode dweltyp (1=1) (2=2) (3=3) (4=4) (5=9)
	...
	*do "$fixlabels\fixlabels", nostop
	...
	keep countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year subnatid0 ///
		...
		water_original water_source improved_water pipedwater_acc watertype_quest sanitation_original sanitation_source improved_sanitation toilet_acc ///
	     computer internet hsize relationharm relationcs male age soc marital eye_dsablty hear_dsablty walk_dsablty conc_dsord slfcre_dsablty comm_dsablty ed_mod_age everattend language ///
		 ...
		 landphone cellphone computer radio television fan sewingmachine washingmachine refrigerator lamp bicycle motorcycle motorcar cow buffalo chicken etablet stove video rooms roof wall floor dweltyp acqui_house agriland area_agriland ownagriland area_ownagriland rentout_agriland arearentout_agriland rentin_agriland arearentin_agriland ///
...
** DELETE MISSING VARIABLES
	...
	*saveold "`output'\Data\Harmonized\BTN_2017_BLSS_v01_M_v05_A_SARMD_IND.dta", replace version(12)
	*saveold "${rootdatalib}\\${folder}\__REGIONAL\Individual Files\BTN_2017_BLSS_v01_M_v05_A_SARMD_IND.dta", replace version(12)
	save "`path'\Harmonized\BTN_2017_BLSS_v01_M_v02_A_SARMD_IND.dta", replace 
	*notes
	*log close
