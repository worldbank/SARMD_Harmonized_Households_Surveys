/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   BTN_2022_BLSS_v01_M_v01_A_SARMD_COR.do	</_Program name_>
<_Application_>    STATA 16.0	<_Application_>
<_Author(s)_>      jogreen@worldbank.org	</_Author(s)_>
<_Modified_by_>    acastillo@worldbank@worldbank.org	</__>
<_Date created_>   11-22-2022	</_Date created_>
<_Date modified>   21-22-2022	</_Date modified_>
--------------------------------------------------------------------------------
...
<_Version Control_>
Date:	11-22-2022
File:	BTN_2022_BLSS_v01_M_v01_A_SARMD_COR.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
*<_Program setup_>
...
* global paths on WB computer
	...
	if ( "${rootdatalib}"=="") glo rootdatalib "C:/Users/`c(username)'/OneDrive - WBG/SAR/06.SARMD/SAR_DATABANK"
	*<_Folder creation_>
...
*<_converfactor_>
*<_converfactor_note_> Conversion factor *</_countrycode_note_>
*<_converfactor_note_> converfactor brought in from rawdata *</_countrycode_note_>
g converfactor = 1
*</_converfactor_>
...
cap egen literacy = rowmax(ed1__?)
*</_literacy_>
...
*g spdef = paasche_res*cpi_tot
*</_spdef_>

*<_Keep variables_>
order countrycode year hhid pid weight weighttype converfactor  cpiperiod harmonization ppp educat7 educat5 educat4 educy hsize literacy primarycomp school survey veralt vermast welfare welfaredef welfarenom welfareother welfareothertype welfaretype welfshprosperity welfshprtype spdef
