...
** HOUSE OWNERSHIP
*<_ownhouse_>
	recode g01 (1=1) (2/3=2) (4=3) (*=.), g(ownhouse)
*</_ownhouse_>
...
*</_water_original_>
	...
	*<_improved_water_>
		recode g05 (1/5 8=1) (6/7 9=0) (*=.), g(improved_water)
	*</_improved_water_>
...
*<_toilet_jmp_>
recode g06  (2=1) (3=2) (4=4) (1=12) (5=13) (6=13) (7=13) (*=.), g(toilet_jmp)
...
*</_sar_improved_toilet_>
	...
	*<_sanitation_source_>
		...
		replace sanitation_source=9 if g06==4
	...
	*<_toilet_acc_>
		recode g06 (1 5/7=0) (2/4=3), g(toilet_acc)
		#delimit 
...
** COMPUTER
*<_computer_>
	gen byte computer = (f11l==1) if inlist(f11l,1,2)
...
** RADIO
*<_radio_>
	gen radio = (f11d==1) if inlist(f11d,1,2)
...
** COW
*<_cow_>
	gen cow = (f4a==1) if inlist(f4a,1,2)
...
** CHICKEN
*<_chicken_>
	gen chicken = (f7a==1) if inlist(f7a,1,2)
...
foreach var_notfound in shared_toilet industry_year industry_2_year industry_orig_year industry_orig_2_year occup_year ocusec_year {
	...
	note `var_notfound': PAK_2004_HIES does not have any relevant questions or variables.
}
...
foreach var_notfound in converfactor gaul_adm2_code gaul_adm3_code sector pline_int poor_int {
	g `var_notfound'=.
	note `var_notfound': For PAK_2004_HIES, I did not have a sufficient understanding of how `var_notfound' is defined from the SAR team, so it was created as missing.
}
