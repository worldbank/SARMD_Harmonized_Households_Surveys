...
** DIRECTORY
    local input      "$rootdatalib\PAK\PAK_2004_HIES\PAK_2004_HIES_v01_M"
	local output     "$rootdatalib\PAK\PAK_2004_HIES\PAK_2004_HIES_v01_M_v0`v'_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\PAK_2004_HIES_v01_M_v0`v'_A.log",replace
...
*<_educat7_>
	...
	*Attended in the past 
	replace educat7 = 1 if c03 == 2 //Never attended 
	replace educat7 = 2 if c04 < 5
	replace educat7 = 3 if c04 == 5
	replace educat7 = 4 if c04 >= 6  & c04 < 10  & c04 != . 
	replace educat7 = 5 if c04 == 10
	replace educat7 = 6 if c04 == 11
	replace educat7 = 7 if inlist(c04,12,13,14,15,16,17,18)
	replace educat7 = 8 if c04 == 19
	*Currently attending
	replace educat7 = 2 if (c06 >= 1   & c06 <= 5)  & c05==1
	replace educat7 = 3 if (c06 >= 6   & c06 <= 9)  & c05==1
	replace educat7 = 4 if (c06 == 10) & c05==1
	replace educat7 = 5 if (c06 == 11) & c05==1 
	replace educat7 = 7 if inlist(c06,12,13,14,15,16,17,18)
	replace educat7 = 8 if c06 == 19   & c05==1  & educat7==.
	replace educat7 =.z if c07==4
	*Without the minimum age 
...
*<_cpi_>
	...
	*ren cpi`year'_w cpi
	label variable cpi2011_06 "CPI (CPI from January 2005 base 2011)"
	label variable cpi2017_06 "CPI (CPI from January 2005 base 2017)"
*</_cpi_>
...
** KEEP VARIABLES - ALL
	...
	keep countrycode code year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year fieldwork  ///
		...
		water_original water_source improved_water pipedwater_acc watertype_quest sanitation_original sanitation_source improved_sanitation toilet_acc ///
		 ...
		 pline_nat pline_int* poor_nat poor_int* spdef cpi* ppp* welfare welfshprosperity welfarenom welfaredef eqadult ///
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2004_HIES_v01_M_v0`v'_A_SARMD-FULL_IND.dta", replace version(12)
	*saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2004_HIES_v01_M_v0`v'_A_SARMD-FULL_IND.dta", replace version(13)
	log close
...
cap sum `i'
 ...
 These include the existing information from the particular survey, but the iformation should be used for comparability purposes  
	saveold "`output'\Data\Harmonized\PAK_2004_HIES_v01_M_v0`v'_A_SARMD_IND.dta", replace version(12)
	*saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2004_HIES_v01_M_v0`v'_A_SARMD_IND.dta", replace version(13)
