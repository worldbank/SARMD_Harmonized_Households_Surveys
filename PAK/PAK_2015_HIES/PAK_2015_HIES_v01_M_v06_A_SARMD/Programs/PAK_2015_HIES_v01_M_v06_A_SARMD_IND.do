...
global filename_ALL  "`code'_`year'_`survey'_v`vm'_M_v`va'_A_SARMD_ALL"
...
** HOUSE OWNERSHIP
*<_ownhouse_>
	recode s3aq02 (1/2=1) (3/4=2) (5=3) (*=.), g(ownhouse)
*</_ownhouse_>
...
*</_water_original_>
	...
	** WATER SOURCE
	*<_water_source_>
		recode s3aq06 (2/3=4) (4=10) (5 10=5) (6=13) (7=9) (8=7) (9=12) (11=14) (*=.), g(water_source)
		replace water_source = 1 if s3aq06==1 & s3aq10==0
		replace water_source = 3 if s3aq06==1 & inrange(s3aq10,1,5)
		#delimit
	...
	*<_improved_water_>
		gen improved_water=.
		replace improved_water=1 if inlist(water_source,1,2,3,4,5,6,7,8,12)
...
replace	toilet_jmp=13 if toilet_orig==4
replace	toilet_jmp=13 if toilet_orig==5
...
*</_sar_improved_toilet_>
	...
	*<_sanitation_source_>
		...
		replace sanitation_source=14 if s3aq15==4
		replace sanitation_source=14 if s3aq15==5
...
** INTERNET
	gen byte internet=1 if s3aq20a==1 | s3aq20b==1
	recode  internet (.=0) if s3aq20a==2 | s3aq20b==2
...
** LANGUAGE
*<_language_>
	*labvalch3 language , strfcn(proper(`"@"'))
	*numlabel language, add mask("# - ")
	*tab language
*</_language_>
...
** 
    label var s2ac04 "Has ever attended any educational institution"
	la de lbls2ac04 1 "Yes" 2 "No"
	label values s2ac04  lbls2ac04
	
	label var s2ac06 "is the person currently studying in any educational institution?"
	la de lbls2ac06 1 "Yes" 2 "No"
	label values s2ac06  lbls2ac06
...
*<_ed_mod_age_>
	...
	notes: PAK 2015 defines as minimum age 3 years old. However, to mantain consistency accross years, we used the minimum age defined in PAK 2018. 
*</_ed_mod_age_>


** CURRENTLY AT SCHOOL
*<_atschool_>
    gen atschool=0 if age>=4
	replace atschool=1 if s2ac06==1 & age>=4
	*replace atschool=. if age<ed_mod_age & age!=.
	label var atschool "Attending school"
	la de lblatschool 0 "No" 1 "Yes"
	label values atschool  lblatschool
	notes: Children from 0 to 3 years old were classified in the category not at school (equal to zero). To mantain consistency with other years. 
*</_atschool_>
...
**<_educy_>
	...
	recode  s2ac05 (11 12=13) (13=14) (14 15 17 18=16) (16=17) (20=.), gen (educy1)
	recode  s2ac05 (11 12=12) (13=13) (14 15 17 18=15) (16=16) (20=.), gen (educy2)
...
*	recode educy2 (11=12) (13=13) (14 15 17 18=15) (16=16) (20=.) if  s2ac05==. & s2ac07!=.
	gen educy3=.
	replace educy3=educy1
	replace educy3=educy2 if educy2>educy1
	gen educy=.
	replace educy=0 if s2ac01==2 
	replace educy=0 if s2ac04==2 
	replace educy=educy3 if educy==.
...
*<_educat7_>
	...
	*Attended in the past 
	replace educat7 = 1 if s2ac04 == 2
	replace educat7 = 2 if s2ac05 < 5
	replace educat7 = 3 if s2ac05 == 5
	replace educat7 = 4 if s2ac05 >= 6  & s2ac05 < 10  & s2ac05 != . 
	replace educat7 = 5 if s2ac05 == 10
	replace educat7 = 6 if s2ac05 >= 11 & s2ac05 <= 12  
	replace educat7 = 7 if inlist(s2ac05,13,14,15,16,17,18,19)
	replace educat7 = 8 if s2ac05 == 20
	*Currently attending
	replace educat7 = 2 if (s2ac07 >= 1   & s2ac07 <= 5)  & s2ac06==1
	replace educat7 = 3 if (s2ac07 >= 6   & s2ac07 <= 9)  & s2ac06==1
	replace educat7 = 4 if (s2ac07 == 10) & s2ac06==1
	replace educat7 = 5 if (s2ac07 >= 11  & s2ac07 <= 12) & s2ac06==1
	replace educat7 = 7 if inlist(s2ac07,13,14,15,16,17,18,19)
	replace educat7 = 8 if (s2ac07 == 20 ) & s2ac06==1    & educat7==.
	
	replace educat7 = .z if s2ac08==3 | s2ac08==4
...
*****************************************************************************************************/
	...
	*old: datalibweb, country(Support) year(2005) type(GMDRAW) surveyid(Support_2005_CPI_v`cpiver'_M) filename(Monthly_CPI.dta)
    *keep if inlist(code,"`code'")
	keep if code=="PAK"
	...
	*ren cpi`year'_w cpi
	label variable cpi2011_`cpiver' "CPI (CPI from January 2016 base 2011)"
	label variable cpi2017_`cpiver' "CPI (CPI from January 2016 base 2017)"
*</_cpi_>
...
*<_ppp_>
	...
	*old: datalibweb, country(Support) year(2005) type(GMDRAW) surveyid(Support_2005_CPI_v`cpiver'_M) filename(Yearly_CPI_Final.dta)
    ...
    *replace datalevel=2 if datalevel==1 & code!="IND"
	...
	label variable ppp2011_`cpiver'  "PPP (base 2011)"
	label variable ppp2017_`cpiver'  "PPP (base 2017)"
*</_ppp_>
...
*</_tenure_>	
	...
	*<_toilet_acc_>
		recode s3aq15 (1/3=3) (4/6=0), g(toilet_acc)
	*</_toilet_acc_>
 ...
 * have age, don't need to create agecat
  gen agecat=""
...
foreach var_notfound in shared_toilet industry_year industry_2_year industry_orig_year industry_orig_2_year occup_year ocusec_year {
	...
	note `var_notfound': PAK_2015_HIES does not have any relevant questions or variables.
}


* create variables that do not have sufficient definitions from the SAR team
foreach var_notfound in converfactor {
	g `var_notfound'=.
	note `var_notfound': For PAK_2015_HIES, I did not have a sufficient understanding of how `var_notfound' is defined from the SAR team, so it was created as missing.
}
