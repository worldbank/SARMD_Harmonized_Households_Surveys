...
merge 1:1 hhid pid using "$rootdatalib\\`code'\\`yearfolder'\\`SARMDfolder'\Data\Harmonized\\`filename'.dta", gen(merge_M_IND)
...
*<_Save data file_>;
*do 	 "$rootdatalib\\`code'\\`yearfolder'\\`SARMDfolder'\Programs\Labels_GMD_ALL.do"
do   "P:\SARMD\SARDATABANK\SARMDdofiles\_aux\Labels_GMD_All.do"
save "${rootdatalib}\\`code'\\`yearfolder'\\`SARMDfolder'\Data\Harmonized\\${filename_ALL}.dta" , replace
*</_Save data file_>;
