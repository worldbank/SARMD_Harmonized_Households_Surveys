...
------------------------------------------------------------------------------------
<_Program name_>   	PAK_2015_HIES_v02_M_v01_A_SAMRD_IND.do	       </_Program name_>
...
<_Version Control_>
Date:				04-2025
File:				PAK_2015_HIES_v02_M_v01_A_SAMRD_IND.do
First version
</_Version Control_>
----------------------------------------------------------------------------------*/
...
*<_ownhouse_>
recode s3aq02 (1/2=1) (3/4=2) (5=3) (*=.), gen(ownhouse)
*</_ownhouse_>

*<_typehouse_>
recode s3aq02 (1/2=1) (3/4=2) (5=3) (*=.), gen(typehouse)
*</_typehouse_>
...
*<_lanholding_>
gen     landholding = 0		if  s6aq01_901==2 | s6aq01_902==2 
replace landholding = 1		if  s6aq01_901==1 | s6aq01_902==1 
notes landholding: "PAK 2015" this variable was generated if household owns at least one acre of agricultural or non-agricultural land
*</_landholding_>	
...
replace water_source = 4 			if  s3aq06==2 | s3aq06==3
replace water_source = 5 			if  s3aq06==5 | s3aq06==10
...
replace water_source = 14 		if  s3aq06==7 | s3aq06==11
*</_water_source_>
...
replace improved_water = 1 		if  s3aq06==9
*</_improved_water_>

*<_pipedwater_acc_>
gen 	pipedwater_acc = 0 		if  s3aq06!=1  // Asuming other is not piped water
replace pipedwater_acc = 1 		if  s3aq06==1
*</_pipedwater_acc_>
...
notes electricity: "PAK 2015" this variable is generated if household has electrical connection or extension
*</_electricity_>

*<_toilet_orig_>
gen toilet_orig = s3aq15
label define lbltoilet_orig 1 "Flush connected to public sewerage" 2 "Flush connected to pit" 3 "Flush connected to open drain" 4 "Dry raised latrine" 5 "Dry pit latrine" 6 "No toilet in the household"
...
replace	toilet_jmp = 8 			if  toilet_orig==5
...
replace sanitation_source = 10 	if  s3aq15==5
...
*<_internet_>
gen		internet = 1 			if  s3aq20a==1 | s3aq20b==1
...
notes atschool: children aged 0 to 3 were classified as missings 
*</_atschool_>
...
notes literacy: "PAK 2015" literacy questions are only asked to individuals aged 10 and older
*</_literacy_>
...
replace educat7 = 1 		if  s2ac04==2 | s2ac05==0
replace educat7 = 2 		if  s2ac05>=1 & s2ac05<5
replace educat7 = 3 		if  s2ac05==5
replace educat7 = 4 		if  s2ac05>=6 & s2ac05<10 
...
* Currently attending
replace educat7 = 1		if  s2ac07==0
replace educat7 = 2 		if  s2ac07>=1 & s2ac07<=5 & s2ac06==1
replace educat7 = 4 		if  s2ac07>=6 & s2ac07<=10 & s2ac06==1
replace educat7 = 6 		if  s2ac07>=11 & s2ac07<=12 & s2ac06==1
...
* ASSETS
*****************************************************************************************************/
* Notes: PAK 2015 does not contain information on assets.
...
*<_poor_int_>
gen poor_int_215 = welfare<pline_int_215 & welfare_old!=.
...
*<_poor_int_>
gen poor_int_365 = welfare<pline_int_365 & welfare_old!=.
...
*<_poor_int_>
gen poor_int_685 = welfare<pline_int_685 & welfare_old!=.
