/*------------------------------------------------------------------------------
  SARMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   		PAK_2015_HIES_v02_M_v01_A_SAMRD_INC.do </_Program name_>
...
<_Version Control_>
Date:					03-17-2025
File:					PAK_2015_HIES_v02_M_v01_A_SAMRD_INC.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
local variables "c02_802 c02_804 c02_805 c02_8061 c02_8062 c02_810 c02_811 c02_814 c02_815 c02_817 c02_818 c02_819 c02_953 c02_960 c02_962 c02_970 s6aq04_901 s6aq04_902 s6aq04_903 s6aq04_904 s10c1_105 s10c1_197"
...
* S6AQ04_901: Agricultural Land, if rented out, what was the total net rent received, in (cash/kind) during the last 1 year?
* S6AQ04_902: Non-Agricultural Land, if rented out, what was the total net rent received, in (cash/kind) during the last 1 year?
* S6AQ04_903: Residential Building, if rented out, what was the total net rent received, in (cash/kind) during the last 1 year?
* S6AQ04_904: Commercial Building, if rented out, what was the total net rent received, in (cash/kind) during the last 1 year?
...
egen icap = rsum(s6aq04_901 s6aq04_902 s6aq04_903 s6aq04_904 s10c1_105 s10c1_197 c02_953 c02_960 c02_962 c02_970), missing
*</_icap_>
...
egen inocct_m = rsum(c02_818), missing
*</_inocct_m_>
...
* 819: Annual assistance from other government or other resources
egen itrane_ns = rsum(c02_810 c02_819), missing
*</_itrane_ns_>
...
egen renta_imp = rsum(housing_rent) if s3aq02!=3, missing
*</_renta_imp_>
