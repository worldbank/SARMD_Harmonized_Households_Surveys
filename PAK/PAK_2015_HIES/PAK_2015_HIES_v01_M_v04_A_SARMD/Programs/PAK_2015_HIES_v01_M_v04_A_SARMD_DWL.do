/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   PAK_2015_PSLM_v01_M_v04_A_GMD_DWL.do	</_Program name_>
...
<_Version Control_>
Date:	03-03-2019
File:	PAK_2015_PSLM_v01_M_v04_A_GMD_DWL.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*<_Raw data_>;
tempfile raw1
cap datalibweb, country(`code') year(`year') type(SARRAW) surveyid(PAK_2015_PSLM_v01_M) filename(sec_6a.dta) 
if _rc!=0 {
...
replace s6aq02 = 0 if s6aq01 == 2 & s6aq02 == .
keep hhcode code s6aq02 s6aq2a s6aq04
reshape wide s6aq02 s6aq2a s6aq04, i(hhcode) j(code)
save `raw1'

tempfile raw2
cap datalibweb, country(`code') year(`year') type(SARRAW) surveyid(PAK_2015_PSLM_v01_M) filename(sec_7a.dta) 
if _rc!=0 {
...
keep hhcode codes s7ac1 s7ac2 s7ac3
reshape wide s7ac1 s7ac2 s7ac3, i(hhcode) j(codes)
drop s7ac2101 s7ac3101 s7ac2102 s7ac3102 s7ac2103 s7ac3103 s7ac2104 s7ac3104
...
recode s3aq20g (2=0), gen(etablet);
*</_etablet_>;

*<_internet_>;
*<_internet_note_> Ownership of a  internet *</_internet_note_>;
*<_internet_note_> internet brought in from SARMD *</_internet_note_>;
ren internet internet_sarmd;
gen internet = .;
replace internet = 1 if s3aq21a == 1| s3aq21a == 2 | s3aq21b == 1 | s3aq21b == 2;
replace internet = 2 if (s3aq21a == 3 | s3aq21b == 3) & internet == .;
replace internet = 4 if s3aq20a == 2 & s3aq20b == 2 & internet == .;
*</_internet_>;
...
gen ownland= (s6aq02902 == 1) if !missing(s6aq02902);
*</_ownland_>;
...
recode s7ac1101 (2=0), gen(ownagriland);
*</_ownagriland_>;
...
gen area_ownagriland= s7ac1102/2.471;
*</_area_ownagriland_>;
...
recode s7ac1103 (2=0), gen(rentout_agriland);
*</_rentout_agriland_>;
...
gen arearentout_agriland= s7ac1104/2.471;
*</_arearentout_agriland_>;
...
egen arearentin_agriland= rowtotal(s7ac2109 s7ac3109), missing;
replace arearentin_agriland = arearentin_agriland/2.471;
*</_arearentin_agriland_>;
...
gen rentin_agriland= (arearentin_agriland > 0) if !missing(arearentin_agriland);
replace arearentin_agriland = . if rentin_agriland == 0;
*</_rentin_agriland_>;

*<_agriland_>;
*<_agriland_note_> Agriculture Land *</_agriland_note_>;
*<_agriland_note_> agriland brought in from rawdata *</_agriland_note_>;
gen agriland= (rentin_agriland==1 | ownagriland == 1) if rentin_agriland != . |ownagriland != .;
*</_agriland_>;
...
egen area_agriland = rowtotal(arearentin_agriland area_ownagriland), missing;
*</_area_agriland_>;
