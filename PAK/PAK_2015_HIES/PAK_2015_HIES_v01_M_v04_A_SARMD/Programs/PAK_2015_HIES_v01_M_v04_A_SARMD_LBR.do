/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   PAK_2015_PSLM_v01_M_v04_A_GMD_LBR.do	</_Program name_>
...
<_Version Control_>
Date:	03-03-2019
File:	PAK_2015_PSLM_v01_M_v04_A_GMD_LBR.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
local filename     "`code'_`year'_`survey'_v`vm'_M_v`va'_A_SARMD_LBR"
*</_Program setup_>
...
clear all
tempfile raw
datalibweb, country(PAK) year(2015) type(SARRAW) surveyid(PAK_2015_HIES_v01_M) filename(sec_1b.dta)
