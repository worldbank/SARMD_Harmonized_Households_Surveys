/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   PAK_2015_PSLM_v01_M_v01_A_GMD_UTL.do	</_Program name_>
...
<_Version Control_>
Date:	03-03-2019
File:	PAK_2015_PSLM_v01_M_v01_A_GMD_UTL.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*<_Raw data_>;
tempfile raw1
datalibweb, country(PAK) year(2015) type(SARRAW) surveyid(PAK_2015_PSLM_v01_M) filename(sec_4abcde.dta)
...
tempfile raw2
datalibweb, country(PAK) year(2015) type(SARRAW) surveyid(PAK_2015_PSLM_v01_M) filename(sec_3a.dta)
...
local va           "02";
local type         "SARMD";
local yearfolder   "PAK_2015_PSLM";
local gmdfolder    "PAK_2015_PSLM_v01_M_v01_A_GMD";
local filename     "PAK_2015_PSLM_v01_M_v01_A_GMD_UTL";
*</_Program setup_>;
