...
** DIRECTORY
glo ppath "P:\SARMD\SARDATABANK"
glo sarmd "P:\SARMD\SOUTH ASIA MICRO DATABASE"
	global directory = "${ppath}\SAR_DATABANK\PAK" 
	local input 	"${directory}\PAK_2015_PSLM\PAK_2015_PSLM_v01_M"
	local output 	"${directory}\PAK_2015_PSLM\PAK_2015_PSLM_v01_M_v`va'_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\PAK_2015_PSLM_v01_M_v`va'_A_SARMD.log",replace
...
*<_educat7_>
	...
	replace educat7=8 if s2ac07==20
...
saveold "`output'\Data\Harmonized\PAK_2015_PSLM_v01_M_v02_A_SARMD_ALL.dta", replace version(12)
...
** KEEP VARIABLES - ALL
	*do "$fixlabels\fixlabels", nostop
	...
	keep countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year fieldwork  ///
		subnatid1 subnatid2 subnatid3 gaul_adm1_code ownhouse landholding tenure water_original piped_water water_jmp sar_improved_water  electricity toilet_orig sewage_toilet toilet_jmp sar_improved_toilet  landphone cellphone ///
		water_original water_source improved_water pipedwater_acc watertype_quest sanitation_original sanitation_source improved_sanitation toilet_acc ///
		 ...
		 pline_nat poor_nat spdef welfare welfshprosperity welfarenom welfaredef eqadult welfarenat food_share nfood_share quintile_cons_aggregate decile_cons_aggregate welfareother welfaretype welfareothertype  
		 
** ORDER VARIABLES

	order countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year fieldwork ///
		subnatid1 subnatid2 subnatid3 gaul_adm1_code ownhouse landholding tenure water_original piped_water water_jmp sar_improved_water ///
