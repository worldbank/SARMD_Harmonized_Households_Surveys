/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   PAK_2015_PSLM_v01_M_v01_A_GMD_DWL.do	</_Program name_>
...
<_Version Control_>
Date:	03-03-2019
File:	PAK_2015_PSLM_v01_M_v01_A_GMD_DWL.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*<_Raw data_>;
tempfile raw1
datalibweb, country(PAK) year(2015) type(SARRAW) surveyid(PAK_2015_PSLM_v01_M) filename(sec_6a.dta)
...
tempfile raw2
datalibweb, country(PAK) year(2015) type(SARRAW) surveyid(PAK_2015_PSLM_v01_M) filename(sec_7a.dta)
...
local filename     "PAK_2015_PSLM_v01_M_v01_A_GMD_DWL";
*</_Program setup_>;
