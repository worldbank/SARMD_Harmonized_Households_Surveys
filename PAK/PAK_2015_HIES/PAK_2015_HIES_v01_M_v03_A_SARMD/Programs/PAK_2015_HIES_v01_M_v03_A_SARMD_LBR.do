/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   PAK_2015_PSLM_v01_M_v01_A_GMD_LBR.do	</_Program name_>
...
<_Version Control_>
Date:	03-03-2019
File:	PAK_2015_PSLM_v01_M_v01_A_GMD_LBR.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*<_Raw data_>;
tempfile raw
datalibweb, country(PAK) year(2015) type(SARRAW) surveyid(PAK_2015_PSLM_v01_M) filename(sec_1b.dta)
...
local filename     "PAK_2015_PSLM_v01_M_v01_A_GMD_LBR";
*</_Program setup_>;
...
*lstatus;
notes _dta: Reference period is a month, not a week or year
*</_lstatus_>;
...
recode industrycat4 (2/5 = 2) (6/9 = 3);
*</_industrycat4_>;
...
gen wage_nc=.;
notes wage_nc: Missing because last wage payment not collected, included bonus and was net not gross;
*</_wage_nc_>;
...
gen wmonths= s1bq09;
notes wmonths:Only asked to those who reported wages on a monthly basis, blank for everyone else;
*</_wmonths_>;
...
gen wage_total=.;
replace wage_total = s1bq10 if s1bq07 == 2;
replace wage_total = int(s1bq08*s1bq09) if s1bq07 == 1;
*</_wage_total_>;
...
gen t_wage_total= wage_total;
notes t_wage_total: Reference period of a month, not week;
*</_t_wage_total_>;
...
clonevar industry_orig_2_year= industry_orig_2_sarmd;
*</_industry_orig_2_year_>;
...
gen industrycat10_2_year= industry_2;
*</_industrycat10_2_year_>;
...
egen t_wage_total_year= rowtotal(wage_total_2_year t_wage_others_year), missing;
*</_t_wage_total_year_>;
...
egen laborincome= rowtotal(wage_total wage_total_2_year t_wage_others_year), missing;
*</_laborincome_>;
