...
* Section F1
use "${rootdatalib}/`code'/`code'_`year'_`survey'/`code'_`year'_`survey'_v`vm'_M/Data/Stata/Sec F1.dta", clear
* keep only chicken question
keep if q1to10==7
keep hhcode sf1col1
rename sf1col1 sf1q7col1

* merge with assembeld data
merge 1:m hhcode using "${rootdatalib}/`code'/`code'_`year'_`survey'/`code'_`year'_`survey'_v`vm'_M/Data/Stata/`code'_`year'_`survey'_M.dta", nogen assert(match)
...
** HOUSE OWNERSHIP
*<_ownhouse_>
	recode sgq01 (1/2=1) (3/4=2) (5=3) (*=.), g(ownhouse)
*</_ownhouse_>
...
replace water_jmp=13 if sgq05==9
replace water_jmp=14 if inlist(sgq05,10)
...
*</_water_original_>
	...
	** WATER SOURCE
	*<_water_source_>
		recode sgq05 (1=1) (2=2) (3/4=4) (5=5) (6=10) (7=13) (8=12) (9=7) (10=14) (*=.), g(water_source)
		#delimit
...
*<_toilet_jmp_>
recode sgq06  (2=1) (3=2) (4=4) (1=12) (5=13) (6=13) (7=13) (*=.), g(toilet_jmp)
...
*</_sar_improved_toilet_>
	...
	*<_sanitation_source_>
		...
		replace sanitation_source=9 if sgq06==4
	...
	*<_toilet_acc_>
	recode sgq06 (1 5/7=0) (2/4=3) (*=.), g(toilet_acc)
		#delimit 
...
*/
	...
	replace educy=. if age>=educy & educy!=.
*</_educy_>
...
** LAND PHONE
*<_landphone_>
	g		landphone=1 if sgq09==2 | sgq09==4
...
** COMPUTER
*<_computer_>
	gen byte computer = (sf2q11l==1) if inlist(sf2q11l,1,2)
...
** CHICKEN
*<_chicken_>
	recode sf1q7col1 (1=1) (2=0) (*=.), g(chicken)
*</_chicken>
...
*QUINTILE, DECILE AND FOOD/NON-FOOD SHARES OF CONSUMPTION AGGREGATE
	...
	* path on Joe's computer
	if ("`c(username)'"=="sunquat") {
		merge m:1 hhcode using "${input}/Data/Stata/PAK_fnf_`y'", keepusing(food_share nfood_share quintile_cons_aggregate decile_cons_aggregate) nogen
	}
	* global paths on WB computer
	else {
		merge m:1 hhcode using "$shares/PAK_fnf_`y'", keepusing(food_share nfood_share quintile_cons_aggregate decile_cons_aggregate) nogen
	}
...
foreach var_notfound in shared_toilet industry_year industry_2_year industry_orig_year industry_orig_2_year occup_year ocusec_year {
	...
	note `var_notfound': PAK_2010_HIES does not have any relevant questions or variables.
}
...
foreach var_notfound in converfactor gaul_adm2_code gaul_adm3_code sector {
	g `var_notfound'=.
	note `var_notfound': For PAK_2010_HIES, I did not have a sufficient understanding of how `var_notfound' is defined from the SAR team, so it was created as missing.
}
