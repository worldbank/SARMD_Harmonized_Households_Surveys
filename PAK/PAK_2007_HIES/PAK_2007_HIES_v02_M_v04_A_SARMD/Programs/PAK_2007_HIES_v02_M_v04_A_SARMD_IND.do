...
*<_landphone_>
	gen byte landphone=.
	replace landphone=1 if s5q4a==1 | s5q4a==2
	...
	notes landphone: "PAK 2007" variable is labeled and named wrong in raw-files. We use s5q4a where it should have been s5q4c.
*</_landphone_>
...
foreach var_notfound in shared_toilet industry_year industry_2_year industry_orig_year industry_orig_2_year occup_year ocusec_year {
	...
	note `var_notfound': PAK_2007_HIES does not have any relevant questions or variables.
}
...
foreach var_notfound in converfactor gaul_adm2_code gaul_adm3_code sector {
	g `var_notfound'=.
	note `var_notfound': For PAK_2007_HIES, I did not have a sufficient understanding of how `var_notfound' is defined from the SAR team, so it was created as missing.
}
