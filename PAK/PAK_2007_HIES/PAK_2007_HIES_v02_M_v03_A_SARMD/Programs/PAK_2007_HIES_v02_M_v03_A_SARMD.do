...
** DIRECTORY
    ...
    local input      "$rootdatalib\PAK\PAK_2007_HIES\PAK_2007_HIES_v`veralt'_M"
	local output     "$rootdatalib\PAK\PAK_2007_HIES\PAK_2007_HIES_v`veralt'_M_v0`v'_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\PAK_2007_PSLM_v`veralt'_M_v0`v'_A_SARMD.log",replace
...
foreach s in landholding durables{
	...
	*Merge with spatial deflator
	...
	merge m:1 psu using "$rootdatalib\PAK\PAK_2007_HIES\PAK_2007_HIES_v`veralt'_M\Data\Stata\psu_paasche_2007_pdef1.dta", nogen 
...
*<_cpi_>
	...
	*ren cpi`year'_w cpi
	label variable cpi2011_06 "CPI (CPI from January 2008 base 2011)"
	label variable cpi2017_06 "CPI (CPI from January 2008 base 2017)"
*</_cpi_>
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2007_PSLM_v`veralt'_M_v0`v'_A_SARMD_IND.dta", replace version(12)
	*saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2007_PSLM_v`veralt'_M_v02_A_SARMD_IND.dta", replace  version(13)
