...
*</_water_original_>
	...
	** WATER SOURCE
	*<_water_source_>
		recode s5q05 (2/3=4) (4=10) (5 10=5) (6=13) (7=9) (8=7) (9=12) (11=14) (*=.), g(water_source)
...
g industrycat10_2 = industry_2
recode industrycat10_2 (2/5=2) (6/9=3) (10=4), g(industrycat4_2)
...
foreach var_notfound in shared_toilet industry_year industry_2_year industry_orig_year industry_orig_2_year occup_year ocusec_year {
	...
	note `var_notfound': PAK_2013_HIES does not have any relevant questions or variables.
}
...
foreach var_notfound in converfactor gaul_adm2_code gaul_adm3_code sector {
	g `var_notfound'=.
	note `var_notfound': For PAK_2013_HIES, I did not have a sufficient understanding of how `var_notfound' is defined from the SAR team, so it was created as missing.
}
