...
** DIRECTORY
	*glo rootdatalib     "P:\SARMD\SARDATABANK"
	...
	local input   		 "${rootdatalib}\PAK\PAK_2013_HIES\PAK_2013_HIES_v01_M"
	local output  		 "${rootdatalib}\PAK\PAK_2013_HIES\PAK_2013_HIES_v01_M_v0`v'_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\PAK_2013_HIES_v01_M_v0`v'_A_SARMD.log",replace
...
compress
saveold "`output'\Data\Harmonized\PAK_2013_HIES_v01_M_v0`v'_A_SARMD_ALL.dta", replace version(12)
...
/*
	...
	*ren cpi`year'_w cpi
	label variable cpi2011_06 "CPI (CPI from January 2014 base 2011)"
	label variable cpi2017_06 "CPI (CPI from January 2014 base 2017)"
*</_cpi_>
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2013_HIES_v01_M_v0`v'_A_SARMD_IND.dta", replace version(12)
	*saveold "${rootdatalib}\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2013_HIES_v01_M_v0`v'_A_SARMD_IND.dta", replace version(13)
