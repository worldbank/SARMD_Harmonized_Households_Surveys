...
Employment
*/
	use "`input'\Data\Raw\Household\sec_1b_.dta", clear
	isid hhcode idc
...
Education
*/
	use "`input'\Data\Raw\Household\sec_2ab.dta", clear
	isid hhcode idc 
	merge 1:1 hhcode idc using `aux'
	tab _merge
...
*/
	use "`input'\Data\Raw\Household\sec_5m.dta", clear
	isid hhcode
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2013_PSLM.dta", replace
	save "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Final Files\Individual Files\PAK_2013_PSLM.dta", replace
