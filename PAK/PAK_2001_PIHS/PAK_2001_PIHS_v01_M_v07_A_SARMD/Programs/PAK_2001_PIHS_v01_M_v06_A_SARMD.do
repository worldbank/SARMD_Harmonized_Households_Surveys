...
** DIRECTORY
	local input      "$rootdatalib\PAK\PAK_2001_PIHS\PAK_2001_PIHS_v01_M"
	local output     "$rootdatalib\PAK\PAK_2001_PIHS\PAK_2001_PIHS_v01_M_v0`v'_A_SARMD"
...
forval i=1/3{
		...
		*gen psu = substr(hhid,1,7)
		merge m:1 psu using "$rootdatalib\PAK\PAK_2001_PIHS\PAK_2001_PIHS_v01_M\Data\Stata\psu_paasche_2001_pdef1.dta", nogen 
...
*<_cpi_>
	...
	*/
    ...
    foreach x of numlist 11 17 {
	 ...
	 gen cpi20`x'_06=(monthly_cpi/yearly_cpi20`x') 
	}
	...
	*ren cpi`year'_w cpi
	label variable cpi2011_06 "CPI (CPI from June 2001 base 2011)"
	label variable cpi2017_06 "CPI (CPI from June 2001 base 2017)"
*</_cpi_>
...
*<_poor_int_>
	...
	gen	welfare_ppp2= (12/365)*welfaredef/cpi2011_06/ppp_2011
...
** KEEP VARIABLES - ALL
	...
	keep countrycode code year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year fieldwork ///
		subnatid1 subnatid2 subnatid3 gaul_adm*_code ownhouse landholding tenure water_orig piped_water water_jmp sar_improved_water  electricity toilet_orig sewage_toilet toilet_jmp sar_improved_toilet  landphone cellphone ///
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2001_PIHS_v01_M_v0`v'_A_SARMD_IND.dta", replace version(12)
	*saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2001_PIHS_v01_M_v0`v'_A_SARMD_IND.dta", replace version(12)
