...
** Input databases 
	datalibweb, country(PAK) year(2001) type(GMD) mod(all) clear
	...
	*/
	...
	preserve
	use "`output'\Data\Harmonized\PAK_2001_PIHS_v01_M_v0`v'_A_SARMD_IND.dta", clear 
	rename idh hhid
	rename idp pid 
...
*</_poor_int_>
	...
	saveold "`output'\Data\Harmonized\PAK_2001_PIHS_v01_M_v0`v'_A_SARMD_GMD.dta", replace 
