...
** DIRECTORY
	...
	local v "3"
	local input      "$rootdatalib\PAK\PAK_2005_HIES\PAK_2005_HIES_v02_M"
	local output     "$rootdatalib\PAK\PAK_2005_HIES\PAK_2005_HIES_v02_M_v0`v'_A_SARMD"
	
	
** Input databases 
	datalibweb, country(PAK) year(2005) type(GMD) mod(all) clear
	...
	*/
	...
	preserve
	use "`output'\Data\Harmonized\PAK_2005_HIES_v02_M_v0`v'_A_SARMD_IND.dta", clear 
	rename idh hhid
	rename idp pid 
...
*</_poor_int_>
	...
	saveold "`output'\Data\Harmonized\PAK_2005_HIES_v02_M_v0`v'_A_SARMD_GMD.dta", replace 
