...
** DIRECTORY
    local input      "$rootdatalib\PAK\PAK_2005_HIES\PAK_2005_HIES_v`veralt'_M"
	local output     "$rootdatalib\PAK\PAK_2005_HIES\PAK_2005_HIES_v`veralt'_M_v0`v'_A_SARMD"
...
*Add landholding information
	...
	*gen psu = substr(hhid,1,7)
	merge m:1 psu using "$rootdatalib\PAK\PAK_2005_HIES\PAK_2005_HIES_v`veralt'_M\Data\Stata\psu_paasche_2005_pdef1.dta", nogen 
...
*<_cpi_>
	...
	*ren cpi`year'_w cpi
	label variable cpi2011_06 "CPI (CPI from January 2006 base 2011)"
	label variable cpi2017_06 "CPI (CPI from January 2006 base 2017)"
*</_cpi_>
...
** KEEP VARIABLES - ALL
	...
	keep countrycode code year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year fieldwork  ///
		...
		water_original water_source improved_water pipedwater_acc watertype_quest sanitation_original sanitation_source improved_sanitation toilet_acc ///
		 ...
		 pline_nat pline_int* poor_nat poor_int* spdef cpi* ppp* welfare welfshprosperity welfarenom welfaredef ///
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2005_HIES_v`veralt'_M_v0`v'_A_SARMD_IND.dta", replace version(12)
