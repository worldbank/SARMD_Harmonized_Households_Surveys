...
** DIRECTORY
	global rootdatalib "P:\SARMD\SARDATABANK\WORKINGDATA"
	local v "6"
...
** Input databases 
	datalibweb, country(PAK) year(2011) type(GMD) mod(all) clear
	...
	*/
	...
	preserve
	use "`output'\Data\Harmonized\PAK_2011_PSLM_v01_M_v0`v'_A_SARMD_IND.dta", clear 
	rename idh hhid
	rename idp pid 
...
*</_poor_int_>
	...
	saveold "`output'\Data\Harmonized\PAK_2011_HIES_v01_M_v0`v'_A_SARMD_GMD.dta", replace 
