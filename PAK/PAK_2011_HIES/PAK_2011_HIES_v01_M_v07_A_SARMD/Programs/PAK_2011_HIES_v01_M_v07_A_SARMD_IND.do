...
** LOG FILE
	*log using "`output'/Doc/Technical/PAK_2011_PSLM_v01_M_v0`v'_A_SARMD.log",replace
...
*<_cpi_>
	...
	*ren cpi`year'_w cpi
	label variable cpi2011_`cpiver' "CPI (CPI from January 2012 base 2011)"
	label variable cpi2017_`cpiver' "CPI (CPI from January 2012 base 2017)"
*</_cpi_>
