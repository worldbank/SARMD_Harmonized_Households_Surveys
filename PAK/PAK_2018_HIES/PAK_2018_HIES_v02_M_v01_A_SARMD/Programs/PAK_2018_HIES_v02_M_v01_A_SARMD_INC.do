/*------------------------------------------------------------------------------
  SARMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   		PAK_2018_HIES_v02_M_v01_A_SAMRD_INC.do </_Program name_>
...
<_Version Control_>
Date:					03-17-2025
File:					PAK_2018_HIES_v02_M_v01_A_SAMRD_INC.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
local variables "c02_802 c02_804 c02_805 c02_806 c02_807 c02_811 c02_812 c02_815 c02_816 c02_817 c02_818 c02_819 c02_820 c02_953 c02_960 c02_962 c02_970 s9aq04_901 s9aq04_902 s9aq04_903 s9aq04_904 s10c1_105 s10c1_197"
...
* C02_970: How much profits was received on this loan during the last 1 year?
egen icap = rsum(s9aq04_901 s9aq04_902 s9aq04_903 s9aq04_904 s10c1_105 s10c1_197 c02_953 c02_960 c02_962 c02_970), missing
*</_icap_>
...
* 819: Annual income from Benazir Income Support Program
egen inocct_m = rsum(c02_819), missing
*</_inocct_m_>
...
* 811: Zakat/Ushr received from public sector 
* 820: Annual assistance from other government or other resources
egen itrane_ns = rsum(c02_811 c02_820), missing
*</_itrane_ns_>
...
* 805: Remittances from outside Pakistan received through hundi
* 806: Remittances from outside Pakistan received through mobile banking
* 807: Remittances from outside Pakistan received through other sources
egen itranext_m = rsum(c02_804 c02_805 c02_806 c02_807), missing
*</_itranext_m_>
...
* 812: Zakat/Ushr received from private sector 
egen itranint_m = rsum(c02_802 c02_812), missing
*</_itranint_m_>

*<_itranint_nm_>
*<_itranint_nm_note_> Income by private transfers from the country - non-monetary *</_itranint_nm_note_>
* 818: Gifts, assistance, etc., received in-kind but sold?
egen itranint_nm = rsum(c02_818), missing
*</_itranint_nm_>
...
* 815: Sadqa, inheritance, lottery winnings, etc.
* 816: Receipts from boarders or lodgers (in cash)
*sum c02_815 [w=wgt] 
*replace c02_815 = .		if  c02_815>(r(mean)+(2.4*r(sd)))
egen inla_otro = rsum(c02_815 c02_816), missing
*</_inla_otro_>


*<_renta_imp_>
*<_renta_imp_note_> Imputed rent for own-housing *</_renta_imp_note_>
egen renta_imp = rsum(housing_rent) if s5aq01!=3, missing
*</_renta_imp_>
