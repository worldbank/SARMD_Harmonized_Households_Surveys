/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   PAK_2018_PSLM_v_M_v_A_GMD_LBR.do	</_Program name_>
...
<_Version Control_>
Date:	03-03-2019
File:	PAK_2018_PSLM_v_M_v_A_GMD_LBR.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
local filename     "PAK_2018_PSLM_v_M_v_A_GMD_LBR";
*</_Program setup_>;
...
*gen industrycat10=industrycat10;;
*</_industrycat10_>;
...
*gen industrycat4=industrycat4;;
*</_industrycat4_>;

*<_occup_orig_>;
*<_occup_orig_note_> original occupation code *</_occup_orig_note_>;
*<_occup_orig_note_> occup_orig brought in from SARMD *</_occup_orig_note_>;
*gen occup_orig=occup_orig;;
*</_occup_orig_>;

*<_occup_>;
*<_occup_note_> 1 digit occupational classification *</_occup_note_>;
*<_occup_note_> occup brought in from SARMD *</_occup_note_>;
la de lbloccup 1 "Managers" 2 "Professionals" 3 "Technicians and associate professionals" 4 "Clerical support workers" 5 "Service and sales workers" 6 "Skilled agricultural, forestry and fishery workers" 7 "Craft and related trades workers" 8 "P;
*</_occup_>;
...
*gen industrycat10_2=industrycat10_2;;
*</_industrycat10_2_>;
...
*gen industrycat4_2=industrycat4_2;;
*</_industrycat4_2_>;
...
*gen occup_orig_2=gen occup_orig_2;;
*</_occup_orig_2_>;
...
la de lbloccup_2 1 "Managers" 2 "Professionals" 3 "Technicians and associate professionals" 4 "Clerical support workers" 5 "Service and sales workers" 6 "Skilled agricultural, forestry and fishery workers" 7 "Craft and related trades workers" 8 ;
*</_occup_2_>;
...
*gen t_wage_others=t_wage_others;;
*</_t_wage_others_>;
...
*gen t_hours_total=t_hours_total;;
*</_t_hours_total_>;
...
gen industry_orig_year=industry_orig_2;;
*</_industry_orig_year_>;
...
gen industrycat10_year=industrycat10_2;;
*</_industrycat10_year_>;
...
gen industrycat4_year=industrycat4_2;;
*</_industrycat4_year_>;
...
gen occup_orig_year=occup_orig_2;;
*</_occup_orig_year_>;
...
gen empstat_2_year=empstat_2_year;;
*</_empstat_2_year_>;
...
gen industry_orig_2_year=industry_orig_2;;
*</_industry_orig_2_year_>;
...
gen industrycat10_2_year=industrycat10_2;;
*</_industrycat10_2_year_>;
...
gen industrycat4_2_year=industrycat4_2;;
*</_industrycat4_2_year_>;
...
gen unitwage_2_year=unitwage_2;;
*</_unitwage_2_year_>;
