...
* load section 1b data
use "${input}/Data/Stata/sec_1b (2)", clear
gen double idp_= hhcode*100+idc
gen idp=string(idp_,"%16.0g")
* merge with IND data
merge 1:1 idp using "${rootdatalib}\\`code'\\`yearfolder'\\`SARMDfolder'\Data\Harmonized\\`yearfolder'_v`vm'_M_v`va'_A_`type'_IND.dta", nogen keep(match)
