...
* section 9a
	...
	save `raw_data'
* section 10a
	use "${input}/Data/Stata/sec_10a", clear
	...
	merge 1:1 hhcode using `raw_data', nogen assert(using match)
* section 5a
	merge 1:1 hhcode using "${input}/Data/Stata/sec_5a", nogen assert(match)
	tostring hhcode, gen(idh)
	save `raw_data', replace
* section 7a
	use "${input}/Data/Stata/sec_7a", clear
	keep if inlist(code,701,702,704,706,708,714,711,710,727,728,730,732)
	drop c01 c03
...
recode c02_708_air_conditoner (1/max=1) (*=0), g(ac)
*</_ac_>
...
recode c02_730_car (1/max=1) (0 .=0), g(car)
*</_car_>
