...
* load section 6a data
use "${input}/Data/Stata/sec_6a", clear
...
* merge with section 5a
merge 1:1 hhcode using "${input}/Data/Stata/sec_5a", nogen assert(using match)
tostring hhcode, gen(idh)
* merge with IND data
merge 1:m idh using "${rootdatalib}\\`code'\\`yearfolder'\\`SARMDfolder'\Data\Harmonized\\`yearfolder'_v`vm'_M_v`va'_A_`type'_IND.dta", nogen assert(match)
...
recode s5aq08 (1=1) (2/3=5) (4=2) (5=4) (6/7 9=9) (8=3) (*=.), g(cooksource)
*</_cooksource_>
...
decode s5aq21, g(sanitation_original)
*</_sanitation_original_>
...
recode s5aq17 (1=1) (2=0) (*=.) if imp_wat_rec==1, g(w_avail)
*</_w_avail_>
