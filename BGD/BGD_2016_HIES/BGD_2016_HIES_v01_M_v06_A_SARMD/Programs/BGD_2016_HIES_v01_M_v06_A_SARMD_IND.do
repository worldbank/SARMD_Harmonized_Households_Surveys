...
SARMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	BGD_2016_HIES_v01_M_v07_A_SAMRD_IND.do	   </_Program name_>
...
<_Version Control_>
Date:				10-2023
File:				BGD_2016_HIES_v01_M_v07_A_SAMRD_IND.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
global shares    	"$rootdatalib\\`code'\\`yearfolder'\\`yearfolder'_v`vm'_M\Data\Stata"
...
replace gaul_adm1_code = 2127 			if  subnatid1=="30 - Dhaka"
replace gaul_adm1_code = 2128 			if  subnatid1=="40 - Khulna"
replace gaul_adm1_code = . 				if  subnatid1=="45 - Mymensingh"
...
gen 	subnatid2 = "."
replace subnatid2 = " 1 - Barisal rural" 	if  subnatid1=="10 - Barisal" & urbrural==1
replace subnatid2 = " 2 - Barisal urban" 	if  subnatid1=="10 - Barisal" & urbrural==2
replace subnatid2 = " 3 - Chittagong rural" 	if  subnatid1=="20 - Chittagong" & urbrural==1
replace subnatid2 = " 4 - Chittagong urban" 	if  subnatid1=="20 - Chittagong" & urbrural==2
replace subnatid2 = " 5 - Dhaka rural" 		if  subnatid1=="30 - Dhaka" & urbrural==1
replace subnatid2 = " 6 - Dhaka urban" 		if  subnatid1=="30 - Dhaka" & urbrural==2
replace subnatid2 = " 7 - Khulna rural" 		if  subnatid1=="40 - Khulna" & urbrural==1
replace subnatid2 = " 8 - Khulna urban" 		if  subnatid1=="40 - Khulna" & urbrural==2
replace subnatid2 = " 9 - Mymensingh rural" 	if  subnatid1=="45 - Mymensingh" & urbrural==1
replace subnatid2 = "10 - Mymensingh urban" 	if  subnatid1=="45 - Mymensingh" & urbrural==2
replace subnatid2 = "11 - Ragshashi rural" 	if  subnatid1=="50 - Rajshahi" & urbrural==1
replace subnatid2 = "12 - Ragshashi urban" 	if  subnatid1=="50 - Rajshahi" & urbrural==2
replace subnatid2 = "13 - Rangpur rural" 	if  subnatid1=="55 - Rangpur" & urbrural==1
replace subnatid2 = "14 - Rangpur urban" 	if  subnatid1=="55 - Rangpur" & urbrural==2
replace subnatid2 = "15 - Sylhet rural" 		if  subnatid1=="60 - Sylhet" & urbrural==1
replace subnatid2 = "16 - Sylhet urban" 		if  subnatid1=="60 - Sylhet" & urbrural==2
...
gen byte subnatid3 = zila_code
la def lblsubnatid3 1 "Bagerhat", add
la def lblsubnatid3 3 "Bandarban", add
la def lblsubnatid3 4 "Barguna", add
la def lblsubnatid3 6 "Barisal", add
la def lblsubnatid3 9 "Bhola", add
la def lblsubnatid3 10 "Bogra", add
la def lblsubnatid3 12 "Brahmanbaria", add
la def lblsubnatid3 13 "Chandpur", add
la def lblsubnatid3 15 "Chittagong", add
la def lblsubnatid3 18 "Chuadanga", add
la def lblsubnatid3 19 "Comilla", add
la def lblsubnatid3 22 "Cox's bazar", add
la def lblsubnatid3 26 "Dhaka", add
la def lblsubnatid3 27 "Dinajpur", add
la def lblsubnatid3 29 "Faridpur", add
la def lblsubnatid3 30 "Feni", add
la def lblsubnatid3 32 "Gaibandha", add
la def lblsubnatid3 33 "Gazipur", add
la def lblsubnatid3 34 "Rajbari", add
la def lblsubnatid3 35 "Gopalganj", add
la def lblsubnatid3 36 "Habiganj", add
la def lblsubnatid3 38 "Jaipurhat", add
la def lblsubnatid3 39 "Jamalpur", add
la def lblsubnatid3 41 "Jessore", add
la def lblsubnatid3 42 "Jhalokati", add
la def lblsubnatid3 44 "Jhenaidah", add
la def lblsubnatid3 46 "Khagrachari", add
la def lblsubnatid3 47 "Khulna", add
la def lblsubnatid3 48 "Kishoreganj", add
la def lblsubnatid3 49 "Kurigram", add
la def lblsubnatid3 50 "Kushtia", add
la def lblsubnatid3 51 "Lakshmipur", add
la def lblsubnatid3 52 "Lalmonirhat", add
la def lblsubnatid3 54 "Madaripur", add
la def lblsubnatid3 55 "Magura", add
la def lblsubnatid3 56 "Manikganj", add
la def lblsubnatid3 57 "Meherpur", add
la def lblsubnatid3 58 "Maulvibazar", add
la def lblsubnatid3 59 "Munshigan", add
la def lblsubnatid3 61 "Mymensingh", add
la def lblsubnatid3 64 "Naogaon", add
la def lblsubnatid3 65 "Narail", add
la def lblsubnatid3 67 "Narayanganj", add
la def lblsubnatid3 68 "Narsingdi", add
la def lblsubnatid3 69 "Natore", add
la def lblsubnatid3 70 "Nawabganj", add
la def lblsubnatid3 72 "Netrokona", add
la def lblsubnatid3 73 "Nilphamari", add
la def lblsubnatid3 75 "Noakhali", add
la def lblsubnatid3 76 "Pabna", add
la def lblsubnatid3 77 "Panchagar", add
la def lblsubnatid3 78 "Patuakhali", add
la def lblsubnatid3 79 "Pirojpur", add
la def lblsubnatid3 81 "Rajshahi", add
la def lblsubnatid3 82 "Rajbari", add
la def lblsubnatid3 84 "Rangamati", add
la def lblsubnatid3 85 "Rangpur", add
la def lblsubnatid3 86 "Shariatpur", add
la def lblsubnatid3 87 "Satkhira", add
la def lblsubnatid3 88 "Sirajganj", add
la def lblsubnatid3 89 "Sherpur", add
la def lblsubnatid3 90 "Sunamganj", add
la def lblsubnatid3 91 "Sylhet", add
la def lblsubnatid3 93 "Tangail", add
la def lblsubnatid3 94 "Thakurgaon", add
la val subnatid3 lblsubnatid3
la var subnatid3 "Region at 2 digit (ADMN2)"
numlabel lblsubnatid3, remove
numlabel lblsubnatid3, add mask("# - ")
decode subnatid3, gen(subnatid3_temp)
drop subnatid3
rename subnatid3_temp subnatid3
*</_subnatid3_>
...
replace sar_improved_water = 1 	if  inrange(water_source,1,8)
replace sar_improved_water = 0 	if  inrange(water_source,9,14) // Asuming other is not improved water source
*</_sar_improved_water_>
...
replace toilet_orig = "6 - Other"						if  s6aq10==6
*</_toilet_original_>
