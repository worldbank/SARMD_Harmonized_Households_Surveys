...
keep  hhid idp w_cat 	hours months s4aq01b s4aq01c s4bq06 daylab_cash daylab_kind employee_cash employee_kind month_nonagri agri_net act anomalies
order hhid idp w_cat 	hours months s4aq01b s4aq01c s4bq06 daylab_cash daylab_kind employee_cash employee_kind month_nonagri agri_net act anomalies
reshape wide      w_cat 	hours months s4aq01b s4aq01c s4bq06 daylab_cash daylab_kind employee_cash employee_kind month_nonagri agri_net anomalies, j(act) i(hhid idp)
...
collapse (sum) ssn_cash ssn_kind, by(hhid idp)
sort  hhid idp
save `sect1', replace
...
collapse (sum) stipend_inc, by(hhid idp)
sort hhid idp
tempfile stipend
