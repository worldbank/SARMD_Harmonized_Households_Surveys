...
*==============================================*
	...
	if "${new_primus_master_version}"=="N" {
		if ${var_welfare}==${var_welfareGMD} {
			...
			di as error "STOP: welfare (mean) from this new version and welfare (mean) from GMD primus version do not correspond." 
			di as error "Please check and solve this error before saving the final database."
			
			di ""
			di "welfare value for GMD Primus database: " ${var_welfareGMD}
			di "-----"
			di "welfare value for this new version: " ${var_welfare}
			di ""
		    stop 
		}
	}
...
*==============================================*
	...
	if "${new_primus_master_version}"=="N" {
		if ${var_welfare}==${var_welfareGMD} {
			...
			di as error "STOP: welfare (sd) from this new version and welfare (sd) from GMD primus version do not correspond." 
			di as error "Please check and solve this error before saving the final database."
...
*==============================================*
	...
	if "${new_primus_master_version}"=="N" {
		if ${var_welfare}==${var_welfareGMD} {
			...
			di as error "STOP: welfare (min) from this new version and welfare (min) from GMD primus version do not correspond." 
			di as error "Please check and solve this error before saving the final database."
...
*==============================================*
	...
	if "${new_primus_master_version}"=="N" {
		if ${var_welfare}==${var_welfareGMD} {
			...
			di as error "STOP: welfare (max) from this new version and welfare (max) from GMD primus version do not correspond." 
			di as error "Please check and solve this error before saving the final database."
