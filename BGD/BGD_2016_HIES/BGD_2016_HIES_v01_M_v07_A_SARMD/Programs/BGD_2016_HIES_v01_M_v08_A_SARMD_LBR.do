/*------------------------------------------------------------------------------
  GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	BGD_2016_HIES_v01_M_v08_A_SARMD_LBR.do	   </_Program name_>
...
<_Version Control_>
Date:				09-2024
File:				BGD_2016_HIES_v01_M_v08_A_SARMD_LBR.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
drop _merge
sort  hhid pid
merge 1:1 hhid pid  using "${rootdatalib}\\`code'\\`yearfolder'\\`SARMDfolder'\Data\Harmonized\\`yearfolder'_v`vm'_M_v`va'_A_`type'_IND_full.dta" 
*</_Datalibweb request_>
...
gen     occup_2_year = .
replace occup_2_year = 1		if  s4aq01b_2==20 | s4aq01b_2==21  | s4aq01b_2==30  | s4aq01b_2==40  | s4aq01b_2==50  
replace occup_2_year = 2		if  s4aq01b_2==2  | s4aq01b_2==4   | (s4aq01b_2>=6  & s4aq01b_2<=13) | (s4aq01b_2>=15 & s4aq01b_2<=19)
replace occup_2_year = 3		if  s4aq01b_2==1  | s4aq01b_2==3   | s4aq01b_2==5   | s4aq01b_2==14  | s4aq01b_2==42  | s4aq01b_2==43  | s4aq01b_2==44 | s4aq01b_2==86
replace occup_2_year = 4		if (s4aq01b_2>=31 & s4aq01b_2<=33) | (s4aq01b_2>=37 & s4aq01b_2<=39)
replace occup_2_year = 5		if  s4aq01b_2==36 | s4aq01b_2==45  | (s4aq01b_2>=51 & s4aq01b_2<=54) | s4aq01b_2==49  | s4aq01b_2==58  | s4aq01b_2==59 
replace occup_2_year = 6		if  s4aq01b_2==70 | s4aq01b_2==60  | s4aq01b_2==61  | s4aq01b_2==63  | s4aq01b_2==64
replace occup_2_year = 7		if  s4aq01b_2==71 | s4aq01b_2==72  | (s4aq01b_2>=75 & s4aq01b_2<=85) | (s4aq01b_2>=87 & s4aq01b_2<=89) | s4aq01b_2==92 
replace occup_2_year = 8		if  s4aq01b_2==34 | s4aq01b_2==35  | s4aq01b_2==74  | s4aq01b_2==90  | s4aq01b_2==91
replace occup_2_year = 9		if  s4aq01b_2==55 | s4aq01b_2==56    
*</_occup_2_year_>
...
egen t_hours_others_year = rsum(hours_3 hours_4 hours_5 hours_6 hours_7 hours_8 hours_9 hours_10), missing
*</_t_hours_others_year_>
...
egen    t_wage_nc_others_year = rsum(daylab_cash_3 employee_cash_3 daylab_cash_4 employee_cash_4 daylab_cash_5 daylab_cash_6 daylab_cash_7 daylab_cash_8 agri_net_3 month_nonagri_3 agri_net_4 month_nonagri_4), missing
...
egen    t_wage_others_year = rsum(daylab_cash_3 employee_cash_3 daylab_cash_4 employee_cash_4 daylab_cash_5 daylab_cash_6 daylab_cash_7 daylab_cash_8 daylab_kind_3 employee_kind_3 daylab_kind_4 employee_kind_4 daylab_kind_5 daylab_kind_6 daylab_kind_7 daylab_kind_8 agri_net_3 month_nonagri_3 agri_net_4 month_nonagri_4), missing
...
egen t_hours_total_year = rsum(hours_1 hours_2 hours_3 hours_4 hours_5 hours_6 hours_7 hours_8 hours_9 hours_10), missing
*</_t_hours_total_year_>
