/*------------------------------------------------------------------------------
  GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	BGD_2016_HIES_v01_M_v07_A_SARMD_DWL.do	   </_Program name_>
...
<_Version Control_>
Date:				03-2024
File:				BGD_2016_HIES_v01_M_v07_A_SARMD_DWL.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
gen   etablet = .
notes etablet: HIES 2016 only includes a binary question asking if the household owns a computer/laptop/notebook/tablet
*</_etablet_>
...
gen 	internet = .
replace internet = 2			if  s6aq22==1 | s6aq22==3 | s6aq22==4
replace internet = 1			if  s6aq22==2
replace internet = 4			if  s6aq21==2
*</_internet_>
...
gen     internet_mobile = .
replace internet_mobile = 0	if  s6aq21==2 | s6aq22!=1
replace internet_mobile = 1	if  s6aq22==1
*</_internet_mobile_>
...
notes internet_mobile4G: the HIES 2016 does not contain information specific enough to define this variable
*</_internet_mobile4G_>
...
gen   tv_cable = .a
notes tv_cable: the HIES 2016 does not contain information to define this variable
*</_tv_cable_>
...
gen   video = .a
notes video: the HIES 2016 does not contain information to define this variable
*</_video_>
...
gen 	stove = 0
replace stove = 1		if  assets594==1						// microwave-electric oven //
replace stove = 1		if  s6aq06>=1 & s6aq06<=6	
notes   stove: category "microoven/Kitchen items-cooking" is considered as stove==1
...
gen   ricecook = .a
notes ricecook: the HIES 2016 does not contain information to define this variable
*</_ricecook_>
...
gen   ac = .a
notes ac: the HIES 2016 does not contain information to define this variable
*</_ac_>
...
gen   ewpump = .a
notes ewpump: the HIES 2016 does not contain information to define this variable
*</_ewpump_>
...
gen   oxcart = .a
notes oxcart: the HIES 2016 does not contain information to define this variable
*</_oxcart_>
...
gen 	boat = 0
replace boat = 1			if  assets599==1				// boat-others	//
...
gen     roof = .
replace roof = 1			if  s6aq08==1	// straw-bamboo-polythene-plastic-canvas 	//
replace roof = 8			if  s6aq08==2	// tin (CI sheet)							//
replace roof = 10		if  s6aq08==3	// tally									//		
replace roof = 11		if  s6aq08==4	// brick-cement								//
replace roof = 15		if  s6aq08==5	// other 									//
...
gen 	wall = .
replace wall = 1			if  s6aq07==1	// straw-bamboo-polythene-plastic-canvas 	//
replace wall = 6 		if  s6aq07==2	// mud-urburnt brick 						//
replace wall = 10		if  s6aq07==3	// tin (CI sheet) 							//
replace wall = 15		if  s6aq07==4	// wood 									//
replace wall = 13		if  s6aq07==5	// brick-cement 							//
replace wall = 19		if  s6aq07==6	// other 									//
...
gen  	kitchen = .
replace kitchen = 0		if  s6aq04==2
replace kitchen = 1		if  s6aq04==1 
*</_kitchen_>
...
notes   rooms: there are some negative values in the raw data variable
*</_rooms_>
...
gen   ybuilt = .a
notes ybuilt: the HIES 2016 does not contain information to define this variable
*</_ybuilt_>
...
gen   acqui_house = .a
notes acqui_house: the HIES 2016 does not contain information to define this variable
*</_acqui_house_>
...
gen   dwelownlti = .a
notes dwelownlti: the HIES 2016 does not contain information to define this variable
*</_dwelownlti_>
...
notes fem_dwelownlti: the HIES 2016 does not contain information to define this variable
*</_fem_dwelownlti_>
...
gen   dwelownti = .a
notes dwelownti: the HIES 2016 does not contain information to define this variable
*</_dwelownti_>
...
gen   selldwel = .a
notes selldwel: the HIES 2016 does not contain information to define this variable
*</_selldwel_>
...
gen   transdwel = .a
notes transdwel: the HIES 2016 does not contain information to define this variable
*</_transdwel_>
...
notes   ownland: there are some negative values in the raw data variable
*</_ownland_>
...
gen   acqui_land = .a
notes acqui_land: the HIES 2016 does not contain information to define this variable
*</_acqui_land_>
...
gen   doculand = .a
notes doculand: the HIES 2016 does not contain information to define this variable
*</_doculand_>
...
gen   fem_doculand = .a
notes fem_doculand: the HIES 2016  does not contain information to define this variable
*</_fem_doculand_>
...
gen   landownti = .a
notes landownti: the HIES 2016 does not contain information to define this variable
*</_landownti_>
...
gen   sellland = .a
notes sellland: the HIES 2016 does not contain information to define this variable
*</_sellland_>
...
gen   transland = .a
notes transland: the HIES 2016 does not contain information to define this variable
*</_transland_>
...
notes   agriland: there are some negative values in the raw data variable
*</_agriland_>
...
notes   area_agriland: there are some negative values in the raw data variable
*</_area_agriland_>
...
notes purch_agriland: the HIES 2016 does not contain information to define this variable
*</_purch_agriland_>
...
notes areapurch_agriland: the HIES 2016 does not contain information to define this variable
*</_areapurch_agriland_>
...
notes inher_agriland: the HIES 2016 does not contain information to define this variable
*</_inher_agriland_>
...
notes areainher_agriland: the HIES 2016 does not contain information to define this variable
*</_areainher_agriland_>
...
gen   docuagriland = .a
notes docuagriland: the HIES 2016 does not contain information to define this variable
*</_docuagriland_>
...
notes area_docuagriland: the HIES 2016 does not contain information to define this variable
*</_area_docuagriland_>
...
notes fem_agrilandownti: the HIES 2016 does not contain information to define this variable
*</_fem_agrilandownti_>
...
gen   agrilandownti = .a
notes agrilandownti: the HIES 2016 does not contain information to define this variable
*</_agrilandownti_>
...
gen   sellagriland = .a
notes sellagriland: the HIES 2016 does not contain information to define this variable
*</_sellagriland_>
...
gen   transagriland = .a
notes transagriland: the HIES 2016 does not contain information to define this variable
*</_transagriland_>
...
gen   dweltyp = .a
notes dweltyp: the HIES 2016 does not contain information to define this variable
*</_dweltyp_>
...
gen   typlivqrt = .a
notes typlivqrt: the HIES 2016 does not contain information to define this variable
*</_typlivqrt_>
