...
*"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    sort hhid pid
	if year<2016 {
		keep ${keepextra} age atschool bicycle buffalo cellphone chicken code computer contract countrycode cow cpi* ppp* ed_mod_age educat4 educat5 educat7 educy electricity empstat empstat_2 empstat_2_year everattend fan firmsize_l firmsize_u food_share healthins hsize idh idh_org idp idp_org improved_sanitation improved_water industry industry_2 industry_orig industry_orig_2 int_month int_year internet lamp lb_mod_age literacy lphone lstatus male marital month motorcar motorcycle nfood_share njobs nlfreason occup ocusec ownhouse piped_water pline_int pline_nat poor_int poor_nat pop_wgt psu quintile_cons_aggregate radio rbirth rbirth_juris refrigerator relationcs relationharm rprevious rprevious_juris sar_improved_toilet sar_improved_water sewage_toilet sewingmachine soc socialsec spdef strata subnatid1 subnatid2 subnatid3 survey television toilet_jmp toilet_orig typehouse unempldur_l unempldur_u union unitwage unitwage_2 urban veralt vermast wage wage_2 washingmachine water_jmp water_orig welfare welfaredef welfarenat welfarenom welfareother welfareothertype welfaretype welfshprosperity wgt weighttype whours year yrmove hhid pid //welfshprtype converfactor agecat finalweight
	}
	else if year>=2016 {
		keep ${keepextra} age atschool bicycle buffalo cellphone chicken code computer contract countrycode cow cpi* ppp* ed_mod_age educat4 educat5 educat7 educy electricity empstat empstat_2 empstat_2_year everattend fan firmsize_l firmsize_u food_share healthins hsize idh idh_org idp idp_org improved_sanitation improved_water industry industry_2 industry_orig industry_orig_2 int_month int_year internet lamp lb_mod_age literacy lphone lstatus male marital month motorcar motorcycle nfood_share njobs nlfreason occup ocusec ownhouse piped_water pline_int pline_nat poor_int poor_nat pop_wgt psu quintile_cons_aggregate radio rbirth rbirth_juris refrigerator relationcs relationharm rprevious rprevious_juris sar_improved_toilet sar_improved_water sewage_toilet sewingmachine soc socialsec spdef strata subnatid1 subnatid2 subnatid3 survey television toilet_jmp toilet_orig typehouse unempldur_l unempldur_u union unitwage unitwage_2 urban veralt vermast wage wage_2 washingmachine water_jmp water_orig welfare welfaredef welfarenat welfarenom welfareother welfareothertype welfaretype welfshprosperity wgt weighttype whours year yrmove hhid pid //finalweight
	}
