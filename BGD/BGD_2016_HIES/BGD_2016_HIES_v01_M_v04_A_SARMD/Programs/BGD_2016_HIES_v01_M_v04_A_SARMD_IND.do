...
** INITIAL COMMANDS
	...
	set more off, perm
/*
** DIRECTORY: P:\SARMD\SARDATABANK\SAR_DATABANK
	glo ppath "P:\SARMD\SARDATABANK\SAR_DATABANK"
	glo input "${ppath}\BGD\BGD_2016_HIES\BGD_2016_HIES_v01_M"
	glo output "${ppath}\BGD\BGD_2016_HIES\BGD_2016_HIES_v01_M_v04_A_SARMD"
	glo pricedata "P:\SARMD\SOUTH ASIA MICRO DATABASE\CPI\cpi_ppp_sarmd_weighted.dta"
	glo shares "P:\SARMD\SOUTH ASIA MICRO DATABASE\APPS\DATA CHECK\Food and non-food shares\BGD"
	glo fixlabels "P:\SARMD\SOUTH ASIA MICRO DATABASE\APPS\DATA CHECK\Label fixing"
	*/

	glo input     "${rootdatalib}\BGD\BGD_2016_HIES\BGD_2016_HIES_v01_M"
	glo output    "${rootdatalib}\BGD\BGD_2016_HIES\BGD_2016_HIES_v01_M_v04_A_SARMD"
	glo shares    "P:\SARMD\SARDATABANK\APPS\DATA CHECK\Food and non-food shares\BGD"
...
** LOG FILE
	log using "${output}\Doc\Technical\BGD_2016_HIES_v01_M_v04_A_SARMD.log", replace
...
*******************************************************************************/
	...
	*<_subnatid1_>
		...
		*replace subnatid1=30 if (subnatid1==45 & year==2016)
		la def lblsubnatid1 10 "Barisal" 20 "Chittagong" 30 "Dhaka" 40 "Khulna" 45 "Mymensingh" 50 "Rajshahi" 55 "Rangpur" 60 "Sylhet"
...
*******************************************************************************/
	...
	** YEARS OF EDUCATION COMPLETED: if does not how to read, educy defined as zero
	*<_educy_>
		gen educy=.  
...
*****************************************************************************************************/
	...
	*<_cpi_>
		...
		preserve
		use     "$pricedata", clear 
		keep if countrycode=="BGD" & year==2016
		tempfile pricedata
		save     `pricedata'
		restore
		merge m:1 countrycode year using `pricedata', nogen ///
		keepusing(countrycode year syear cpi${year}_w ppp${year}) keep(3)
	*</_cpi_>	
...
** KEEP VARIABLES - ALL
	...
	urban subnatid1	subnatid2 subnatid3 subnatid4 subnatlev gaul_adm1_code gaul_adm2_code ownhouse tenure landholding water_original ///
	...
	lamp bicycle motorcycle motorcar cow buffalo chicken boat rooms kitchen stove roof wall areaspace bath acqui_house spdef welfare welfarenom ///
...
** DELETE MISSING VARIABLES
	...
	saveold "${output}\Data\Harmonized\BGD_2016_HIES_v01_M_v04_A_SARMD_IND.dta", replace version(12)
	*saveold "${ppath}\__REGIONAL\Individual Files\BGD_2016_HIES_v01_M_v04_A_SARMD_IND.dta", replace version(12)
