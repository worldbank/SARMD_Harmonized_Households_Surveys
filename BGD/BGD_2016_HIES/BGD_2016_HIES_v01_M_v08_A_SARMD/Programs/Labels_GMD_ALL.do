...
*******************************************************************************
    ...
    loc GMD_ALL age  agecat  atschool  bicycle  cellphone  chicken  code  computer  converfactor  countrycode  countryname  ed_mod_age  educat4  educat5  educat7  educy  electricity  empstat  everattend  fan  gaul_adm1_code  gaul_adm2_code gaul_adm3_code harmonization hhid  hsize  imp_san_rec  imp_wat_rec  industry_orig  industry  industrycat10  industrycat4  int_month  landphone  lb_mod_age  literacy  lstatus  male  marital  motorcar  motorcycle  njobs  nlfreason  occup_orig  occup  ocusec  ownhouse  pid  piped_water  primarycomp  psu  radio  refrigerator  relationcs  relationharm  school  sector  sewingmachine  soc  spdef  strata  subnatid1  subnatid2  subnatid3  survey  television  tenure  toilet_orig  sanitation_source toilet_acc  unitwage  urban  wage  washingmachine  water_jmp  water_orig  water_source watertype_quest pipedwater_acc wei* pop*  welfare  welfaretype welfaredef  welfarenom  welfareother  welfareothertype  welfshprosperity  welfshprtype year
...
*******************************************************************************
	...
	cap lab var wgt "Household sampling weight" 
...
* Section 5: Clean up
*******************************************************************************
keep age  agecat  atschool  bicycle  cellphone  chicken  code  computer  converfactor  countrycode  countryname cpi*  ed_mod_age  educat4  educat5  educat7  educy  electricity  empstat  everattend  fan  gaul_adm1_code  gaul_adm2_code gaul_adm3_code harmonization  hhid  hsize  imp_san_rec  imp_wat_rec  industry_orig  industry  industrycat10  industrycat4  int_month  landphone  lb_mod_age  literacy  lstatus  male  marital  motorcar  motorcycle  njobs  nlfreason  occup_orig  occup  ocusec  ownhouse  pid  piped_water ppp* primarycomp  psu  radio  refrigerator  relationcs  relationharm  school  sector  sewingmachine  soc  spdef  strata  subnatid1  subnatid2  subnatid3  survey  television  tenure  toilet_orig  unitwage  urban  wage  washingmachine  water_jmp  water_orig water_source watertype_quest sanitation_source toilet_acc pipedwater_acc wei* pop*  welfare  welfaretype welfaredef  welfarenom  welfareother  welfareothertype  welfshprosperity  welfshprtype year
