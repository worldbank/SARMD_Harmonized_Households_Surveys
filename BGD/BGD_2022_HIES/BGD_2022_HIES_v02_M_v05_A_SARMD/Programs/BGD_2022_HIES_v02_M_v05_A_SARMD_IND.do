/*------------------------------------------------------------------------------
  SARMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	BGD_2022_HIES_v02_M_v05_A_SARMD_IND.do	   </_Program name_>
<_Application_>    	STATA 17.0									 <_Application_>
<_Author(s)_>      	Leo Tornarolli <tornarolli@gmail.com>		  </_Author(s)_>
<_Date created_>   	03-2024									   </_Date created_>
<_Date modified>   	July 2025							  	  </_Date modified_>
--------------------------------------------------------------------------------
...
<_Version Control_>
Date:				07-2025
File:				BGD_2022_HIES_v02_M_v05_A_SARMD_IND.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
clonevar wgt = hh_wgt 
capture clonevar weight = hh_wgt 
...
replace lstatus = 1			if  ila!=0 & ila!=. & lstatus!=1
...
*<_industry_orig_year_note_>   *</_industry_orig_year_note_>
gen     industry_orig_year = "1 - Agriculture, hunting and related activities" 			if  S4AQ01B_1==1
replace industry_orig_year = "2 - Forest and related activities"		 					if  S4AQ01B_1==2
replace industry_orig_year = "5 - Fisheries and related activities"	 					if  S4AQ01B_1==5
replace industry_orig_year = "10 - Minerals" 												if  S4AQ01B_1==10
replace industry_orig_year = "11 - Gas and oil extraction"			 					if  S4AQ01B_1==11
replace industry_orig_year = "14 - Other mineral exploration"			 					if  S4AQ01B_1==14
replace industry_orig_year = "15 - Food and beverage production"		 					if  S4AQ01B_1==15
replace industry_orig_year = "16 - Production of tobacco products"	 					if  S4AQ01B_1==16
replace industry_orig_year = "17 - Textile production"				 					if  S4AQ01B_1==17
replace industry_orig_year = "18 - Production of ready-made garments"	 					if  S4AQ01B_1==18
replace industry_orig_year = "19 - Production of leather and leather products"			if  S4AQ01B_1==19
replace industry_orig_year = "20 - Production of wood and timber products"				if  S4AQ01B_1==20
replace industry_orig_year = "21 - Paper and paper production"		 					if  S4AQ01B_1==21
replace industry_orig_year = "22 - Publication, printing and caking"	 					if  S4AQ01B_1==22
replace industry_orig_year = "23 - Petroleum refining"				 					if  S4AQ01B_1==23
replace industry_orig_year = "24 - Production of chemicals"			 					if  S4AQ01B_1==24
replace industry_orig_year = "25 - Production of rubber and plastic products"				if  S4AQ01B_1==25
replace industry_orig_year = "26 - Production of other non-metallic minerals"				if  S4AQ01B_1==26
replace industry_orig_year = "27 - Metal production" 										if  S4AQ01B_1==27
replace industry_orig_year = "28 - Production of non-metallic products" 					if  S4AQ01B_1==28
replace industry_orig_year = "29 - Manufacture of other unclassified equipment"   		if  S4AQ01B_1==29
replace industry_orig_year = "30 - Production of office and accounting equipment"			if  S4AQ01B_1==30
replace industry_orig_year = "31 - Manufacture of electrical equipment" 					if  S4AQ01B_1==31
replace industry_orig_year = "32 - Production of radio, television and media"				if  S4AQ01B_1==32
replace industry_orig_year = "33 - Manufacture of watches, spectacles, etc."				if  S4AQ01B_1==33
replace industry_orig_year = "34 - Motor car production"				 					if  S4AQ01B_1==34
replace industry_orig_year = "35 - Manufacture of equipment used in other industries"		if  S4AQ01B_1==35
replace industry_orig_year = "36 - Manufacture of furniture and unclassified items"		if  S4AQ01B_1==36
replace industry_orig_year = "37 - Recycling" 											if  S4AQ01B_1==37
replace industry_orig_year = "40 - Gas, hot water and electricity supply" 				if  S4AQ01B_1==40
replace industry_orig_year = "41 - Water collection, purification and supply"				if  S4AQ01B_1==41
replace industry_orig_year = "45 - Construction" 											if  S4AQ01B_1==45
replace industry_orig_year = "50 - Sale, maintenance, repair and sale of motor vehicles"	if  S4AQ01B_1==50
replace industry_orig_year = "51 - Wholesale business other than motor vehicles" 			if  S4AQ01B_1==51
replace industry_orig_year = "52 - Other retail business besides motor vehicles" 			if  S4AQ01B_1==52
replace industry_orig_year = "55 - Hotel and restaurants"						 			if  S4AQ01B_1==55
replace industry_orig_year = "60 - Road vehicles" 										if  S4AQ01B_1==60
replace industry_orig_year = "61 - Naval vehicles" 										if  S4AQ01B_1==61
replace industry_orig_year = "62 - Aircraft" 												if  S4AQ01B_1==62
replace industry_orig_year = "63 - Travel assistance (transport and travel)"	 			if  S4AQ01B_1==63
replace industry_orig_year = "64 - Postal and telecommunications"				 			if  S4AQ01B_1==64
replace industry_orig_year = "65 - Financial intermediation" 								if  S4AQ01B_1==65
replace industry_orig_year = "66 - Insurance and pension"						 			if  S4AQ01B_1==66
replace industry_orig_year = "67 - Financial intermediary support"			 			if  S4AQ01B_1==67
replace industry_orig_year = "70 - Real estate"								 			if  S4AQ01B_1==70
replace industry_orig_year = "71 - Rental of personal and home use equipment" 			if  S4AQ01B_1==71
replace industry_orig_year = "72 - Computer and related work"				 				if  S4AQ01B_1==72
replace industry_orig_year = "73 - Research and development" 								if  S4AQ01B_1==73
replace industry_orig_year = "74 - Other businesses"						 				if  S4AQ01B_1==74
replace industry_orig_year = "75 - Public administration and defense"		 				if  S4AQ01B_1==75
replace industry_orig_year = "80 - Education" 											if  S4AQ01B_1==80
replace industry_orig_year = "81 - Health and social services"			 				if  S4AQ01B_1==81
replace industry_orig_year = "90 - Sewerage and similar works"			 				if  S4AQ01B_1==90
replace industry_orig_year = "92 - Recreational, cultural and sports activities"			if  S4AQ01B_1==92
replace industry_orig_year = "99 - Foreign agencies"	 									if  S4AQ01B_1==99
...
gen     industry_orig_2_year = "1 - Agriculture, hunting and related activities" 			if  S4AQ01B_2==1
replace industry_orig_2_year = "2 - Forest and related activities"		 					if  S4AQ01B_2==2
replace industry_orig_2_year = "5 - Fisheries and related activities"	 					if  S4AQ01B_2==5
replace industry_orig_2_year = "10 - Minerals" 											if  S4AQ01B_2==10
replace industry_orig_2_year = "11 - Gas and oil extraction"			 					if  S4AQ01B_2==11
replace industry_orig_2_year = "14 - Other mineral exploration"			 				if  S4AQ01B_2==14
replace industry_orig_2_year = "15 - Food and beverage production"		 					if  S4AQ01B_2==15
replace industry_orig_2_year = "16 - Production of tobacco products"	 					if  S4AQ01B_2==16
replace industry_orig_2_year = "17 - Textile production"				 					if  S4AQ01B_2==17
replace industry_orig_2_year = "18 - Production of ready-made garments"	 				if  S4AQ01B_2==18
replace industry_orig_2_year = "19 - Production of leather and leather products"			if  S4AQ01B_2==19
replace industry_orig_2_year = "20 - Production of wood and timber products"				if  S4AQ01B_2==20
replace industry_orig_2_year = "21 - Paper and paper production"		 					if  S4AQ01B_2==21
replace industry_orig_2_year = "22 - Publication, printing and caking"	 					if  S4AQ01B_2==22
replace industry_orig_2_year = "23 - Petroleum refining"				 					if  S4AQ01B_2==23
replace industry_orig_2_year = "24 - Production of chemicals"			 					if  S4AQ01B_2==24
replace industry_orig_2_year = "25 - Production of rubber and plastic products"			if  S4AQ01B_2==25
replace industry_orig_2_year = "26 - Production of other non-metallic minerals"			if  S4AQ01B_2==26
replace industry_orig_2_year = "27 - Metal production" 									if  S4AQ01B_2==27
replace industry_orig_2_year = "28 - Production of non-metallic products" 					if  S4AQ01B_2==28
replace industry_orig_2_year = "29 - Manufacture of other unclassified equipment"   		if  S4AQ01B_2==29
replace industry_orig_2_year = "30 - Production of office and accounting equipment"		if  S4AQ01B_2==30
replace industry_orig_2_year = "31 - Manufacture of electrical equipment" 					if  S4AQ01B_2==31
replace industry_orig_2_year = "32 - Production of radio, television and media"			if  S4AQ01B_2==32
replace industry_orig_2_year = "33 - Manufacture of watches, spectacles, etc."				if  S4AQ01B_2==33
replace industry_orig_2_year = "34 - Motor car production"				 					if  S4AQ01B_2==34
replace industry_orig_2_year = "35 - Manufacture of equipment used in other industries"	if  S4AQ01B_2==35
replace industry_orig_2_year = "36 - Manufacture of furniture and unclassified items"		if  S4AQ01B_2==36
replace industry_orig_2_year = "37 - Recycling" 											if  S4AQ01B_2==37
replace industry_orig_2_year = "40 - Gas, hot water and electricity supply" 				if  S4AQ01B_2==40
replace industry_orig_2_year = "41 - Water collection, purification and supply"			if  S4AQ01B_2==41
replace industry_orig_2_year = "45 - Construction" 										if  S4AQ01B_2==45
replace industry_orig_2_year = "50 - Sale, maintenance, repair and sale of motor vehicles"	if  S4AQ01B_2==50
replace industry_orig_2_year = "51 - Wholesale business other than motor vehicles" 		if  S4AQ01B_2==51
replace industry_orig_2_year = "52 - Other retail business besides motor vehicles" 		if  S4AQ01B_2==52
replace industry_orig_2_year = "55 - Hotel and restaurants"						 		if  S4AQ01B_2==55
replace industry_orig_2_year = "60 - Road vehicles" 										if  S4AQ01B_2==60
replace industry_orig_2_year = "61 - Naval vehicles" 										if  S4AQ01B_2==61
replace industry_orig_2_year = "62 - Aircraft" 											if  S4AQ01B_2==62
replace industry_orig_2_year = "63 - Travel assistance (transport and travel)"	 			if  S4AQ01B_2==63
replace industry_orig_2_year = "64 - Postal and telecommunications"				 		if  S4AQ01B_2==64
replace industry_orig_2_year = "65 - Financial intermediation" 							if  S4AQ01B_2==65
replace industry_orig_2_year = "66 - Insurance and pension"						 		if  S4AQ01B_2==66
replace industry_orig_2_year = "67 - Financial intermediary support"			 			if  S4AQ01B_2==67
replace industry_orig_2_year = "70 - Real estate"								 			if  S4AQ01B_2==70
replace industry_orig_2_year = "71 - Rental of personal and home use equipment" 			if  S4AQ01B_2==71
replace industry_orig_2_year = "72 - Computer and related work"				 			if  S4AQ01B_2==72
replace industry_orig_2_year = "73 - Research and development" 							if  S4AQ01B_2==73
replace industry_orig_2_year = "74 - Other businesses"						 				if  S4AQ01B_2==74
replace industry_orig_2_year = "75 - Public administration and defense"		 			if  S4AQ01B_2==75
replace industry_orig_2_year = "80 - Education" 											if  S4AQ01B_2==80
replace industry_orig_2_year = "81 - Health and social services"			 				if  S4AQ01B_2==81
replace industry_orig_2_year = "90 - Sewerage and similar works"			 				if  S4AQ01B_2==90
replace industry_orig_2_year = "92 - Recreational, cultural and sports activities"			if  S4AQ01B_2==92
replace industry_orig_2_year = "99 - Foreign agencies"	 									if  S4AQ01B_2==99
...
foreach var in lstatus nlfreason unempldur_l unempldur_u njobs industry industry_2 industry_year industry_2_year occup occup_2 occup_year empstat empstat_year empstat_2 empstat_2_year ocusec ocusec_year firmsize_l firmsize_u contract healthins socialsec union wage wage_2 unitwage unitwage_2 whours {
	replace `var'=. if age<lb_mod_age
	}
foreach var in industry_orig industry_orig_2 industry_orig_year industry_orig_2_year {
	replace `var'="." if age<lb_mod_age
	}	
...
cap drop welfare_ppp
gen      welfare_ppp = (p_cons2*12)/cpi2021/icp2021/365
apoverty welfare_ppp [aw=weight] 	if  merge==3, line(3.00) 
apoverty welfare_ppp [aw=weight] 	if  merge==3, line(4.20) 
apoverty welfare_ppp [aw=weight] 	if  merge==3, line(8.30)
*/
*<_spdef_>
...
* Welfare spatially adjusted by poverty line
sum zu_cbn [aw=wgt] 
...
local avg2 = r(mean)
replace spdef = (`mean_nat'/zu_cbn)*(`avg'/`avg2')
replace welfare = welfare*spdef*12
*replace welfare_ppp = welfare_ppp*spdef
*</_welfare_>
...
capture drop welfarenom
gen welfarenom = p_cons2*12
*</_welfarenom_>
...
/*
preserve
keep hhid pid iline_nat extr_nat welfare_ppp merge
tempfile poverty
...
*drop  _merge
save  "$output\\`yearfolder'_v`vm'_M_v`va'_A_`type'_IND_full.dta", replace
*</_Save data file_>

/*
apoverty welfare_ppp [aw=wgt] 	if  merge==3, line(3.00) 
apoverty welfare_ppp [aw=wgt] 	if  merge==3, line(4.20) 
apoverty welfare_ppp [aw=wgt] 	if  merge==3, line(8.30)
*/
