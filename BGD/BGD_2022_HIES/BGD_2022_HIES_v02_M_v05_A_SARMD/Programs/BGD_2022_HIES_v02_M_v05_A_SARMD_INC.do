/*------------------------------------------------------------------------------
  SARMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	BGD_2022_HIES_v02_M_v05_A_SAMRD_INC.do	   </_Program name_>
...
<_Version Control_>
Date:				07-2025
File:				BGD_2022_HIES_v02_M_v05_A_SAMRD_INC.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*  6 = Working lactating mother support
* 12 = Gratuitous relief (food/cash)
* 20 = Primary education student stipend
* 21 = Stipend for secondary, higher secondary and madrasah education level students
* 22 = Stipend for undergraduate and postgraduate level students
* 23 = Stipend for students of technical education institutions
* 39 = Income support programme for the poorest
egen icct = rsum(ssn6 ssn12 ssn20_alt ssn21_alt ssn22_alt ssn23 ssn39), missing
*</_icct_>

*<_inocct_m_>
*<_inocct_m_note_> Income from public transfers not CCT - monetary *</_inocct_m_note_>
egen inocct_m  = rsum(ssn_cash1 ssn_cash2 ssn_cash3 ssn_cash4 ssn_cash5 ssn_cash7 ssn_cash8 ssn_cash9 ssn_cash10 ssn_cash11 ssn_cash13 ssn_cash14 ssn_cash15 ssn_cash16 ssn_cash17 ssn_cash18 ssn_cash19 ssn_cash24 ssn_cash25 ssn_cash26 ssn_cash27 ssn_cash28 ssn_cash31 ssn_cash32 ssn_cash33 ssn_cash35 ssn_cash42 ssn_cash45 ssn_cash55 ssn_cash56 ssn_cash59 ssn_cash99), missing
*</_inocct_m_>

*<_inocct_nm_>
*<_inocct_nm_note_> Income from public transfers not CCT - non-monetary *</_inocct_nm_note_>
egen 	food_gov = rsum(S9A2Q08_adjust S9B2Q04_adjust)
replace food_gov = .		if  S1AQ02!=1

egen inocct_nm = rsum(ssn_kind1 ssn_kind2 ssn_kind3 ssn_kind4 ssn_kind5 ssn_kind7 ssn_kind8 ssn_kind9 ssn_kind10 ssn_kind11 ssn_kind13 ssn_kind14 ssn_kind15 ssn_kind16 ssn_kind17 ssn_kind18 ssn_kind19 ssn_kind24 ssn_kind25 ssn_kind26 ssn_kind27 ssn_kind28 ssn_kind31 ssn_kind32 ssn_kind33 ssn_kind35 ssn_kind42 ssn_kind45 ssn_kind55 ssn_kind56 ssn_kind59 ssn_kind99 food_gov), missing
*</_inocct_nm_>
...
gen   psu = PSU
merge m:1 psu idh hhid using "$rootdatalib\\`code'\\`yearfolder'\BGD_2022_HIES_v02_M\Data\Stata\welfare_2022.dta"
drop  if _merge==2
drop _merge
...
foreach var in `INCOME' {
		...
		gen `var'_adj = `var'*`mean_nat'/zu_cbn
		sum `var'_adj [aw=wgt] 
		local avg2 = r(mean)
		replace `var' = `var'_adj*`avg'/`avg2'
		drop `var'_adj
		}
