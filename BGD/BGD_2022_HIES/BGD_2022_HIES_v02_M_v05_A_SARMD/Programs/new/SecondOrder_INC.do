...
*******************************************************************************
cap la var weight "Household weight"
...
cap la var hsize "Number of household members"
...
* Section 5: Clean up
*******************************************************************************
order countrycode year hhid pid weight weighttype iempp_m iempp_nm iempp isalp_m isalp_nm isalp isep_m isep_nm isep iolp_m iolp_nm iolp ip ip_m iempnp_m iempnp_nm iempnp isalnp_m isalnp_nm isalnp isenp_m isenp_nm isenp iolnp_m iolnp_nm iolnp inp inp_m iemp iemp_m isal isal_m ise ise_m ila ila_m ilaho ilaho_m perila ijubi ijubi_con ijubi_ncon ijubi_o icap itranext_m itranext_nm itranint_m itranint_nm itran_ns inocct_m inocct_nm itrane_ns inla_otro icct itran itrane itranp itran_m itrane_m itranp_m inla inla_m ii ii_m ilf ilf_m inlaf inlaf_m itf_m itf_sin_ri renta_imp itf hogarsec hsize ipcf  
