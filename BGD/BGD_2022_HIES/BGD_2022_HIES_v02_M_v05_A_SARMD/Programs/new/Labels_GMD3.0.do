...
*******************************************************************************
	...
	loc COR spdef weight* cpi* weighttype ppp* survey vermast 			///
	...
	loc DEM language age agecat male relationharm relationcs marital 				///
		...
		comm_dsablty childyr childmth mineducatage literacy everattend 			/// 
		mineducatage educat5 educat5 educat4 educy primarycomp school
	...
	loc LBR minlaborage lstatus nlfreason unempldur_l unempldur_u empstat 		///
		...
		occup_2 occup_2* wage_nc_2* unitwage_2* whours_2* wmonths_2* wage_total_2* 	///
	...
	local gmd_3_0_vars `IDN' `COR' `GEO' `DEM' `LBR' `UTL' `DWL' `CONS'
...
*******************************************************************************
	...
	cap lab var hhsize "Total number of residents (regular members) in the household, excluding maids and servants"
