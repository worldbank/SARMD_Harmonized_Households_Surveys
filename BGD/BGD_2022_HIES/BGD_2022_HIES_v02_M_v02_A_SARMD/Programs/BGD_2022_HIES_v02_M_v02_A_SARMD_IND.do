/*------------------------------------------------------------------------------
  SARMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	BGD_2022_HIES_v02_M_v02_A_SARMD_IND.do	   </_Program name_>
...
<_Version Control_>
Date:				12-2023
File:				BGD_2022_HIES_v02_M_v02_A_SARMD_IND.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*use   "${rootdatalib}\\`code'\\`yearfolder'\\`yearfolder'_v`vm'_M\Data\Stata\\BGD_2022_HIES_v01_M_base.dta", clear 
sort  PSU HHID PID
...
merge m:1 psu idh hhid using "$rootdatalib\\`code'\\`yearfolder'\\`yearfolder'_v`vm'_M\Data\Stata\welfare_2022.dta", keep(1 3)


rename welfare welfare_old
...
gen      welfare_ppp = (welfare*12)/cpi2017_v10/ppp_2017/365
apoverty welfare_ppp [aw=weight] , line(2.15) 

** CPI PERIOD  
*<_cpiperiod_>
gen   cpiperiod = "2022m1-2022m12"
...
gen pline_int = 2.15*cpi2017_v10*ppp_2017*365/12 
*</_pline_int_>
