...
local gmdfolder    	"BGD_2022_HIES_v01_M_v01_A_SARMD";
local SARMDfolder  	"BGD_2022_HIES_v01_M_v01_A_SARMD";
local filename     	"BGD_2022_HIES_v01_M_v01_A_SARMD_COR";
*</_Program setup_>;
...
/*
tempfile IND
datalibweb, country(`code') year(`year') survey(`survey') type(`type') vermast(`vm') veralt(`va') mod(IND) localpath(${rootdatalib}) local clear 
keep countrycode year hhid pid weight weighttype hsize literacy atschool educy educat7 educat5 educat4 welfare welfaretype spdef welfaredef welfarenom welfareother welfareothertype welfshprosperity PSU HHID PID
sort  PSU HHID PID
*/
