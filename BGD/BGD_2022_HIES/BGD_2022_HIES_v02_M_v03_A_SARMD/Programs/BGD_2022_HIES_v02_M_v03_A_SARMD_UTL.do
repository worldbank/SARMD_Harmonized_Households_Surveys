/*------------------------------------------------------------------------------
  GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	BGD_2022_HIES_v02_M_v03_A_SARMD_UTL.do	   </_Program name_>
...
<_Version Control_>
Date:				03-2024
File:				BGD_2022_HIES_v02_M_v03_A_SARMD_UTL.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
notes   pwater_exp: original variable S9CQ03_44111 is "water bill supplied"
*</_pwater_exp_>
...
notes dwelothsvc_exp: includes "lift (repair/use) and security expenses" and "bills payable to authority/housing"
drop aux1 aux2
*</_dwelothsvc_exp_>
...
notes   elec_exp: original variable is "electricity bill (with meter charge)"
*</_elec_exp_>
...
notes   ngas_exp: it includes "gas bill (gas supplied on line)" and "natural gas (bottled)"
drop aux1 aux2
*</_ngas_exp _>
...
notes   LPG_exp: it includes "LPG (bottled)"
*</_LPG_exp _>
...
notes   gasoline_exp: it includes "petrol" and "octane"
drop aux1 aux2
*</_gasoline_exp _>
...
notes   othliq_exp: it includes "CNG", "LPG" and "motor well mobil"
drop aux1 aux2 aux3
*</_othliq_exp _>
...
notes   othsol_exp: it includes "agricultural material", "cattle waste (dung)", "jute/mesta shala (shingta/jhingla)" and "other"
...
gen 	w_30m = .
replace w_30m = 1				if  S6AQ14>=0 & S6AQ14<=30
replace w_30m = 0				if  S6AQ14>30 & S6AQ14<90
*</_w_30m_>
