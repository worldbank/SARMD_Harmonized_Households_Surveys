/*------------------------------------------------------------------------------
  SARMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	BGD_2022_HIES_v02_M_v04_A_SARMD_IND.do	   </_Program name_>
...
<_Version Control_>
Date:				09-2024
File:				BGD_2022_HIES_v02_M_v04_A_SARMD_IND.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
gen spatial_def = (`mean_nat'/zu_cbn)*(`avg'/`avg2')
preserve
keep hhid pid spatial_def
tempfile spatial
...
drop  _merge
save  "$output\BGD_2022_HIES_v02_M_v04_A_SARMD_IND_full.dta", replace
*</_Save data file_>
