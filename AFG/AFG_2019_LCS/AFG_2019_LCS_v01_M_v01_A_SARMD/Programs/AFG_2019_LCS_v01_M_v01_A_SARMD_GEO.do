...
local filename      "`code'_`year'_`survey'_v`vm'_M_v`va'_A_`type'_GEO"
*</_Program setup_>
...
gen subnatid1_prev=.
note subnatid1_prev: survey uses the same classifications as 2016, so this is left missing.
*</_subnatid1_prev_>
...
gen subnatid2_prev=.
note subnatid2_prev: survey uses the same classifications as  2016, so this is left missing.
*</_subnatid2_prev_>
...
gen subnatid3_prev=.
note subnatid3_prev: survey uses the same classifications as  2016, so this is left missing.
*</_subnatid3_prev_>
...
gen subnatid4_prev=.
note subnatid4_prev: survey uses the same classifications as 2016, so this is left missing.
*</_subnatid4_prev_>
