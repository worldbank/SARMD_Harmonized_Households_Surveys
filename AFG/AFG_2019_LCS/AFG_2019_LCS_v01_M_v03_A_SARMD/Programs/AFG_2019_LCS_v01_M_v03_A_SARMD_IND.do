...
if ("`c(username)'"=="sunquat") {
	...
	* individual-level assebled data
	merge 1:m hhid_orig using "AFG_2019_LCS_M", nogen assert(match)
	drop HH_ID
	rename hhid_orig HH_ID
	* labour data
	merge m:1 HH_ID Mem_ID using "labour_male", nogen assert(master match)
	rename HH_ID hhid_orig
}
...
gen subnatid4=.
note subnatid4: The data is not representative below the subnatid4 level.
...
decode q12, gen(subnatid2_sar)
decode q16, gen(subnatid3_sar)
gen subnatid4_sar = ""
...
replace	literacy = 1 if inrange(q215e,2,7) | inrange(q215g,1,19)	//completed any amount of school
*</_literacy_>
...
recode q616 (1=1) (2=2) (3=3) (4=4) (5=7) (6=8) (7=5) (8=6) (9=12) (10=10) (11=14) (*=.), g(water_jmp)
*</_water_jmp_>
...
*<_toilet_jmp_>
recode q619 (1=7) (2=8) (3=6) (4=1) (5=2) (6=3) (7=4) (8/9=9) (10=12) (11=13) (*=.), g(toilet_jmp)
*</_toilet_jmp_>
...
gen shared_toilet=.
replace shared_toilet=0 if  q620==2
replace shared_toilet=1 if  q620==1
...
gen sewage_toilet=.
replace sewage_toilet=1 if  q619==4
replace sewage_toilet=0 if  q619!=4 & q619!=.
...
recode q606 (1/3 5=1) (4 6/7=3) (8=2) (*=.), g(ownhouse)
*</_ownhouse_>
...
*</_chicken_>
g chicken = (q704==1) if inlist(q704,1,2) | q701==2
note chicken: For AFG_2019_LCS, the variable used included "chickens or other poultry birds such as turkeys, geese, ducks, quail etc.".																																
*</_chicken_>

*</_cow_>
g cow = ((q702a_1>0 & q702a_1<.) | (q702a_2>0 & q702a_2<.) | (q702a_3>0 & q702a_3<.)) if ~mi(q702a_1) | ~mi(q702a_2) | ~mi(q702a_3) | q701==2
note cow: For AFG_2019_LCS, the variable used included "cattle (meat, dairy, and calf)".																																
*</_cow_>

*</_motorcar_>
recode q902_9 (0=0) (1/3=1), g(motorcar)
*</_motorcar_>

* create variables that were not in questionnaire as missing 
foreach var_notfound in buffalo lamp lphone wage wage_2  {
	g `var_notfound'=.
	note `var_notfound': For AFG_2019_LCS, questions necessary to create `var_notfound' were not in the questionnaire.
}

* create variables that do not have sufficient definitions from the SAR team
foreach var_notfound in industry_year industry_2_year rbirth rbirth_juris rprevious rprevious_juris yrmove  {
	g `var_notfound'=.
	note `var_notfound': For AFG_2019_LCS, I did not have a sufficient understanding of how `var_notfound' is defined from the SAR team, so it was created as missing.
}
