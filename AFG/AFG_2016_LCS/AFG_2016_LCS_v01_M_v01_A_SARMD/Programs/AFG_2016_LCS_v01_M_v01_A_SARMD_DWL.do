...
tempfile raw;
#delimit cr
datalibweb, country(AFG) year(2016) type(SARRAW) surveyid(`code'_`year'_`survey'_v01_M) filename(h_04_10.dta)
#delimit ;
ren hh_id idh;
save `raw';
*</_Raw data_>;
...
gen tv_cable= (q_7_6_e > 0) if !missing(q_7_6_e);
replace tv_cable = . if q_7_6_e == 9 ; // likely missing;
*</_tv_cable_>;
...
rename ownhouse ownhouse_sarmd;
recode q_4_6 (1 2 3=1) (5 8=2) (4 6 7=3) (9 .a = .), gen(ownhouse);
*</_ownhouse_>;
