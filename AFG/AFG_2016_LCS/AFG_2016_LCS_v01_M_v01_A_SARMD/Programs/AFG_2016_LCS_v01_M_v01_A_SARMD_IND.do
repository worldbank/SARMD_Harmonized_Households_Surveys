...
** DIRECTORY
	...
	local temppov "${rootdatalib}\AFG\AFG_2019_LCS\AFG_2019_LCS_v01_M\Data\NoUSEDStata\temp_pov_2016_2019_consolidated.dta"

** LOG FILE
*log using "`output'\Doc\Technical\AFG_2016_LCS_v01_M_v01_A_SARMD.log",replace


cd "`input'\Data\Stata\"
use "H_01.dta", clear
merge 1:1 hh_id using "H_02.dta"
drop _merge
merge 1:m hh_id using "H_03.dta"
drop _merge
merge m:1 hh_id using "H_04_10.dta"
drop _merge
merge 1:1 ind_id using "H_11.dta"
drop _merge
merge 1:1 ind_id using "H_24.dta"
drop _merge
clonevar hhid=hh_id
...
*<_educat7_>
	...
	replace educat7=9 if q11_7==7
	la var educat7 "Level of education 7 categories"
	label define lbleducat7 1 "No education" 2 "Primary incomplete" 3 "Primary complete" ///
	4 "Secondary incomplete" 5 "Secondary complete" 6 "Higher than secondary but not university" /// 
	7 "University incomplete or complete" 8 "Other" 9 "Not classified"
	label values educat7 lbleducat7
	notes educat7: 9 other not classified correspond to Islamic school
*</_educat7_>
...
*<_improved_water_>
	gen improved_water=.
	replace improved_water=1 if inrange(water_orig,1,5)
	replace improved_water=0 if inrange(water_orig,6,11) // Asuming other is not improved water source
...
tab water_orig improved_water [aw=wgt], cell nofreq
...
*<_improved_sanitation_>
	...
	replace improved_sanitation=1 if inlist(sanitation_orig,1,2,3,4,5,6,7,8)
	replace improved_sanitation=0 if inlist(sanitation_orig,9,10,11,12,13,14)
...
tab sanitation_orig improved_sanitation [aw=wgt], cell nofreq
...
*<_landphone_>
	...
	gen byte landphone=q_9_15
	recode   landphone (0=0) (1/max=1)
...
*<_ownhouse_>
	...
	gen byte ownhouse=q_4_6
	recode ownhouse (1=1) (2=1) (3=1) (4=1) (5=1) (6=1) (7=3) (8=2) (9=1) 
...
local variable_order "countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt 
						urban int_year subnatid0 subnatid1 subnatid2 gaul_adm1_code
						hsize relationharm relationcs male age marital 
						ed_mod_age atschool educy everattend literacy 
						water_orig improved_water sanitation_orig improved_sanitation
						eye_dsablty hear_dsablty walk_dsablty conc_dsord slfcre_dsablty comm_dsablty
						landphone cellphone phone computer internet radio television tv_cable video refrigerator sewingmachine washingmachine stove ricecook fan ac etablet ewpump bicycle motorcycle oxcart boat motorcar canoe roof wall floor kitchen 
						bath rooms areaspace ownhouse acqui_house acqui_land dwelownlti fem_dwelownlti dwelownti selldwel transdwel ownland doculand fem_doculand landownti sellland transland agriland area_agriland 
						ownagriland area_ownagriland purch_agriland areapurch_agriland inher_agriland areainher_agriland rentout_agriland arearentout_agriland rentin_agriland arearentin_agriland docuagriland 
						area_docuagriland fem_agrilandownti agrilandownti sellagriland transagriland typlivqrt dweltyp ybuilt
						pline_nat pline_natfood poor_nat poor_natfood welfarenat welfarenatfood";
#delimit cr
...
foreach var of varlist _all {
	...
	saveold "`output'\Data\Harmonized\AFG_2016_LCS_v01_M_v01_A_SARMD_IND.dta", replace version(13)
