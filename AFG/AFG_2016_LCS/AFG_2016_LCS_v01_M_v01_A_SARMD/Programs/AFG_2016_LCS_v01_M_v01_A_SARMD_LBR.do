...
local gmdfolder    "`code'_`year'_`survey'_v01_M_v01_A_`type'";
local filename     "`code'_`year'_`survey'_v01_M_v01_A_`type'_LBR";
*</_Program setup_>;
...
tostring q12_16, gen(industry_orig);
*</_industry_orig_>;
