...
local dlw "datalibweb, country(AFG) year(2019) type(SARRAW) surveyid(AFG_2019_LCS_v01_M)"
...
*<_improved_sanitation_>
	...
	replace improved_sanitation=0 if q_4_20==11
	notes imp_san_rec: `code' `year' imp_san_rec is classified as unimproved if the facility is shared.
*</_improved_sanitation_>
