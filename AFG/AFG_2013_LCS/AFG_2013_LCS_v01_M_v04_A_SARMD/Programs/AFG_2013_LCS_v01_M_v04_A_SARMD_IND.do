...
global pricedata "P:/SARMD/SARDATABANK/APPS/POVERTY/PovcalNet revisions/PovcalNet Spring 2016 revision/cpi_ppp_sarmd_weighted.dta"
global shares    "P:/SARMD/SARDATABANK/APPS/DATA CHECK/Food and non-food shares/BGD"
*</_Program setup_>
...
if ("`c(username)'"=="sunquat") {
	...
	* load and merge relevant data (note: removed roster_male.dta and clusters.dta as it was not used in the updated WB computer code)
	cd "${input}/Data/Stata"
	* input data
	use "`yearfolder'_M", clear
}
* global paths on WB computer
else {
	*<_Datalibweb request_>
	use "${rootdatalib}/`code'/`yearfolder'/`yearfolder'_v`vm'_M/Data/Stata/`yearfolder'_M.dta"
	*</_Datalibweb request_>
	
	** LOG FILE
	*log using "`output'/Doc/Technical/AFG_`year'_LCS_v`vm'_M_v`va'_A_SARMD.log",replace
}
...
** ELECTRICITY PUBLIC CONNECTION - SARMD ONLY (GMD CREATED BELOW)
*<_electricity_>
	egen electricity = rmin(q_4_11_a q_4_11_b q_4_11_e q_4_11_f)
	recode electricity (1=1) (2=0) (*=.)
*</_electricity_>
...
*</_shared_toilet_>
recode q_4_17 (1=1) (2=0) (*=.), g(shared_toilet)
*</_shared_toilet_>
...
*</_impr_toilet_jmp_>
	...
	*<_sanitation_source_>
		...
		replace sanitation_source=1 if q_4_16==4
	...
	*<_toilet_acc_>
		recode q_4_16 (4/5=3) (1/3 6/7=0), g(toilet_acc) 
		#delimit 
...
gen agecat = .
note agecat: For AFG_2013_LCS, age is continuous so did not create agecat.
*</_agecat_>
...
*<_literacy_>
	...
	recode literacy (2=0)
	replace literacy = 1 if (q_10_5==1 & inrange(q_10_6,1,19)) | inrange(q_10_5,2,6)	//completed any school
...
*<_educat7_>
	gen educat7=.
	replace educat7=.z if q_10_5==.a
	replace educat7=1 if q_10_4!=1
	replace educat7=2 if q_10_5==1 & q_10_6<6
	replace educat7=3 if q_10_5==1 & q_10_6==6
	replace educat7=4 if q_10_5==2 
	replace educat7=4 if q_10_5==3 & q_10_6<12
	replace educat7=5 if q_10_5==3 & q_10_6==12
	replace educat7=6 if q_10_5==4 
	replace educat7=7 if q_10_5==5 | q_10_5==6
...
cap gen industrycat10= q_11_19_b
*</_industrycat10_>
...
** CEL PHONE
*<_cellphone_>
	recode q_7_1_r (0=0) (1/max=1) (*=.), g(cellphone)
...
foreach var_notfound in industry_year industry_2_year industry_orig_year industry_orig_2_year lphone occup_year ocusec_year subnatid4 subnatid2_sar subnatid3_sar subnatid4_sar weighttype {
	if strmatch("`var_notfound'","*_orig*") g `var_notfound' = ""
	else g int `var_notfound' = .
	note `var_notfound': AFG_2013_LCS does not have any relevant questions or variables.
}

* create variables that do not have sufficient definitions from the SAR team
foreach var_notknown in food_share month nfood_share converfactor countryname gaul_adm2_code gaul_adm3_code sector {
	g `var_notknown'=.
	note `var_notknown': For AFG_2013_LCS, I did not have a sufficient understanding of how `var_notfound' is defined from the SAR team, so it was created as missing.
}
...
drop electricity
*<_electricity_>
	egen electricity = rmin(q_4_11_a q_4_11_b q_4_11_c q_4_11_d q_4_11_e q_4_11_f q_4_11_g q_4_11_h q_4_11_i)
	recode electricity (1=1) (2=0) (*=.)
*</_electricity_>
