...
** DIRECTORY
	local input "${rootdatalib}\AFG\AFG_2013_LCS\AFG_2013_LCS_v01_M"
	local output "${rootdatalib}\AFG\AFG_2013_LCS\AFG_2013_LCS_v01_M_v03_A_SARMD"
...
** ORDER VARIABLES
	...
	order countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year fieldwork subnatid0 ///
		subnatid1 subnatid2 subnatid3 gaul_adm1_code ownhouse landholding tenure water_orig piped_water water_jmp sar_improved_water water_original water_source ///
