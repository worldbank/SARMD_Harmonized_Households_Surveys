/*------------------------------------------------------------------------------
  GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	NPL_2022_LSS-IV_v02_M_v01_A_SARMD_DWL.do	   </_Program name_>
...
<_Version Control_>
Date:				08-2024
File:				NPL_2022_LSS-IV_v02_M_v01_A_SARMD_DWL.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
gen   etablet = .
notes etablet: LSS-IV only includes a binary question asking if the household owns a Telephone sets / Mobile phone / Tablet
*</_etablet_>
...
replace internet = 4			if  internet == 2
*</_internet_>
...
gen     internet_mobile = .
notes internet_mobile: the LSS-IV does not contain information specific enough to define this variable
*</_internet_mobile_>
...
notes internet_mobile4G: the LSS-IV does not contain information specific enough to define this variable
*</_internet_mobile4G_>
...
gen   tv_cable = .
replace tv_cable = 1 if q02_31_b1 == 1
replace tv_cable = 0 if q02_31_b1 == 2 
*</_tv_cable_>
...
gen   video = .
notes video: the LSS-IV does not contain information to define this variable
*</_video_>
...
gen 	stove = 0
replace stove = 1		if  own_507==1				// microwave oven //
replace stove = 1		if  q02_33>=3 & q02_33<=7	
notes   stove: category "open fireplace" and "MUD/CLAY STOVE" is considered as stove==0
*</_stove_>
...
gen   ricecook = .a
notes ricecook: the LSS-IV does not contain information to define this variable
*</_ricecook_>
...
gen 	ac = .
replace ac = 1			if  own_513==1
replace ac = 0			if  own_513==2
*</_ac_>
...
gen 	ewpump = .
replace ewpump = 1 if own_farming_6 == 1
replace ewpump = 0 if own_farming_6 == 2
notes   ewpump: question asks for "water pump"
*</_ewpump_>
...
gen   oxcart = .a
notes oxcart: the LSS-IV does not contain information to define this variable
*</_oxcart_>
...
gen   canoe = .a
notes canoe: the LSS-IV does not contain information to define this variable
*</_canoe_>
...
gen     roof = .
replace roof = 14		if  q02_06==1	// GALVANIZED IRON, TIN 	//
replace roof = 11		if  q02_06==2	// CEMENT, CONCRETE							//
replace roof = 1		if  q02_06==3	// STRAW, GRASS, HAY									//		
replace roof = 10		if  q02_06==4	// TILE, KHAPADA, JHINGATI							//
replace roof = 14		if  q02_06==5	// STONE, SLATE 									//
replace roof = 6		if  q02_06==6	// WOOD, PLANKS 									//
replace roof = 3		if  q02_06==7	// MUD, EARTH 									//
replace roof = 15		if  q02_06==8	// OTHER 									//
*</_roof_>
...
gen 	wall = .
replace wall = 1		if  q02_04==4	// BAMBOO/LEAVES 	//
replace wall = 6 		if  q02_04==1	// MUD BONDED BRICKS/STONES 						//
replace wall = 18		if  q02_04==5	// 	UNBAKED BRICKS						//
replace wall = 15		if  q02_04==3	// WOOD/PLANKS 									//
replace wall = 13		if  q02_04==2	// CEMENT BONDED BRICKS/STONES 							//
replace wall = 10		if  q02_04==6	// GALVANIZED IRON SHEETS/TIN							//
replace wall = 7		if  q02_04==7	// PRE-FAB 							//
replace wall = 19		if  q02_04==8	// OTHER 									//
*</_wall_>
...
gen   floor = .
replace floor = 1 		if q02_07 == 1     //EARTH/MUD  	//
replace floor = 4 		if q02_07 == 2    //WOOD PLANKS/BAMBOO  	//
replace floor = 11 		if q02_07 == 3    //CONCRETE/CEMENT BONDED  	//
replace floor = 10 		if q02_07 == 4    //CERAMIC TILE  	//
replace floor = 14 		if q02_07 == 5    //OTHER  	//
*</_floor_>
...
gen  	kitchen = .
replace kitchen = 0		if  q02_02_b == 0
replace kitchen = 1		if  q02_02_b>=1 & q02_02_b!=.
*</_kitchen_>
...
gen   bath = .a
notes bath: the LSS-IV does not contain information to define this variable
*</_bath_>
...
gen   ybuilt = .
replace ybuilt = q02_10-56 if int_month >=1 & int_month<=4
replace ybuilt = q02_10-57 if int_month >=5 & int_month<=12
notes areaspace: raw data is in Bikram Sambat (BS) calendar, converted to sq meters using 56 or 57 years depending on month
*</_ybuilt_>
...
gen   acqui_house = .a
notes acqui_house: the LSS-IV does not contain information to define this variable
*</_acqui_house_>
...
gen   dwelownlti = .a
notes dwelownlti: the LSS-IV does not contain information to define this variable
*</_dwelownlti_>
...
notes fem_dwelownlti: the LSS-IV does not contain information to define this variable
*</_fem_dwelownlti_>
...
gen   dwelownti = .a
notes dwelownti: the LSS-IV does not contain information to define this variable
*</_dwelownti_>
...
gen   selldwel = .a
notes selldwel: the LSS-IV does not contain information to define this variable
*</_selldwel_>
...
gen   transdwel = .a
notes transdwel: the LSS-IV does not contain information to define this variable
*</_transdwel_>
...
gen 	ownland = .a
notes ownland: the LSS-IV does not contain information to define this variable
*</_ownland_>
...
gen   acqui_land = .a
notes acqui_land: the LSS-IV does not contain information to define this variable
*</_acqui_land_>
...
gen   doculand = .a
notes doculand: the LSS-IV does not contain information to define this variable
*</_doculand_>
...
gen   fem_doculand = .a
notes fem_doculand: the LSS-IV does not contain information to define this variable
*</_fem_doculand_>
...
gen   landownti = .a
notes landownti: the LSS-IV does not contain information to define this variable
*</_landownti_>
...
gen   sellland = .a
notes sellland: the LSS-IV does not contain information to define this variable
*</_sellland_>
...
gen   transland = .a
notes transland: the LSS-IV does not contain information to define this variable
*</_transland_>
...
gen 	agriland = 1 if ownagriland==1 | notownland==1
replace agriland = 0 if ownagriland==0 & notownland==0
...
egen     area_agriland = rsum(area_notownland area_ownagriland), missing
*</_area_agriland_>
...
cap gen ownagriland = ownagriland
*</_ownagriland_>
...
cap gen     area_ownagriland = area_ownagriland
...
notes purch_agriland: the LSS-IV does not contain information to define this variable
*</_purch_agriland_>
...
notes areapurch_agriland: the LSS-IV does not contain information to define this variable
*</_areapurch_agriland_>
...
notes inher_agriland: the LSS-IV does not contain information to define this variable
*</_inher_agriland_>
...
notes areainher_agriland: the LSS-IV does not contain information to define this variable
*</_areainher_agriland_>
...
cap gen rentout_agriland = rentout_agriland
...
cap gen     arearentout_agriland = arearentout_agriland
...
cap gen rentin_agriland = rentin_agriland
...
cap gen     arearentin_agriland = arearentin_agriland
...
gen   docuagriland = .a
notes docuagriland: the LSS-IV does not contain information to define this variable
*</_docuagriland_>
...
notes area_docuagriland: the LSS-IV does not contain information to define this variable
*</_area_docuagriland_>
...
notes fem_agrilandownti: the LSS-IV does not contain information to define this variable
*</_fem_agrilandownti_>
...
gen   agrilandownti = .a
notes agrilandownti: the LSS-IV does not contain information to define this variable
*</_agrilandownti_>
...
gen   sellagriland = .a
notes sellagriland: the LSS-IV does not contain information to define this variable
*</_sellagriland_>
...
gen   transagriland = .a
notes transagriland: the LSS-IV does not contain information to define this variable
*</_transagriland_>
...
gen   dweltyp = .a
notes dweltyp: the LSS-IV does not contain information to define this variable
*</_dweltyp_>
...
gen   typlivqrt = .a
notes typlivqrt: the LSS-IV does not contain information to define this variable
*</_typlivqrt_>
