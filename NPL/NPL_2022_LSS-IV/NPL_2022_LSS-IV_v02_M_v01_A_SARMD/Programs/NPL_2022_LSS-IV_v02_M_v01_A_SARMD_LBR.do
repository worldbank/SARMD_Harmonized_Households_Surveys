/*------------------------------------------------------------------------------
  GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	NPL_2022_LSS-IV_v02_M_v01_A_SARMD_LBR.do	   </_Program name_>
...
<_Version Control_>
Date:				08-2024
File:				NPL_2022_LSS-IV_v02_M_v01_A_SARMD_LBR.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
recode industrycat10 (1=1) (2/5=2) (6/9=3) (10=4) , gen(industrycat4)
*</_industrycat4_>
...
gen   industrycat10_2 = .
notes industrycat10_2: LSS-IV does not collect information on sector of employment (industry) in the last 7 days
*</_industrycat10_2_>
...
gen wage_nc_year = wage_base_p if (lstatus==1 & empstat<=4)
...
gen wage_nc_2_year =  wage_base_np if (lstatus==1 & empstat<=4)
...
egen    wage_total_year = rsum(isalp_m isalp_nm isep_m isep_nm iempp_m iempp_nm iolp_m iolp_nm), missing
...
egen    wage_total_2_year = rsum(isalnp_m isalnp_nm isenp_m isenp_nm iempnp_m iempnp_nm iolnp_m iolnp_nm), missing
