/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   		NPL_2022_LSS-IV_v03_M.do				   </_Program name_>
...
<_Version Control_>
Date:					19-03-2024
File:					NPL_2022-2023_LSS-IV_v03_M.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*******************************************************************
	...
	*Los que se definen solo para el jefe de hogar porque es una a nivel de todo el hogar
		foreach var of varlist food_inkind inc_renting_assets inc_renting_housing nonfood_own travel_inkind inc_remit_absent* inc_other* {
