/*------------------------------------------------------------------------------
  GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	NPL_2022_LSS-IV_v03_M_v01_A_SARMD_IND.do	   </_Program name_>
...
<_Version Control_>
Date:				08-2024
File:				NPL_2022_LSS-IV_v03_M_v01_A_SARMD_IND.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
gen hhid_orig = "psu_number hh_number"
*</_idh_orig_>
...
*<_pid_orig_>
*<_pid_orig_note_> Personal identifier variables in the raw data depends on the module *</_idp_org_note_>
gen pid_orig = "psu_number hh_number s01_idc"
notes pid_orig: Personal identifier variables in the raw data depends on the module
*</_pid_orig_>
...
*<_water_original_>
*<_water_original__note_> Source of Drinking Water-Original from raw file *</_water_orig_note_>
/*<_water_originalnote_> Original categories from source of drinking water *</_water_orig_note_>*/
*<_water_original_note_>  *</_water_orig_note_>
gen 	water_original = "."
replace water_original = " 1 - PIPED WATER (WITHIN COMPOUND)"					if  q02_19==1
replace water_original = " 2 - PIPED WATER (OUTSIDE COMPOUND)"					if  q02_19==2
replace water_original = " 3 - TUBEWELL / HAND PUMP"							if  q02_19==3
replace water_original = " 4 - COVERED WELL"									if  q02_19==4
replace water_original = " 5 - OPEN WELL"										if  q02_19==5
replace water_original = " 6 - SPRING WATER"									if  q02_19==6
replace water_original = " 7 - RIVER / RIVULET"									if  q02_19==7
replace water_original = " 8 - JAR / BOTTLED WATER"								if  q02_19==8
replace water_original = " 9 - OTHER SOURCE"									if  q02_19==9
...
gen  	imp_wat_rec = .
replace imp_wat_rec = 1	if (water_jmp>=1 & water_jmp<=6)
replace imp_wat_rec = 0	if (water_jmp>=12 & water_jmp<=14)
*<_imp_wat_rec_>
...
replace sanitation_original = " 1 - FLUSH (CONNECTED TO MUNICIPAL SEWER)"	if  q02_27==1
replace sanitation_original = " 2 - FLUSH (CONNECTED TO SEPTIC TANK)"		if  q02_27==2
replace sanitation_original = " 3 - NON-FLUSH / SIMPLE LATRINE"				if  q02_27==3
replace sanitation_original = " 4 - PUBLIC TOILET"							if  q02_27==4
replace sanitation_original = " 5 - NO TOILET"								if  q02_27==5
*<_sanitation_original_>
...
*<_imp_san_rec_>
*<_imp_san_rec_note_> Improved type of sanitation facility-using country-specific definitions *</_imp_san_rec_note_>
/*<_imp_san_rec_note_> Dummy variable: 1=improved, 0=unimproved source following JMP guidelines *</_imp_san_rec_note_>*/
*<_imp_san_rec_note_>  1 "Yes" 0 "No" *</_imp_san_rec_note_>
gen 	imp_san_rec = .
replace imp_san_rec = 1	if (toilet_jmp>=1 & toilet_jmp<=2)
replace imp_san_rec = 0	if  toilet_jmp==13 | toilet_jmp==12 | toilet_jmp==7 
...
*<_landphone_>
*<_landphone__note_> Household has landphone *</_lphone_note_>
/*<_landphone__note_> Availability of landphones in household. Question on quantity or specific availability should be present *</_lphone_note_>*/
*<_landphone__note_>  1 "Yes" 0 "No" *</_lphone_note_>
gen 	landphone = .
replace landphone = 0			if  q02_31_a1==2
replace landphone = 1			if  q02_31_a1==1
*</_landphone_>
...
replace internet = 4			if  q02_31_c1==2
*</_internet_>
...
*<_school_note_>  1 "Yes" 0 "No" *</_atschool_note_>
gen 	school = .
replace school = 0		if  q07_04==1 | q07_04==2 
replace school = 1		if  q07_04==3
*</_school_>
...
replace inter_edlevel = 0 if inter_edlevel == 16 | inter_edlevel==17
gen byte educy= inter_edlevel
replace educy = 0 if educy == -1
replace educy = 17 if inlist(educy, 14, 15)
replace educy = 15 if educy == 13
...
gen byte educat7 = .
replace educat7 = 2 if inrange(inter_edlevel, 1, 4)
replace educat7 = 3 if inrange(inter_edlevel, 5, 7)
replace educat7 = 4 if inrange(inter_edlevel, 8, 11)
replace educat7 = 5 if inter_edlevel == 12
replace educat7 = 7 if inrange(inter_edlevel, 13, 15)
replace educat7 = 1 if inlist(inter_edlevel, -1, 0)
*</_educat7_>
...
foreach v of varlist educat7 educat5 educat4 educy school literacy everattend { 
...
*<minlaborage>
*<_minlaborage_note_> Labor module application age *</_lb_mod_age_note_>
/*<_minlaborage_note_> Age at which the labor module starts being applied (working age: people at which can start legally working) *</_lb_mod_age_note_>*/
*<_minlaborage_note_>  *</_lb_mod_age_note_>
gen   minlaborage = 10
*</_lb_mod_age_>
...
gen 	industrycat10 = .
replace industrycat10 = 1 if q09_14_a>=111 & q09_14_a<=322
replace industrycat10 = 2 if q09_14_a>=510 & q09_14_a<=990
replace industrycat10 = 3 if q09_14_a>=1010 & q09_14_a<=3320
replace industrycat10 = 4 if q09_14_a>=3510 & q09_14_a<=3900
replace industrycat10 = 5 if q09_14_a>=4100 & q09_14_a<=4390
replace industrycat10 = 6 if (q09_14_a>=4510 & q09_14_a<=4799) | (q09_14_a>=5510 & q09_14_a<=5630)
replace industrycat10 = 7 if q09_14_a>=4911 & q09_14_a<=5320 | (q09_14_a>=5811 & q09_14_a<=6399)
replace industrycat10 = 8 if q09_14_a>=6411 & q09_14_a<=8299
replace industrycat10 = 9 if q09_14_a>=8411 & q09_14_a<=8430
replace industrycat10 = 10 if (q09_14_a>=8510 & q09_14_a!=.)
...
*<_industry_orig_year_note_>   *</_industry_orig_year_note_>
gen  str4 industry_orig_year = ""
notes   industry_orig_year: LSS-IV does not collect information on sector of employment (industry) in the last 12 months

*</_industry_orig_year_>

*<industrycat10_year>
*<_industrycat10_year_note_> 1 digit industry classification - main job - last 12 months *</_industry_year_note_>
/*<_industrycat10_year_note_> Variable is constructed for all persons administered this module in each questionnaire. For this reason the lower age cutoff (and perhaps upper age cutoff) at which information is collected will vary from country to country. Classifies the main job of any individual with a job (lstatus=1) and is missing otherwise. The codes for the main job are given here based on the UN-ISIC (Rev. 3.1). The main categories subsume the following codes: 1 = Agriculture, Hunting, Fishing and Forestry 2 = Mining 3 = Manufacturing 4 = Electricity and Utilities 5 = Construction 6 = Commerce 7 = Transportation, Storage and Communication 8 = Financial, Insurance and Real Estate 9 = Public Administration 10 = Other Services. In the case of different classifications, recoding has been done to best match the ISIC-31 codes. Code 10 is also assigned for unspecified categories or items. *</_industry_year_note_>*/
*<_industrycat10_year_note_>  *</_industry_year_note_>
gen 	industrycat10_year = .
notes   industrycat10_year: LSS-IV does not collect information on sector of employment (industry) in the last 12 months
...
gen  str4 industry_orig_2 = ""
notes   industry_orig_2: LSS-IV does not collect information on sector of employment (industry) in the last 12 months
*</_industry_orig_2_>

*<_industrycat10_2_>
*<_industrycat10_2_note_>  1 digit industry classification - second job - last 7 days *</_industry_2_note_>
/*<_industrycat10_2_note_> Variable is constructed for all persons administered this module in each questionnaire. For this reason the lower age cutoff (and perhaps upper age cutoff) at which information is collected will vary from country to country.
Classifies the seco *</_industry_2_note_>*/
*<_industrycat10_2_note_>  *</_industrycat10_2_note_>
gen 	industrycat10_2 = .
notes   industrycat10_2: LSS-IV does not collect information on sector of employment (industry) in the second job
*</_industry_2_>
...
gen  str4 industry_orig_2_year = ""
notes   industry_orig_2_year: LSS-IV does not collect information on sector of employment (industry) in the second job
*</_industry_orig_2_year_>

*<_industrycat10_2_year_year_>
*<_industrycat10_2_year_note_>  1 digit industry classification - second job - last 12 months *</_industry_2_year_note_>
/*<_industrycat10_2_year_note_> Variable is constructed for all persons administered this module in each questionnaire. For this reason the lower age cutoff (and perhaps upper age cutoff) at which information is collected will vary from country to country.
Classifies the seco *</_industry_2_year_note_>*/
*<_industrycat10_2_year_note_>  *</_industrycat10_2_year_note_>
gen 	industrycat10_2_year = .
notes   industrycat10_2_year: LSS-IV does not collect information on sector of employment (industry) in the second job
*</_industry_2_year_>
...
*<_occup_2_>
*<_occup_2_note_> 1 digit occupational classification - second job - last 7 days *</_occup_2_note_>
...
gen   unitwage = 5 if lstatus == 1 & inrange(empstat,1,4)
*</_unitwage_>
...
*<tv>
*<_tv_note_> Household has television *</_television_note_>
/*<_tv_note_> Availability of televisions in household. Question on quantity or specific availability should be present *</_television_note_>*/
*<_tv_note_>  1 "Yes" 0 "No" *</_tv_note_>
gen 	tv = 0			if  own_512==2
replace tv = 1  		if  own_512==1 
*</tv>
...
*<_sewmach_>
*<_sewmach_note_> Household has sewing machine *</_sewmach_note_>
/*<_sewmach_note_> Availability of sewing machines  in household. Question on quantity or specific availability should be present *</_sewingmachine_note_>*/
*<_sewmach_note_>  1 "Yes" 0 "No" *</_sewingmachine_note_>
gen 	sewmach = 0   if  own_520==2
replace sewmach = 1   if  own_520==1 
*<_sewmach_>

*<_washmach_>
*<_washmach_note_> Household has washing machine *</_washingmachine_note_>
/*<_washmach_note_> Availability of washing machines in household. Question on quantity or specific availability should be present *</_washingmachine_note_>*/
*<_washmach_note_>  1 "Yes" 0 "No" *</_washingmachine_note_>
gen 	washmach = 0	if  own_509==2
replace washmach = 1  	if  own_509==1 
*<_washmach_>

*<_fridge_>
*<_fridge__note_> Household has refrigerator *</_refrigerator_note_>
/*<_fridge__note_> Availability of refrigerator  in household. Question on quantity or specific availability should be present *</_refrigerator_note_>*/
*<_refrigerator_note_>  1 "Yes" 0 "No" *</_refrigerator_note_>
gen 	fridge = 0		if  own_506==2
replace fridge = 1  	if  own_506==1  
notes fridge: the raw variable refers to "Refrigerator or Freezer"
*</_fridge_>
...
*<_bcycle_>
*<_bcycle_note_> Household has bicycle *</_bicycle_note_>
/*<_bcycle_note_> Availability of bicycle in household. Question on quantity or specific availability should be present *</_bicycle_note_>*/
*<_bcycle_note_>  1 "Yes" 0 "No" *</_bicycle_note_>
gen 	bcycle = 0			if  own_503 == 2
replace bcycle = 1  		if  own_503 == 1
*<_bcycle_>

*<_mcycle_>
*<_mcycle_note_> Household has motorcycle *</_motorcycle_note_>
/*<_mcycle_note_> Availability of motor cycles (bikes) in household. Question on quantity or specific availability should be present *</_motorcycle_note_>*/
*<_mcycle_note_>  1 "Yes" 0 "No" *</_motorcycle_note_>
gen 	mcycle = 0			if  own_504 == 2
replace mcycle = 1  		if  own_504 == 1 
notes mcycle: the raw variable refers to "Motorcycle/Scooter"
*<_mcycle_>

*<_car_>
*<_car_note_> Household has motorcar *</_motorcar_note_>
/*<_car_note_> Availability of motorcars in household. Question on quantity or specific availability should be present *</_motorcar_note_>*/
*<_car_note_>  1 "Yes" 0 "No" *</_motorcar_note_>
gen 	car = 0		if  own_505 == 2
replace car = 1  	if  own_505 == 1 
notes car: the raw variable refers to "Motor car, jeep, van, etc."
*</_car_>
...
gen str4 occup_orig = ""
replace occup_orig = string(q09_09_a, "%04.0f") if lstatus == 1
