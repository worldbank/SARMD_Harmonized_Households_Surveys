/*------------------------------------------------------------------------------
  GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	NPL_2022_LSS-IV_v03_M_v01_A_SARMD_LBR.do	   </_Program name_>
...
<_Version Control_>
Date:				08-2024
File:				NPL_2022_LSS-IV_v03_M_v01_A_SARMD_LBR.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
gen minlaborage_year = minlaborage
*</_minlaborage_year_>
...
egen  auxi = rsum(isalp_m isalp_nm isep_m isep_nm iempp_m iempp_nm iolp_m iolp_nm), missing
gen   lstatus_year = 1		if  auxi!=0 & auxi!=.
notes lstatus: the LSS-IV only allows to identify those who were employed at some point in the last 12 months
drop auxi 
*</_lstatus_year_>
...
gen   nlfreason_year = .
notes nlfreason_year: the LSS-IV does not contain the information needed to define this variable
*</_nlfreason_year_>
...
notes unempldur_l_year: the LSS-IV does not contain the information needed to define this variable
*</_unempldur_l_year_>
...
notes unempldur_u_year: the LSS-IV does not contain the information needed to define this variable
*</_unempldur_u_year_>
...
gen   ocusec_2 = .
notes ocusec_2: the LSS-IV does not contain the information needed to define this variable
*</_ocusec_2_>
...
gen   industrycat4_2 = .
notes industrycat4_2: LSS-IV does not collect information on sector of employment (industry) in the last 7 days
*</_industrycat4_2_>
...
notes industrycat4_year: LSS-IV does not collect this information 
...
notes industrycat4_2_year: LSS-IV does not collect this information 
*</_industrycat4_2_year_>
...
gen str4 occup_orig_year = "."
notes occup_orig_year: LSS-IV does not collect this information 
*</_occup_orig_year_>
...
gen     occup_2_year = .
notes occup_2_year: LSS-IV does not collect this information 
*</_occup_2_year_>
...
notes occup_orig_2: LSS-IV does not collect information on occupational status for the main job in the last 7 days
*</_occup_orig_2_>
...
notes occup_orig_2_year: LSS-IV does not collect information on occupational status for the main job in the last 7 days
*</_occup_orig_2_year_>
...
gen wage_nc = .
notes wage_nc: LSS-IV does not collect this information in the last 7 days
*</_wage_nc_>
...
gen   wage_nc_2 = .
notes wage_nc_2: LSS-IV does not collect this information in the last 7 days
*</_wage_nc_2_>
...
gen aux = wage_base_p*12
gen wage_nc_year = aux if (lstatus==1 & empstat<=4)
notes wage_nc_year: LSS-IV only collects this information for wage employers paid on a longer basis 
replace wage_nc_year = . if lstatus_year!=1 | empstat_year!=1
drop aux*
*</_wage_nc_year_>
...
gen aux = wage_base_np*12
gen wage_nc_2_year =  aux if (lstatus==1 & empstat<=4)
notes wage_nc_2_year: LSS-IV only collects this information for wage employers paid on a longer basis 
replace wage_nc_2_year = . if lstatus_year!=1 | empstat_year!=1
drop aux*
*</_wage_nc_2_year_>
...
gen  unitwage_year = 8
note unitwage_year: LSS-IV only collects this information (salary excluding bonus, etc) for wage employers paid on a longer basis in the last 12 months
*</_unitwage_year_>
...
gen  unitwage_2_year = 8
note unitwage_2_year: LSS-IV only collects this information (salary excluding bonus, etc) for wage employers paid on a longer basis in the last 12 months
*</_unitwage_2_year_>
...
gen   whours_2 = .
notes whours_2: LSS-IV does not collect this information 
*</_whours_2_>
...
gen whours_year = .
notes whours_year: LSS-IV does not collect this information 
*</_whours_year_>
...
gen whours_2_year = .
notes whours_2_year: LSS-IV does not collect this information 
*</_whours_2_year_>
...
gen   wmonths = .
notes wmonths: LSS-IV does not collect this information 
*</_wmonths_>
...
gen   wmonths_2 = .
notes wmonths_2: LSS-IV does not collect this information 
*</_wmonths_2_>
...
gen wmonths_year = .
notes wmonths_year: LSS-IV does not collect this information 
*</_wmonths_year_>
...
gen wmonths_2_year = .
notes wmonths_2_year: LSS-IV does not collect this information 
*</_wmonths_2_year_>
...
gen   wage_total = .
notes wage_total:  LSS-IV does not collect information on labor income for the main job in the last 7 days
*</_wage_total_>
...
gen   wage_total_2 = .
notes wage_total_2:  LSS-IV does not collect information on labor income for the secondary job in the last 7 days
*</_wage_total_2_>
...
egen    wage_total_year = rsum(isalp_m isalp_nm), missing
replace wage_total_year = . if lstatus_year!=1 | empstat_year!=1
*</_wage_total_year_>
...
egen    wage_total_2_year = rsum(isalnp_m isalnp_nm), missing
notes wage_total_2_year:  wage_total_2_year refers to annualized total wage for non-principal job (secondary, tertiary, and others)
*</_wage_total_2_year_>
...
gen   contract_year = .
notes contract_year: the LSS-IV does not collect information on labour contract for the main job in the last 12 months
*</_contract_year_>
...
gen   healthins_year = .
notes healthins_year: the LSS-IV does not collect information on health insurance from employment for the main job in the last 12 months
*</_healthins_year_>
...
gen   socialsec_year = .
notes socialsec_year: the LSS-IV does not collect information on social security rights from employment for the main job in the last 12 months
*</_socialsec_year_>
...
gen   union_year = .
notes union_year: the LSS-IV does not collect information on union membership for the main job in the last 12 months
*</_union_year_>
...
gen   firmsize_l_year = .
notes firmsize_l_year: the LSS-IV does not collect information on firm size
*</_firmsize_l_year_>
...
gen   firmsize_u_year = .
notes firmsize_u_year: the LSS-IV does not collect information on firm size
*</_firmsize_u_year_>
...
gen   firmsize_l_2 = .
notes firmsize_l_2: the LSS-IV does not collect information on firm size
*</_firmsize_l_2_>
...
gen   firmsize_u_2 = .
notes firmsize_u_2: the LSS-IV does not collect information on firm size
*</_firmsize_u_2_>
...
notes firmsize_l_2_year: the LSS-IV does not collect information on firm size
*</_firmsize_l_2_year_>
...
notes firmsize_u_2_year: the LSS-IV does not collect information on firm size
*</_firmsize_u_2_year_>
...
notes t_wage_nc_others: the LSS-IV does not include the information needed to define this variable
*</_t_wage_nc_others_>
...
gen   t_hours_others = .
notes t_hours_others: the LSS-IV does not include the information needed to define this variable
*</_t_hours_others_>
...
gen   t_wage_others = .
notes t_wage_others: the LSS-IV does not include the information needed to define this variable
*</_t_wage_others_>
...
gen   t_hours_total = .
notes t_hours_total: the LSS-IV does not include the information needed to define this variable
*</_t_hours_total_>
...
gen   t_wage_nc_total = .
notes t_wage_nc_total: the LSS-IV does not include the information needed to define this variable
*</_t_wage_nc_total_>
...
gen   t_wage_total = .
notes t_wage_total: the LSS-IV does not include the information needed to define this variable
*</_t_wage_total_>
...
notes t_hours_others_year: the LSS-IV does not include the information needed to define this variable
*</_t_hours_others_year_>
...
notes t_wage_nc_others_year: the LSS-IV does not include the information needed to define this variable
*</_t_wage_nc_others_year_>
...
notes t_wage_others_year: the LSS-IV does not include the information needed to define this variable
*</_t_wage_others_year_>
...
notes t_hours_total_year: the LSS-IV does not include the information needed to define this variable
*</_t_hours_total_year_>
...
gen aux_wage_nc_1_year = wage_nc_year
gen aux_wage_nc_2_year = wage_nc_2_year
egen t_wage_nc_total_year = rsum(aux_wage_nc_1_year aux_wage_nc_2_year t_wage_nc_others_year), missing
notes t_wage_nc_total_year: LSS-IV only collects this information (salary excluding bonus, etc) for wage employers paid on a longer basis 
drop aux_wage*
*</_t_wage_nc_total_year_>
...
gen t_hours_annual = .
notes t_hours_annual: the LSS-IV does not include the information needed to define this variable
*</_t_hours_annual_>
...
notes linc_nc: LSS-IV only collects this information (salary excluding bonus, etc) for wage employers paid on a longer basis 
*</_linc_nc_>
...
egen    auxp = rsum(isalp_m isalp_nm isep_m isep_nm iempp_m iempp_nm iolp_m iolp_nm), missing
egen    auxnp = rsum(isalnp_m isalnp_nm isenp_m isenp_nm iempnp_m iempnp_nm iolnp_m iolnp_nm), missing
egen    laborincome = rsum(auxp auxnp), missing
