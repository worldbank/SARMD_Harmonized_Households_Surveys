/*------------------------------------------------------------------------------
  GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	NPL_2022_LSS-IV_v03_M_v01_A_SARMD_INC.do	   </_Program name_>
...
<_Version Control_>
Date:				08-2024
File:				NPL_2022_LSS-IV_v03_M_v01_A_SARMD_INC.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*<hsize>
*<_hsize_note_> Number of members of the household *</_hsize_note_>
cap drop hogarsec
gen     hogarsec = 0		if  q01_04!=.
replace hogarsec = 1		if  q01_04==12
tempvar uno
gen `uno' = 1
egen hsize = sum(`uno')	if  hogarsec==0, by(hhid)
*<hsize>

*<_Save data file_>
do   "$rootdofiles\_aux\new\SecondOrder_INC.do"
