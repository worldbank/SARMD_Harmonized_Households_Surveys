...
*******************************************************************************
    ...
    loc GMD_ALL age  agecat  school  bcycle  cellphone  chicken  code  computer  converfactor  countrycode  countryname  ed_mod_age  educat4  educat5  educat7  educy  electricity  empstat  everattend  fan  gaul_adm1_code  gaul_adm2_code gaul_adm3_code harmonization hhid  hsize  imp_san_rec  imp_wat_rec  industry_orig  industrycat10  industrycat10  industrycat4  int_month  landphone  minlaborage  literacy  lstatus  male  marital  car  mcycle  njobs  nlfreason  occup_orig  occup  ocusec  ownhouse  pid  piped_water  primarycomp  psu  radio  fridge  relationcs  relationharm  school  sector  sewmach  soc  spdef  strata  subnatid1  subnatid2  subnatid3  survey  tv  tenure  sanitation_orig  sanitation_source toilet_acc  unitwage  urban  wage  washmach  water_jmp  water_original  water_source watertype_quest pipedwater_acc wei* pop*  welfare  welfaretype welfaredef  welfarenom  welfareother  welfareothertype  welfshprosperity  welfshprtype year
...
*******************************************************************************
	...
	cap lab var gaul_adm3_code "GAUL code for admin3 level"
    cap lab var harmonization "Type of harmonization"
	...
	cap lab var weight "Household sampling weight" 
...
* Section 5: Clean up
*******************************************************************************
keep age  agecat  school  bcycle  cellphone  chicken  code  computer  converfactor  countrycode  countryname cpi*  ed_mod_age  educat4  educat5  educat7  educy  electricity  empstat  everattend  fan  gaul_adm1_code  gaul_adm2_code gaul_adm3_code harmonization  hhid  hsize  imp_san_rec  imp_wat_rec  industry_orig  industrycat10  industrycat10  industrycat4  int_month  landphone  minlaborage  literacy  lstatus  male  marital  car  mcycle  njobs  nlfreason  occup_orig  occup  ocusec  ownhouse  pid  piped_water ppp* primarycomp  psu  radio  fridge  relationcs  relationharm  school  sector  sewmach  soc  spdef  strata  subnatid1  subnatid2  subnatid3  survey  tv  tenure  sanitation_orig  unitwage  urban  wage  washmach  water_jmp  water_original water_source watertype_quest sanitation_source toilet_acc pipedwater_acc wei* pop*  welfare  welfaretype welfaredef  welfarenom  welfareother  welfareothertype  welfshprosperity  welfshprtype year hhid pid
