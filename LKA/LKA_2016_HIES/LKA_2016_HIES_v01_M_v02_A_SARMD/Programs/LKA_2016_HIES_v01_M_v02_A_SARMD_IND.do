...
** DIRECTORY
	...
	*/
	...
	glo input     "$rootdatalibweb\SAR_DATABANK\LKA\LKA_2016_HIES\LKA_2016_HIES_v01_M"
	glo output    "$rootdatalibweb\SAR_DATABANK\LKA\LKA_2016_HIES\LKA_2016_HIES_v01_M_v02_A_SARMD"
...
** LOG FILE
	log using "$output\Doc\Technical\LKA_2016_HIES_v01_M_v02_A_SARMD.log",replace
...
*****************************************************************************************************/
	...
	** USE SARMD CPI AND PPP
		...
		*keepusing(countrycode year urb syear cpi${year}_w ppp${year})
		...
		use "$pricedata", clear 
		tempfile pricedata 
		keep if countrycode=="LKA" & year==2016
		local year=2011
...
** DELETE MISSING VARIABLES
	...
	saveold "${output}\Data\Harmonized\LKA_2016_HIES_v01_M_v02_A_SARMD_ALL.dta", replace version(13)
	*saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\LKA_2016_HIES_v01_M_v02_A_SARMD_IND.dta", replace version(13)
...
saveold "$output\Data\Harmonized\LKA_2016_HIES_v01_M_v02_A_SARMD_IND.dta", replace version(12)
*saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\LKA_2016_HIES_v01_M_v02_A_SARMD_IND.dta", replace version(12)
