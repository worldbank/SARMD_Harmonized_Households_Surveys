/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   LKA_2016_HIES_v01_M_v01_A_GMD_UTL.do	</_Program name_>
...
<_Version Control_>
Date:	03-03-2019
File:	LKA_2016_HIES_v01_M_v01_A_GMD_UTL.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*<_Raw data_>;
tempfile raw1
datalibweb, country(LKA) year(2016) type(SARRAW) surveyid(LKA_2016_HIES_v01_M) filename(sec_4_2_non_food_consumption_and_expenditure.dta)
keep district sector month psu snumber hhno nf_code nf_value
keep if inlist(nf_code,2503,2412,3505,2101,2411,2505,2103,2502,2106,2504,2413,2414,2711,2104,2003)
reshape wide nf_value, i(district sector month psu snumber hhno) j(nf_code)
save `raw1'
...
local filename     "LKA_2016_HIES_v01_M_v01_A_GMD_UTL";
*</_Program setup_>;
...
gen cellphone_exp= 12*nf_value2503;
...
gen cooksource= cooking_fuel;
recode cooksource (2=5) (3=2) (5=9);
*</_cooksource_>;
...
gen diesel_exp = 12*nf_value2412;
...
gen dwelsvc_exp= nf_value3505;
notes dwelsvc_exp: Survey originally collects annualized estimate, which is presented here;
*</_dwelsvc_exp_>;
...
gen lightsource= lite_source;
recode lightsource (1=2) (2=1) (5=4) (3 4 = 9);
*</_lightsource_>;
...
gen gasoline_exp = 12*nf_value2411;
...
gen internet_exp=12*nf_value2505;
...
gen kerosene_exp= nf_value2103*12;
...
gen landphone_exp= 12*nf_value2502;
...
egen transfuel_exp= rowtotal(nf_value2411-nf_value2414), missing;
replace transfuel_exp = 12*transfuel_exp;
...
gen w_30m= .;
replace w_30m = 1 if own_water == 1 | water_distance < 1000;
replace w_30m = 0 if w_30m == . & (own_water != . | water_distance != .);
notes w_30m: originally collected in metres, created based on the assumption that a round trip distance of 1000 metres can be made within 30 min;
*</_w_30m_>;
...
gen waste= garbage_dumping;
recode waste (2=6) (4=9) (3 5 9=10);
notes waste: Other (10) also includes garbage dumped within or outside premises;
*</_waste_>;
