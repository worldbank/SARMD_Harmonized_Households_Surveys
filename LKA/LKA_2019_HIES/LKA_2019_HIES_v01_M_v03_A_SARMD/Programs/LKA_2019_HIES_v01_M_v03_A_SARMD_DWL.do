/*------------------------------------------------------------------------------
  GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	LKA_2019_HIES_v01_M_v03_A_SARMD_DWL.do	   </_Program name_>
...
<_Version Control_>
Date:				10-2024
File:				LKA_2019_HIES_v01_M_v03_A_SARMD_DWL.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
gen landphone = (telephone==1) if inlist(telephone,1,2)
*</_landphone_>
...
gen video = (vcd==1 | camera==1) if inlist(vcd,1,2) | inlist(camera,1,2)
