...
*******************************************************************************
	...
	* Define value labels
        ...
        cap lab def piped_label_label 1 "Yes"  0 "No", replace
        ...
        cap lab def contract_year_label 0 "No"  1 "Yes", replace
...
/*
	if ("${module}"=="GEO" | "${module}"=="DWL" | "${module}"=="UTL") & (countrycode!="MDV" & year!=2016) {
