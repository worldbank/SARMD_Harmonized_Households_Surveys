/*------------------------------------------------------------------------------
  GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   	LKA_2019_HIES_v02_M_v01_A_SARMD_LBR.do	   </_Program name_>
<_Application_>    	STATA 17.0									 <_Application_>
<_Author(s)_>      	Leo Tornarolli <tornarolli@gmail.com>		  </_Author(s)_>
<_Date created_>   	12-2023									   </_Date created_>
<_Date modified>    December 2023							  </_Date modified_>
--------------------------------------------------------------------------------
...
<_Version Control_>
Date:				12-2023
File:				LKA_2019_HIES_v02_M_v01_A_SARMD_LBR.do
First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
gen   lstatus_year = .
notes lstatus_year: the HIES does not contain the information needed to define this variable 
*</_lstatus_year_>
...
gen   ocusec_2_year = .
notes ocusec_2_year: the HIES does not contain the information needed to define this variable
*</_ocusec_2_year_>
...
gen   	industrycat4 = 1		if  industrycat10==1
replace industrycat4 = 2		if  industrycat10>=2 & industrycat10<=5
replace industrycat4 = 3		if  industrycat10>=6 & industrycat10<=9
...
gen   industrycat10_2 = .
notes industrycat10_2: the HIES does not contain the information needed to define this variable
*</_industrycat10_2_>
...
gen   industrycat4_2 = .
notes industrycat4_2: the HIES does not contain the information needed to define this variable
*</_industrycat4_2_>
...
notes industrycat10_year: the HIES does not contain the information needed to define this variable
*</_industrycat10_year_>
...
gen  occup_orig_year = .
note occup_orig_year: the HIES does not contain the information needed to define this variable
*</_occup_orig_year_>
...
gen   occup_2_year = .
notes occup_2_year: the HIES does not contain the information needed to define this variable
*</_occup_2_year_>
...
notes occup_orig_2_year: the HIES does not contain the information needed to define this variable
*</_occup_orig_2_year_>
...
egen wage_nc = rsum(employment_income1 agricultural_1 non_agricultural_1), missing
*</_wage_nc_>
...
egen  wage_nc_2 = rsum(employment_income2 agricultural_2 non_agricultural_2), missing
*</_wage_nc_2_>
...
gen   wage_nc_year = .
notes wage_nc_year: the HIES does not contain the information needed to define this variable
*</_wage_nc_year_>
...
gen   wage_nc_2_year = .
notes wage_nc_2_year: the HIES does not contain the information needed to define this variable
*</_wage_nc_2_year_>
...
gen  unitwage_year = .
note unitwage_year: the HIES does not contain the information needed to define this variable
*</_unitwage_year_>
...
gen  unitwage_2_year = .
note unitwage_2_year: the HIES does not contain the information needed to define this variable
*</_unitwage_2_year_>
...
gen   whours_2 = .
notes whours_2: the HIES does not contain the information needed to define this variable
*</_whours_2_>
...
gen   whours_year = .
notes whours_year: the HIES does not contain the information needed to define this variable
*</_whours_year_>
...
gen   whours_2_year = .
notes whours_2_year: the HIES does not contain the information needed to define this variable
*</_whours_2_year_>
...
gen   wmonths_year = .
notes wmonths_year: the HIES does not contain the information needed to define this variable
*</_wmonths_year_>
...
gen   wmonths_2_year = .
notes wmonths_2_year: the HIES does not contain the information needed to define this variable
*</_wmonths_2_year_>
...
gen   wage_total = .
notes wage_total: the HIES does not collect information on the number of months worked during the year
*</_wage_total_>
...
gen   wage_total_2 = .
notes wage_total_2: the HIES does not collect information on the number of months worked during the year
*</_wage_total_2_>
...
gen   wage_total_year = .
notes wage_total_year: the HIES does not contain the information needed to define this variable
*</_wage_total_year_>
...
notes wage_total_2_year: the HIES does not contain the information needed to define this variable
*</_wage_total_2_year_>
...
gen   contract_year = .
notes contract_year: the HIES does not contain the information needed to define this variable
*</_contract_year_>
...
gen   healthins_year = .
notes healthins_year: the HIES does not contain the information needed to define this variable
*</_healthins_year_>
...
gen   socialsec_year = .
notes socialsec_year: the HIES does not contain the information needed to define this variable
*</_socialsec_year_>
...
gen   union_year = .
notes union_year: the HIES does not contain the information needed to define this variable
*</_union_year_>
...
gen   firmsize_l_year = .
notes firmsize_l_year: the HIES does not contain the information needed to define this variable
*</_firmsize_l_year_>
...
gen   firmsize_u_year = .
notes firmsize_u_year: the HIES does not contain the information needed to define this variable
*</_firmsize_u_year_>
...
gen   firmsize_l_2 = .
notes firmsize_l_2: the HIES does not contain the information needed to define this variable
*</_firmsize_l_2_>
...
gen   firmsize_u_2 = .
notes firmsize_u_2: the HIES does not contain the information needed to define this variable
*</_firmsize_u_2_>
...
notes firmsize_l_2_year: the HIES does not contain the information needed to define this variable
*</_firmsize_l_2_year_>
...
notes firmsize_u_2_year: the HIES does not contain the information needed to define this variable
*</_firmsize_u_2_year_>
...
egen    t_wage_nc_total = rsum(employment_income1 employment_income2 agricultural_1 agricultural_2 non_agricultural_1 non_agricultural_2), missing
replace t_wage_nc_total = t_wage_nc_total*12
*</_t_wage_nc_total_>
...
gen   	t_wage_total = t_wage_nc_total
*</_t_wage_total_>
...
notes t_hours_others_year: the HIES does not include the information needed to define this variable
*</_t_hours_others_year_>
...
notes t_wage_nc_others_year: the HIES does not include the information needed to define this variable
*</_t_wage_nc_others_year_>
...
notes t_wage_others_year: the HIES does not include the information needed to define this variable
*</_t_wage_others_year_>
...
notes t_hours_total_year: the HIES does not include the information needed to define this variable
*</_t_hours_total_year_>
...
notes t_wage_nc_total_year: the HIES does not include the information needed to define this variable
*</_t_wage_nc_total_year_>
...
egen    linc_nc = rsum(employment_income1 employment_income2 agricultural_1 agricultural_2 non_agricultural_1 non_agricultural_2), missing
replace linc_nc = linc_nc*12
*</_linc_nc_>
...
egen    laborincome = rsum(employment_income1 employment_income2 agricultural_1 agricultural_2 non_agricultural_1 non_agricultural_2), missing
replace laborincome = laborincome*12
*</_laborincome_>
