...
** DIRECTORY
	...
	*/
	...
	glo input     "$rootdatalibweb\SAR_DATABANK\LKA\LKA_2012_HIES\LKA_2012_HIES_v01_M"
	glo output    "$rootdatalibweb\SAR_DATABANK\LKA\LKA_2012_HIES\LKA_2012_HIES_v01_M_v04_A_SARMD"
...
** LOG FILE
	log using "$output\Doc\Technical\LKA_2012_HIES_v01_M_v04_A_SARMD.log",replace
...
*<_cpi_>
	...
	*keepusing(countrycode year urb syear cpi`year'_w ppp`year')
	...
	use "$pricedata", clear 
	tempfile pricedata 
	keep if countrycode=="LKA" & year==2012
	local year=2011
...
** DELETE MISSING VARIABLES
	...
	keep countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt subnatid1 subnatid2 welfareother `keep' *type
	compress

	saveold "$output\Data\Harmonized\LKA_2012_HIES_v01_M_v04_A_SARMD_ALL.dta", replace version(12)
	*saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\LKA_2012_HIES_v01_M_v04_A_SARMD-FULL_IND.dta", replace version(12)
...
saveold "$output\Data\Harmonized\LKA_2012_HIES_v01_M_v04_A_SARMD_IND.dta", replace version(12)
*saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\LKA_2012_HIES_v01_M_v04_A_SARMD_IND.dta", replace version(12)
