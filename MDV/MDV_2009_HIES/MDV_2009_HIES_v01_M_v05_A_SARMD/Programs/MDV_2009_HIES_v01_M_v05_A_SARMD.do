...
*****************************************************************************************************/
	...
	* Household Info
	use "`input'\Data\Stata\Form8_hh.dta"
	sort formID
	ren formID hhid
	ren Q1 electricity_orig
	ren Q2 internet_orig
	tempfile form8_hh
	save `form8_hh'
	...
	* Demographics
	...
	merge m:1 hhid using `form8_hh'
	ren _merge merge_form8_hh
...
*<_electricity_>
	...
	replace electricity = 1 if electricity_orig == "1"
	replace electricity = 0 if electricity_orig == "2"
...
** INTERNET
	gen byte internet= .
	replace internet = 1 if internet_orig == "1"
	replace internet = 0 if internet_orig == "2"
