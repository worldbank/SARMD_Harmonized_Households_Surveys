/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   MDV_2016_HIES_v01_M_v01_A_GMD_LBR.do	</_Program name_>
<_Application_>    STATA 16.0	<_Application_>
<_Author(s)_>      Navishti Das and Javier Parada	</_Author(s)_>
<_Date created_>   03-03-2019	</_Date created_>
<_Date modified>   03-12-2020	</_Date modified_>
...
<_Version Control_>
Date:	03-05-2019
File:	MDV_2016_HIES_v01_M_v01_A_GMD_LBR.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
*<_Raw data_>
tempfile raw1
datalibweb, country(MDV) year(2016) type(SARRAW) surveyid(MDV_2016_HIES_v01_M) filename(F5.dta)
save `raw1'

tempfile raw2
datalibweb, country(MDV) year(2016) type(SARRAW) surveyid(MDV_2016_HIES_v01_M) filename(F6.dta)
merge 1:1 Form_ID Id using `raw1'
drop _merge
egen idp=concat(Form_ID Id), punct(-)
save `raw2'
*<_Raw data_>
...
*<_industry_orig_note_> industry_orig brought in from SARMD and  Q6011ISIC*</_industry_orig_note_>
*industry_orig
note industry_orig: Q6011ISIC
*</_industry_orig_>
...
gen wage_nc = .
replace wage_nc = Q617
replace wage_nc = Q6251Amount if Q617 == .
*</_wage_nc_>
...
tempvar wage_incl
gen `wage_incl' = .
replace `wage_incl' = Q617
replace `wage_incl' = Q25Total if Q617 == .

gen wage_total= `wage_incl'*wmonths
*</_wage_total_>
...
*<_ocusec_2_note_> Created from rawdata *</_ocusec_2_note_>
gen ocusec_2=.
replace ocusec_2 = 1 if inlist(Q628, 1, 2, 4, 5)  
replace ocusec_2 = 2 if inlist(Q628, 3, 6, 7, 9, 10)  
replace ocusec_2 = 3 if Q628 == 8  
*</_ocusec_2_>
...
*clonevar industry_orig_2 = Q6271ISIC 
note industry_orig_2: Q6271ISIC 
*</_industry_orig_2_>
...
clonevar occup_orig_2= Q631ISCO 
*</_occup_orig_2_>
...
gen wage_nc_2=.
replace wage_nc_2 = Q643
replace wage_nc_2 = Q6511Amount if Q643 == .
*</_wage_nc_2_>
...
tempvar wage_incl_2
gen `wage_incl_2' = .
replace `wage_incl_2' = Q643
replace `wage_incl_2' = Q651Total if Q643 == .

gen wage_total_2 = `wage_incl_2'*wmonths_2
*</_wage_total_2_>
...
gen t_hours_total = `t_hours_1' + `t_hours_2' +  t_hours_others
*</_t_hours_total_>
