/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   MDV_2016_HIES_v01_M_v01_A_GMD_COR.do	</_Program name_>
...
<_Study ID_>                    MDV_2016_HIES_v01_M </_Study ID_>
<_Data collection from (M/Y)_>  03-2016 </_Data collection from (M/Y)_>
<_Data collection to (M/Y)_>    11-2016 </_Data collection to (M/Y)_>
<_Source of dataset_>                   </_Source of dataset_>
<_Sample size (HH)_>            4,910  </_Sample size (HH)_>
<_Sample size (IND)_>           26,453  </_Sample size (IND)_>
<_Sampling method_>             Stratified two-stage </_Sampling method_>
<_Geographic coverage_>         National </_Geographic coverage_>
<_Geo_1_>                       Atoll  </_Geo_1_>
<_Geo_2_>                       Island   </_Geo_2_>
<_PSU variable_>                psu     </_PSU variable_>
<_Number of food items_>        216     </_Number of food items_>
<_Food recall period(s)_>       7 days </_Food recall period(s)_>
<_Number of non-food items_>    147    </_Number of non-food items_>
<_Non-food recall period(s)_>   30 days </_Non-food recall period(s)_>
<_Currency_>                    MVR </_Currency_>

--------------------------------------------------------------------------------
<_Version Control_>
Date:	03-03-2019
File:	MDV_2016_HIES_v01_M_v01_A_GMD_COR.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
local va           "01"
local type         "SARMD"
local yearfolder   "MDV_2016_HIES"
glo   module       "COR"
