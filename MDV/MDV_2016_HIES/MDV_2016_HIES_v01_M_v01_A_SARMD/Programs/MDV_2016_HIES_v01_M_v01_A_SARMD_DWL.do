...
*<_Raw data_>
datalibweb, country(MDV) year(2016) type(SARRAW) surveyid(MDV_2016_HIES_v01_M) filename(F2-Q30.dta)
tempfile assets
	keep Form_ID _Item _HaveAccess
	rename _HaveAccess access_
	recode access_ (1=1) (2 9=0)
	replace _Item = subinstr(_Item," ", "",.)
	replace _Item = subinstr(_Item,"/", "",.)
	reshape wide access_, i( Form_ID ) j(_Item ) string
	foreach var of varlist access_Aircondition-access_Waterpump{
...
tempfile raw
merge 1:1 Form_ID using `assets'
drop _merge
ren Form_ID idh
...
*<_internet_note_> internet brought in from  *</_internet_note_>
*gen internet =.
*</_internet_>
...
*<_video_note_> video brought in from *</_video_note_>
gen video=.
*</_video_>
...
*<_sewmach_note_> sewmach brought in from *</_sewmach_note_>
gen sewmach=.
*</_sewmach_>
...
gen washmach=access_Washingmachine
*</_washmach_>

*<_stove_>
*<_stove_note_> Ownership of a stove *</_stove_note_>
*<_stove_note_> stove brought in from *</_stove_note_>
gen stove=. 
*</_stove_>
...
gen ricecook = access_Ricecooker
*</_ricecook_>
...
gen boat= access_DhoniSpeedboat
*</_boat_>
...
gen kitchen= (kitchentype == 1) if !missing(kitchentype)
*</_kitchen_>

*<_bath_>
*<_bath_note_> Bathing facility in the dwelling *</_bath_note_>
*<_bath_note_> bath brought in from *</_bath_note_>
gen bath=.
*</_bath_>
...
egen rooms= rowtotal(bedrsleeping_number bedrnotsleeping_number sittingr_dinningr_number)
*</_rooms_>

*<_areaspace_>
*<_areaspace_note_> Area *</_areaspace_note_>
*<_areaspace_note_> areaspace brought in from SARMD *</_areaspace_note_>
gen areaspace= int(floorareaoccupied/10.764)
*</_areaspace_>
...
*<_acqui_house_note_> acqui_house brought in from *</_acqui_house_note_>
gen acqui_house=.
*</_acqui_house_>
...
*<_agriland_note_> agriland brought in from *</_agriland_note_>
gen agriland=.
*</_agriland_>

*<_area_agriland_>
*<_area_agriland_note_> Area of Agriculture land *</_area_agriland_note_>
*<_area_agriland_note_> area_agriland brought in from *</_area_agriland_note_>
gen area_agriland=.
*</_area_agriland_>

*<_ownagriland_>
*<_ownagriland_note_> Ownership of agriculture land *</_ownagriland_note_>
*<_ownagriland_note_> ownagriland brought in from *</_ownagriland_note_>
gen ownagriland=.
*</_ownagriland_>

*<_area_ownagriland_>
*<_area_ownagriland_note_> Area of agriculture land owned *</_area_ownagriland_note_>
*<_area_ownagriland_note_> area_ownagriland brought in from *</_area_ownagriland_note_>
...
*<_rentout_agriland_note_> rentout_agriland brought in from *</_rentout_agriland_note_>
...
*<_arearentout_agriland_note_> arearentout_agriland brought in from *</_arearentout_agriland_note_>
gen arearentout_agriland=.
*</_arearentout_agriland_>

*<_rentin_agriland_>
*<_rentin_agriland_note_> Rent in Land *</_rentin_agriland_note_>
*<_rentin_agriland_note_> rentin_agriland brought in from *</_rentin_agriland_note_>
gen rentin_agriland=.
*</_rentin_agriland_>

*<_arearentin_agriland_>
*<_arearentin_agriland_note_> Area of rent in agri land *</_arearentin_agriland_note_>
*<_arearentin_agriland_note_> arearentin_agriland brought in from *</_arearentin_agriland_note_>
...
*<_transagriland_note_> transagriland brought in from
*</_transagriland_note_>
gen transagriland=.
*</_transagriland_>
