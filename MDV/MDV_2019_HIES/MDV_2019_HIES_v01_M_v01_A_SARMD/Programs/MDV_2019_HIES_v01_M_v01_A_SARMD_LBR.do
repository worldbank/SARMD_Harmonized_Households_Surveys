/*------------------------------------------------------------------------------
					GMD Harmonization
--------------------------------------------------------------------------------
<_Program name_>   MDV_2019_HIES_v01_M_v01_A_GMD_LBR.do	</_Program name_>
...
<_Version Control_>
Date:	05-03-2020
File:	MDV_2019_HIES_v01_M_v01_A_GMD_LBR.do
- First version
</_Version Control_>
------------------------------------------------------------------------------*/
...
local filename     "MDV_2019_HIES_v01_M_v01_A_SARMD_LBR";
*</_Program setup_>;
...
gen wage_total=(tinmvr*primaryMonthsWorked);
...
gen whours_2=(primaryHrsPerDay22*5);
...
gen wage_total_2=(tinmvr2*primaryMonthsWorked22) if primaryMonthsWorked22!=-1;
