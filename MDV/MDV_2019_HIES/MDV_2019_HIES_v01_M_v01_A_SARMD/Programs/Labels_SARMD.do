...
*"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
	...
	loc IND "age atschool bicycle buffalo cellphone chicken code computer contract countrycode cow cpi* cpiperiod ed_mod_age educat4 educat5 educat7 educy electricity empstat empstat_2 empstat_2_year everattend fan finalweight firmsize_l food_share healthins hsize idh idh_org idp idp_org improved_sanitation improved_water industry industry_2 industry_orig industry_orig_2 int_month int_year internet lamp lb_mod_age literacy lphone lstatus male marital month motorcar motorcycle nfood_share njobs nlfreason occup ocusec ownhouse piped_water pline_int pline_nat poor_int poor_nat pop_wgt psu quintile_cons_aggregate radio rbirth rbirth_juris refrigerator relationcs relationharm rprevious rprevious_juris sar_improved_toilet sar_improved_water sewage_toilet sewingmachine soc socialsec spdef strata subnatid1 subnatid2 subnatid3 survey television toilet_jmp toilet_orig typehouse unempldur_l unempldur_u union unitwage unitwage_2 urban veralt vermast wage wage_2 washingmachine water_jmp water_orig welfare welfaredef welfarenat welfarenom welfareother welfareothertype welfaretype welfshprosperity wgt whours year yrmove"
...
*"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
	...
	cap la var empstat_2_year "Employment status - second job" 
	cap la var everattend "Ever attended school" 
	...
	cap la var occup "1 digit occupational classification" 
	...
	cap la var unitwage "Last wages time unit" 
...
*"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
	...
	* Define value labels
	...
	cap lab def water_jmp 1 1 "Piped into dwelling" 2 "Piped into compound, yard or plot" 3 "Public tap / standpipe" 4 "Tubewell, Borehole"  5 "Protected well" 6 "Unprotected well" 7 "Protected spring" 8 "Unprotected spring" 9 "Rain water" 10 "Tanker-truck or other vendor" 11 "Cart with small tank / drum" 12 "Surface water (river, stream, dam, lake, pond)" 13 "Bottled water"  14 "Other", replace
...
cap label define relationcs 1 "Head of the household" 2 "Wife / Husband" 3 "Son / Daughter" 4 "Parents of head of the household/ spouse" 5 "Other Relative" 6 "Domestic Servant/ Driver/ Watcher" 7 "Boarder" 9 "Other"

	local vars atschool  bicycle  buffalo  cellphone  chicken  computer  contract  cow  educat4  educat5  educat7  electricity  empstat  empstat_2  empstat_2_year  everattend  fan  healthins  improved_sanitation  improved_water  int_month  internet  lamp  literacy  lphone  lstatus  male  marital  motorcar  motorcycle  nlfreason  occup  ocusec  ownhouse  piped_water  quintile_cons_aggregate  radio  refrigerator  relationharm  sar_improved_toilet  sar_improved_water  sewage_toilet  sewingmachine  socialsec  television  toilet_jmp  typehouse  union  unitwage  unitwage_2  urban  washingmachine  water_jmp
...
*"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    sort hhid pid
	keep age atschool bicycle buffalo cellphone chicken code computer contract countrycode cow cpi* ppp* ed_mod_age educat4 educat5 educat7 educy electricity empstat empstat_2 empstat_2_year everattend fan finalweight firmsize_l food_share healthins hsize idh idh_org idp idp_org improved_sanitation improved_water industry industry_2 industry_orig industry_orig_2 int_month int_year internet lamp lb_mod_age literacy lphone lstatus male marital month motorcar motorcycle nfood_share njobs nlfreason occup ocusec ownhouse piped_water pline_int pline_nat poor_int poor_nat pop_wgt psu quintile_cons_aggregate radio rbirth rbirth_juris refrigerator relationcs relationharm rprevious rprevious_juris sar_improved_toilet sar_improved_water sewage_toilet sewingmachine soc socialsec spdef strata subnatid1 subnatid2 subnatid3 survey television toilet_jmp toilet_orig typehouse unempldur_l unempldur_u union unitwage unitwage_2 urban veralt vermast wage wage_2 washingmachine water_jmp water_orig welfare welfaredef welfarenat welfarenom welfareother welfareothertype welfaretype welfshprosperity wgt whours year yrmove hhid pid
    gen END_SARMD=.
